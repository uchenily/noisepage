...
public:
     ...
     */
    static std::vector<common::ManagedPointer<parser::TableRef>>
    GetSelectWithOrder(common::ManagedPointer<parser::SelectStatement> select_statement);
     ...
     */
    static std::vector<common::ManagedPointer<parser::TableRef>>
    GetInsertWithOrder(common::ManagedPointer<parser::InsertStatement> insert_statement);
     ...
     */
    static std::vector<common::ManagedPointer<parser::TableRef>>
    GetUpdateWithOrder(common::ManagedPointer<parser::UpdateStatement> update_statement);
     ...
     */
    static std::vector<common::ManagedPointer<parser::TableRef>>
    GetDeleteWithOrder(common::ManagedPointer<parser::DeleteStatement> delete_statement);
};
} // namespace noisepage::binder::cte
