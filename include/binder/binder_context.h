...
namespace binder {
    ...
    public:
         ...
         * It also takes in a pointer to the binder context's upper context, and the constructor determines the depth of
         * the current context based on the upper context. These two fields are used in nested queries.
         * @param upper_context Pointer to the upper level binder context of the current binder context.
         */
        explicit BinderContext(common::ManagedPointer<BinderContext> upper_context)
         ...
         * We insert the new table information to the nested table alias map because the structure of the attribute
         * matches the information we have about the new table; the name of the attribute might confuse people.
         ...
         */
        bool CheckNestedTableColumn(const parser::AliasType                              &alias,
         ...
         */
        common::ManagedPointer<BinderContext> GetUpperContext() {
            return upper_context_;
        }
         ...
         */
        void SetUpperContext(common::ManagedPointer<BinderContext> upper_context) {
            upper_context_ = upper_context;
        }
        ...
        /**
         * Retrieve the alias saved in this context corresponding to alias_name, if none is found then create a new
         * alias using alias_name
        ...
        /**
         * Starting at the current context, traverse up to higher level contexts until we find an AliasType
         * corresponding to alias_name. If we don't find one, then create a new AliasType using alias_name.
