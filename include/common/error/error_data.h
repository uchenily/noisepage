...
public:
    ...
    /**
     * @param severity how serious is this error. Severity determines if it will be written back to the client as an
     * Error or a Notice message. @see PostgresPacketWriter::WriteError
