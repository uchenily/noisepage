...
public:
    ...
    /**
     * Notify all of the replicas that the current oldest active transaction (OAT) is at least as new as the supplied
     * OAT.
     *
    ...
    transaction::timestamp_t GetLastSentTransactionId() const {
        return newest_txn_sent_;
    }
