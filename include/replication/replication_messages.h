...
public:
    ...
    virtual ReplicationMessageType GetMessageType() const {
        return type_;
    }
    ...
    const ReplicationMessageMetadata &GetMetadata() const {
        return metadata_;
    }

    /** @return     The message ID from the metadata. Convenience function. */
    msg_id_t GetMessageId() const {
        return GetMetadata().GetMessageId();
    }
...
public:
     ...
     */
    NotifyOATMsg(ReplicationMessageMetadata metadata,
                 record_batch_id_t          batch_id,
    ...
    ReplicationMessageType GetMessageType() const override {
        return ReplicationMessageType::NOTIFY_OAT;
    }

    /** @return The ID of the last batch of log records that was sent. */
    record_batch_id_t GetBatchId() const {
        return batch_id_;
    }

    /** @return The oldest active transaction of the OAT. */
    transaction::timestamp_t GetOldestActiveTxn() const {
...
public:
     ...
     */
    RecordsBatchMsg(ReplicationMessageMetadata  metadata,
                    record_batch_id_t           batch_id,
    ...
    ReplicationMessageType GetMessageType() const override {
        return ReplicationMessageType::RECORDS_BATCH;
    }
...
public:
    ...
    ReplicationMessageType GetMessageType() const override {
        return ReplicationMessageType::TXN_APPLIED;
    }

    /** @return The ID of the transaction that was applied on the replica. */
    transaction::timestamp_t GetAppliedTxnId() const {
        return applied_txn_id_;
    }
