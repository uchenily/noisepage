...
private:
    ...
    /**
     * @brief Obtain a function that will teardown the core catalog objects as they exist at the time of the provided
     * txn.
     *
     ...
     */
    bool CreateNamespace(common::ManagedPointer<transaction::TransactionContext> txn,
    ...
    GetNamespaceClassOids(common::ManagedPointer<transaction::TransactionContext> txn, namespace_oid_t ns_oid);
    ...
    GetClassSchemaPtrKind(common::ManagedPointer<transaction::TransactionContext> txn, uint32_t oid);
    ...
    GetClassNameKind(common::ManagedPointer<transaction::TransactionContext> txn, uint32_t oid);
