...
private:
     ...
     */
    void CreateColumnStatistic(common::ManagedPointer<transaction::TransactionContext> txn,
     ...
     */
    std::unique_ptr<optimizer::ColumnStatsBase>
    CreateColumnStats(common::ManagedPointer<storage::ProjectedRow> all_cols_pr,
                      table_oid_t                                   table_oid,
                      col_oid_t                                     col_oid,
