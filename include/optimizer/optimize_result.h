...
public:
     ...
     */
    common::ManagedPointer<planner::PlanMetaData> GetPlanMetaData() {
        return common::ManagedPointer(plan_meta_data_);
    }

    /**
     * @return root plan node
     */
    common::ManagedPointer<planner::AbstractPlanNode> GetPlanNode() {
        return common::ManagedPointer(plan_node_);
    }
     ...
     * @return root plan node
     */
    std::unique_ptr<planner::AbstractPlanNode> &&TakePlanNodeOwnership() {
        return std::move(plan_node_);
    }
