...
namespace optimizer {
    ...
    public:
        ...
        ConvertToOpExpression(common::ManagedPointer<parser::SQLStatement> op,
    ...
    private:
         ...
         */
        bool
        GenerateSubqueryTree(common::ManagedPointer<parser::AbstractExpression> expr, int child_id, bool single_join);
