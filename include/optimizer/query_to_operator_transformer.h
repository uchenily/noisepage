...
namespace optimizer {
    ...
    public:
         ...
         */
        auto ConvertToOpExpression(common::ManagedPointer<parser::SQLStatement> op,
    ...
    private:
         ...
         */
        auto GenerateSubqueryTree(common::ManagedPointer<parser::AbstractExpression> expr,
                                  int                                                child_id,
         ...
         */
        static auto IsSupportedConjunctivePredicate(common::ManagedPointer<parser::AbstractExpression> expr) -> bool;
         ...
         * @return True if supported, false otherwise
         */
        static auto IsSupportedSubSelect(common::ManagedPointer<parser::SelectStatement> op) -> bool;
         ...
         */
        static auto RequireAggregation(common::ManagedPointer<parser::SelectStatement> op) -> bool;
         ...
         */
        auto FindFirstCTEScanNode(common::ManagedPointer<AbstractOptimizerNode> child_expr,
