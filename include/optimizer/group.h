...
public:
     ...
     */
    const std::unordered_set<parser::AliasType> &GetTableAliases() const {
     ...
     */
    void SetTableNumRows(size_t table_num_rows) {
    ...
    /**
     * Get the selectivities for filter columns  (selectivities multiplied for the same column, assuming conjunction
     * AND)
     ...
     */
    bool HasNumRows() {
        return num_rows_ != UNINITIALIZED_NUM_ROWS;
    }
