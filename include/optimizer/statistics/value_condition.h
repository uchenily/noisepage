...
public:
     ...
     */
    ValueCondition(catalog::col_oid_t                               column_id,
                   std::string                                      column_name,
                   parser::ExpressionType                           type,
     ...
     */
    const catalog::col_oid_t &GetColumnID() const {
        return column_id_;
    }
     ...
     */
    const parser::ExpressionType &GetType() const {
        return type_;
    }
