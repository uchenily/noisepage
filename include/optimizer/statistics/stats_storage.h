...
struct TableStatsKey {
     ...
     */
    TableStatsKey(catalog::db_oid_t db_oid, catalog::table_oid_t table_oid)
        : db_oid_(db_oid)
...
struct TableStatsValue {
     ...
     */
    explicit TableStatsValue(TableStats table_stats)
...
struct LatchedTableStatsReference {
     ...
     */
    explicit LatchedTableStatsReference(const TableStats        &table_stats,
                                        common::SharedLatchGuard table_stats_shared_latch,
...
struct hash<noisepage::optimizer::TableStatsKey> {
    ...
    size_t operator()(const noisepage::optimizer::TableStatsKey &table_stats_key) const {
        ...
        hash
            = noisepage::common::HashUtil::CombineHashes(hash,
                                                         noisepage::common::HashUtil::Hash(table_stats_key.table_oid_));
        return hash;
    }
};
...
public:
     ...
     */
    LatchedTableStatsReference
    GetTableStats(catalog::db_oid_t database_id, catalog::table_oid_t table_id, catalog::CatalogAccessor *accessor);
     ...
     */
    void MarkStatsStale(catalog::db_oid_t                      database_id,
...
private:
     ...
     */
    void
    InsertTableStats(catalog::db_oid_t database_id, catalog::table_oid_t table_id, catalog::CatalogAccessor *accessor);
     ...
     * @param accessor - catalog accessor
     */
    static void UpdateStaleColumns(catalog::table_oid_t      table_id,
                                   TableStatsValue          *table_stats_value,
