...
public:
     ...
     */
    group_id_t GetOriginGroup() const {
        return origin_group_;
    }
...
public:
     ...
     */
    static Operator
    Make(parser::AliasType                                                                           table_alias,
...
public:
     ...
     * @return vector of predicates
     */
    const std::vector<common::ManagedPointer<parser::AbstractExpression>> &GetExpressions() const {
        return expressions_;
    }
...
public:
     ...
     */
    const std::vector<optimizer::OrderByOrderingType> &GetSortDirections() const {
...
public:
     ...
     */
    const parser::IndexType &GetIndexType() const {
        return index_type_;
    }
     ...
     * @return Type of the index
     */
    const std::vector<common::ManagedPointer<parser::AbstractExpression>> &GetIndexAttr() const {
        return index_attrs_;
    }
     ...
     */
    const catalog::IndexOptions &GetIndexOptions() const {
        return index_options_;
    }
