...
public:
     ...
     */
    OptimizationContext(OptimizerContext *context,
     ...
     */
    OptimizerContext *GetOptimizerContext() const {
        return context_;
    }
     ...
     */
    PropertySet *GetRequiredProperties() const {
        return required_prop_;
    }

    /**
     * @returns Current context's upper bound cost
     */
    double GetCostUpperBound() const {
        return cost_upper_bound_;
    }
