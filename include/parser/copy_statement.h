...
namespace parser {
    ...
    public:
        ...
        /** @return copy table */
        common::ManagedPointer<TableRef> GetCopyTable() {
            return common::ManagedPointer(table_);
        }

        /** @return select statement */
        common::ManagedPointer<SelectStatement> GetSelectStatement() {
            return common::ManagedPointer(select_stmt_);
        }
        ...
        ExternalFileFormat GetExternalFileFormat() {
            return format_;
        }
