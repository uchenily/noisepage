...
namespace parser {
    ...
    struct BaseFunctionParameter {
        ...
        explicit BaseFunctionParameter(DataType datatype)
            : datatype_(datatype) {}
    ...
    struct ReturnType : BaseFunctionParameter {
        /** @param datatype data type of the parameter */
        explicit ReturnType(DataType datatype)
            : BaseFunctionParameter(datatype) {}
    ...
    public:
         ...
         */
        CreateFunctionStatement(bool                                        replace,
         ...
         * @return return type
         */
        common::ManagedPointer<ReturnType> GetFuncReturnType() {
            return common::ManagedPointer(return_type_);
        }

        /**
         * @return function body
         */
        std::vector<std::string> GetFuncBody() {
            return func_body_;
        }
