...
namespace parser {
    ...
    public:
         ...
         */
        common::ManagedPointer<AbstractExpression> GetUpdateValue() const {
            return value_;
        }
    ...
    public:
        ...
        common::ManagedPointer<TableRef> GetUpdateTable() {
            return common::ManagedPointer(table_);
        }
        ...
        common::ManagedPointer<AbstractExpression> GetUpdateCondition() {
            return where_;
        }
