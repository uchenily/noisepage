...
public:
     ...
     */
    ConstantValueExpression(execution::sql::SqlTypeId type,
                            execution::sql::StringVal value,
    ...
    /**
     * @return copy of the underlying Val
     * @warning StringVal may not have inlined its value, in which case the StringVal returned by this function will
     * hold a pointer to the buffer in this CVE. In that case, do not destroy this CVE before the copied StringVal
     */
     ...
     * @param buffer StringVal might not be inlined, so take ownership of that buffer
     */
    void SetValue(const execution::sql::SqlTypeId type,
     ...
     * @warning std::string_view returned by this function will hold a pointer to the buffer in this CVE. In that case,
...
private:
    ...
    void Validate() const;
    std::variant<execution::sql::Val,
                 execution::sql::BoolVal,
                 execution::sql::Integer,
                 execution::sql::Real,
                 execution::sql::DecimalVal,
                 execution::sql::StringVal,
                 execution::sql::DateVal,
