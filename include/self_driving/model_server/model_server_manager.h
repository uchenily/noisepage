...
public:
     ...
     */
    ModelServerManager(const std::string                                  &model_bin,
     ...
     */
    bool TrainModel(ModelType::Type                                        model,
     ...
     * @return True if sending train request suceeds
     */
    bool TrainInterferenceModel(const std::vector<std::string>                        &methods,
                                const std::string                                     &input_path,
                                const std::string                                     &save_path,
    ...
    InferForecastModel(const std::string              &input_path,
     ...
     */
    std::pair<selfdriving::WorkloadForecastPrediction, bool>
    InferForecastModel(std::unordered_map<int64_t, std::vector<double>> *input_data,
                       const std::string                                &model_path,
                       const std::vector<std::string>                   &model_names,
                       std::string                                      *models_config,
                       uint64_t                                          interval_micro_sec,
    ...
    InferInterferenceModel(const std::string &model_path, const std::vector<std::vector<double>> &features);
