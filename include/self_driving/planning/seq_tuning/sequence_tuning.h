...
namespace pilot {
     ...
     * MonteCarloTreeSearch. The algo varies from the original paper linked below by considering a set of structures at
     * each timestamp: https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/SequenceTuning_Sig06.pdf.
     */
    ...
    public:
         ...
         * @param best_actions_seq storing output: query string of the best actions as well as the associated database
         * oid
         */
        ...
        /**
         * Computing the transition cost (measured as cumulative elapsed time of actions) from one configuration to
         * another.
         ...
         */
        static double
        ConfigTransitionCost(const std::map<pilot::action_id_t, std::unique_ptr<pilot::AbstractAction>> &structure_map,
    ...
    private:
         ...
         */
        double UnionPair(const PathSolution &path_one,
         ...
         */
        void GreedySeq(const std::map<action_id_t, PathSolution> &best_path_for_structure,
                       uint64_t                                   memory_constraint,
         ...
         * @param global_config_set set of configs selected by step 3 of the GREEDY-SEQ algo to be used in the final
         * graph
         * @param memory_constraint maximum allowed memory in bytes
         */
        void MergeConfigs(std::multiset<PathSolution>     *global_path_set,
