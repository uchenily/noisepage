...
public:
     ...
     */
    static std::pair<execution::sql::SqlTypeId, ExecutionOperatingUnitType>
    ConvertExpressionType(common::ManagedPointer<parser::AbstractExpression> expr) {
     ...
     */
    static std::vector<std::pair<execution::sql::SqlTypeId, ExecutionOperatingUnitType>>
    ExtractFeaturesFromExpression(common::ManagedPointer<parser::AbstractExpression> expr) {
        if (expr == nullptr)
            return std::vector<std::pair<execution::sql::SqlTypeId, ExecutionOperatingUnitType>>();
