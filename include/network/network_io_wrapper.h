...
public:
     ...
     */
    common::ManagedPointer<ReadBuffer> GetReadBuffer() {
        return common::ManagedPointer<ReadBuffer>(in_);
    }

    /**
     * @return The WriteQueue for this IOWrapper
     */
    common::ManagedPointer<WriteQueue> GetWriteQueue() {
        return common::ManagedPointer<WriteQueue>(out_);
    }
