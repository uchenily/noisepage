...
public:
    ...
    public:
         ...
         */
        byte *operator[](const int64_t &idx) const noexcept {
            return *(*this + idx);
        }
...
public:
     ...
     */
    ChunkedVectorT(ChunkedVectorT &&that) noexcept
    ...
    public:
         ...
         */
        explicit Iterator(BaseChunkedVectorIterator iter)
            : iter_(iter) {}
        ...
        T &operator*() const noexcept {
            return *reinterpret_cast<T *>(*iter_);
        }
         ...
         * @return the new iterator with the added offset
         */
        Iterator operator+(const int64_t &offset) const noexcept {
         ...
         * @return the element that is idx away from the current position
         */
        T &operator[](const int64_t &idx) const noexcept {
