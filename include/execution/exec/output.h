...
public:
     ...
     */
    explicit OutputBuffer(sql::MemoryPool      *memory_pool,
                          uint16_t              num_cols,
                          uint32_t              tuple_size,
     ...
     * @return memory pool
     */
    sql::MemoryPool *GetMemoryPool() const {
        return memory_pool_;
    }
...
public:
     ...
     */
    explicit OutputPrinter(const planner::OutputSchema *schema)
        : schema_(schema) {}
