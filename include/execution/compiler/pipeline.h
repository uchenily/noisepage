...
public:
    ...
    bool IsParallel() const {
        return parallelism_ == Parallelism ::Parallel;
    }
     ...
     */
    bool IsDriver(const PipelineDriver *driver) const {
     ...
     */
    ast::Identifier GetPipelineStateVar() {
        return state_var_;
    }

    /** @return The unique ID of this pipeline. */
    pipeline_id_t GetPipelineId() const {
        return pipeline_id_t{id_};
    }
     ...
     */
    ast::Expr *OUFeatureVecPtr() const {
        return oufeatures_.GetPtr(codegen_);
    }
...
private:
    ...
    const std::vector<OperatorTranslator *> &GetTranslators() const {
        return steps_;
    }
    ...
    const StateDescriptor &GetPipelineStateDescriptor() const {
        return state_;
    }

    StateDescriptor &GetPipelineStateDescriptor() {
        return state_;
    }
