...
public:
    ...
    public:
         ...
         */
        Entry(StateDescriptor *desc, ast::Identifier member)
            : desc_(desc)
            , member_(member) {}
     ...
     */
    ast::Identifier GetTypeName() const {
        return name_;
    }
...
private:
    ...
    struct SlotInfo {
        ...
        ast::Expr *type_repr_;
        // Constructor.
        SlotInfo(ast::Identifier name, ast::Expr *type_repr)
            : name_(name)
