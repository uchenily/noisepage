...
public:
    ...
    public:
         ...
         */
        explicit CodeScope(CodeGen *codegen)
            : codegen_(codegen) {
            codegen_->EnterScope();
        }
     ...
     */
    [[nodiscard]]
    ast::Expr *TplType(sql::TypeId type);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggregateType(parser::ExpressionType agg_type, sql::TypeId ret_type, sql::TypeId child_type) const;

    /**
     * @return An expression that represents the address of the provided object.
     */
    [[nodiscard]]
    ast::Expr *AddressOf(ast::Expr *obj) const;

    /**
     * @return An expression that represents the address of the provided object.
     */
    [[nodiscard]]
    ast::Expr *AddressOf(ast::Identifier obj_name) const;

    /**
     * @return An expression that represents the size of a type with the provided name, in bytes.
     */
    [[nodiscard]]
    ast::Expr *SizeOf(ast::Identifier type_name) const;

    /**
     * @return The offset of the given member within the given object.
     */
    [[nodiscard]]
    ast::Expr *OffsetOf(ast::Identifier obj, ast::Identifier member) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *PtrCast(ast::Expr *base, ast::Expr *arg) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *PtrCast(ast::Identifier base_name, ast::Expr *arg) const;
     ...
     */
    [[nodiscard]]
    ast::VariableDecl *DeclareVarNoInit(ast::Identifier name, ast::Expr *type_repr);
     ...
     */
    [[nodiscard]]
    ast::VariableDecl *DeclareVarNoInit(ast::Identifier name, ast::BuiltinType::Kind kind);
     ...
     */
    [[nodiscard]]
    ast::VariableDecl *DeclareVarWithInit(ast::Identifier name, ast::Expr *init);
     ...
     */
    [[nodiscard]]
    ast::VariableDecl *DeclareVar(ast::Identifier name, ast::Expr *type_repr, ast::Expr *init);
     ...
     */
    [[nodiscard]]
    ast::StructDecl *DeclareStruct(ast::Identifier name, util::RegionVector<ast::FieldDecl *> &&fields) const;
     ...
     */
    [[nodiscard]]
    ast::Stmt *Assign(ast::Expr *dest, ast::Expr *value);
     ...
     */
    [[nodiscard]]
    ast::Expr *BinaryOp(parsing::Token::Type op, ast::Expr *left, ast::Expr *right) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *Compare(parsing::Token::Type op, ast::Expr *left, ast::Expr *right) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *IsNilPointer(ast::Expr *obj) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *UnaryOp(parsing::Token::Type op, ast::Expr *input) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *AccessStructMember(ast::Expr *object, ast::Identifier member);
     ...
     */
    [[nodiscard]]
    ast::Expr *Call(ast::Identifier func_name, std::initializer_list<ast::Expr *> args) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *Call(ast::Identifier func_name, const std::vector<ast::Expr *> &args) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *CallBuiltin(ast::Builtin builtin, std::initializer_list<ast::Expr *> args) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *CallBuiltin(ast::Builtin builtin, const std::vector<ast::Expr *> &args) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *BoolToSql(bool b) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *IntToSql(int64_t num) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *FloatToSql(double num) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *DateToSql(sql::Date date) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *DateToSql(int32_t year, int32_t month, int32_t day) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *TimestampToSql(sql::Timestamp timestamp) const;
     ...
     */
    [[nodiscard]]
    ast::Expr *TimestampToSql(uint64_t julian_usec) const;
    ...
    [[nodiscard]]
    ast::Expr *
    TimestampToSql(int32_t year, int32_t month, int32_t day, int32_t h, int32_t m, int32_t s, int32_t ms, int32_t us)
        const;
     ...
     */
    [[nodiscard]]
    ast::Expr *StringToSql(std::string_view str) const;
     ...
     */
    [[nodiscard]]
    catalog::CatalogAccessor *GetCatalogAccessor() const;
    ...
    [[nodiscard]]
    ast::Expr *
    TableIterInit(ast::Expr *table_iter, ast::Expr *exec_ctx, catalog::table_oid_t table_oid, ast::Identifier col_oids);
     ...
     */
    [[nodiscard]]
    ast::Expr *TableIterAdvance(ast::Expr *table_iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *TableIterGetVPI(ast::Expr *table_iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *TableIterClose(ast::Expr *table_iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *IterateTableParallel(catalog::table_oid_t table_oid,
     ...
     */
    ast::Expr *TempTableIterInit(ast::Identifier tvi,
     ...
     */
    [[nodiscard]]
    ast::Expr *IndexIteratorInit(ast::Identifier iter,
     ...
     */
    [[nodiscard]]
    ast::Expr *IndexIteratorInit(ast::Expr      *iter_ptr,
                                 ast::Expr      *exec_ctx_var,
                                 uint32_t        num_attrs,
                                 uint32_t        table_oid,
                                 uint32_t        index_oid,
     ...
     */
    [[nodiscard]]
    ast::Expr *IndexIteratorScan(ast::Expr *iter_ptr, planner::IndexScanType scan_type, uint32_t limit);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIIsFiltered(ast::Expr *vpi);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIHasNext(ast::Expr *vpi, bool filtered);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIAdvance(ast::Expr *vpi, bool filtered);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIInit(ast::Expr *vpi, ast::Expr *vp, ast::Expr *tids);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIMatch(ast::Expr *vpi, ast::Expr *cond);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIGet(ast::Expr *vpi, sql::TypeId type_id, bool nullable, uint32_t idx);
     ...
     */
    [[nodiscard]]
    ast::Expr *VPIFilter(ast::Expr             *exec_ctx,
                         ast::Expr             *vp,
     ...
     */
    [[nodiscard]]
    ast::Expr *PRGet(ast::Expr *pr, noisepage::execution::sql::SqlTypeId type, bool nullable, uint32_t attr_idx);
     ...
     */
    [[nodiscard]]
    ast::Expr *FilterManagerInit(ast::Expr *filter_manager, ast::Expr *exec_ctx);
     ...
     */
    [[nodiscard]]
    ast::Expr *FilterManagerFree(ast::Expr *filter_manager);
     ...
     */
    [[nodiscard]]
    ast::Expr *FilterManagerInsert(ast::Expr *filter_manager, const std::vector<ast::Identifier> &clause_fn_names);
     ...
     */
    [[nodiscard]]
    ast::Expr *FilterManagerRunFilters(ast::Expr *filter_manager, ast::Expr *vpi, ast::Expr *exec_ctx);
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecCtxRegisterHook(ast::Expr *exec_ctx, uint32_t hook_idx, ast::Identifier hook);
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecCtxClearHooks(ast::Expr *exec_ctx);
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecCtxInitHooks(ast::Expr *exec_ctx, uint32_t num_hooks);
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecCtxAddRowsAffected(ast::Expr *exec_ctx, int64_t num_rows_affected);
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecOUFeatureVectorRecordFeature(ast::Expr                                           *ouvec,
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecCtxGetMemoryPool(ast::Expr *exec_ctx);
     ...
     */
    [[nodiscard]]
    ast::Expr *ExecCtxGetTLS(ast::Expr *exec_ctx);
     ...
     */
    [[nodiscard]]
    ast::Expr *TLSAccessCurrentThreadState(ast::Expr *tls, ast::Identifier state_type_name);
     ...
     */
    [[nodiscard]]
    ast::Expr *TLSIterate(ast::Expr *tls, ast::Expr *context, ast::Identifier func);
     ...
     */
    [[nodiscard]]
    ast::Expr *TLSReset(ast::Expr      *tls,
     ...
     */
    [[nodiscard]]
    ast::Expr *TLSClear(ast::Expr *tls);
     ...
     */
    [[nodiscard]]
    ast::Expr *Hash(const std::vector<ast::Expr *> &values);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHashTableInit(ast::Expr *join_hash_table, ast::Expr *exec_ctx, ast::Identifier build_row_type_name);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHashTableInsert(ast::Expr *join_hash_table, ast::Expr *hash_val, ast::Identifier tuple_type_name);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHashTableBuild(ast::Expr *join_hash_table);
    ...
    [[nodiscard]]
    ast::Expr *
    JoinHashTableBuildParallel(ast::Expr *join_hash_table, ast::Expr *thread_state_container, ast::Expr *offset);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHashTableLookup(ast::Expr *join_hash_table, ast::Expr *entry_iter, ast::Expr *hash_val);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHashTableFree(ast::Expr *join_hash_table);
     ...
     */
    [[nodiscard]]
    ast::Expr *HTEntryIterHasNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *HTEntryIterGetRow(ast::Expr *iter, ast::Identifier row_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHTIteratorInit(ast::Expr *iter, ast::Expr *ht);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHTIteratorHasNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHTIteratorNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHTIteratorGetRow(ast::Expr *iter, ast::Identifier payload_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *JoinHTIteratorFree(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableInit(ast::Expr *agg_ht, ast::Expr *exec_ctx, ast::Identifier agg_payload_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableLookup(ast::Expr      *agg_ht,
                                  ast::Expr      *hash_val,
    ...
    [[nodiscard]]
    ast::Expr *
    AggHashTableInsert(ast::Expr *agg_ht, ast::Expr *hash_val, bool partitioned, ast::Identifier agg_payload_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableLinkEntry(ast::Expr *agg_ht, ast::Expr *entry);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableMovePartitions(ast::Expr      *agg_ht,
                                          ast::Expr      *tls,
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableParallelScan(ast::Expr      *agg_ht,
                                        ast::Expr      *query_state,
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableFree(ast::Expr *agg_ht);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggPartitionIteratorHasNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggPartitionIteratorNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggPartitionIteratorGetHash(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggPartitionIteratorGetRow(ast::Expr *iter, ast::Identifier agg_payload_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggPartitionIteratorGetRowEntry(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableIteratorInit(ast::Expr *iter, ast::Expr *agg_ht);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableIteratorHasNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableIteratorNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableIteratorGetRow(ast::Expr *iter, ast::Identifier agg_payload_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggHashTableIteratorClose(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggregatorInit(ast::Expr *agg);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggregatorAdvance(ast::Expr *agg, ast::Expr *val);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggregatorMerge(ast::Expr *agg1, ast::Expr *agg2);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggregatorResult(ast::Expr *exec_ctx, ast::Expr *agg, const parser::ExpressionType &expression_type);
     ...
     */
    [[nodiscard]]
    ast::Expr *AggregatorFree(ast::Expr *agg);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterInit(ast::Expr      *sorter,
                          ast::Expr      *exec_ctx,
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterInsert(ast::Expr *sorter, ast::Identifier sort_row_type_name);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterInsertTopK(ast::Expr *sorter, ast::Identifier sort_row_type_name, uint64_t top_k);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterInsertTopKFinish(ast::Expr *sorter, uint64_t top_k);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterSort(ast::Expr *sorter);
     ...
     */
    [[nodiscard]]
    ast::Expr *SortParallel(ast::Expr *sorter, ast::Expr *tls, ast::Expr *offset);
     ...
     */
    [[nodiscard]]
    ast::Expr *SortTopKParallel(ast::Expr *sorter, ast::Expr *tls, ast::Expr *offset, std::size_t top_k);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterFree(ast::Expr *sorter);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterIterInit(ast::Expr *iter, ast::Expr *sorter);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterIterHasNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterIterNext(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterIterSkipRows(ast::Expr *iter, uint32_t n);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterIterGetRow(ast::Expr *iter, ast::Identifier row_type_name);
     ...
     */
    [[nodiscard]]
    ast::Expr *SorterIterClose(ast::Expr *iter);
     ...
     */
    [[nodiscard]]
    ast::Expr *Like(ast::Expr *str, ast::Expr *pattern);
     ...
     */
    [[nodiscard]]
    ast::Expr *NotLike(ast::Expr *str, ast::Expr *pattern);
     ...
     */
    [[nodiscard]]
    ast::Expr *CSVReaderInit(ast::Expr *reader, std::string_view file_name);
     ...
     */
    [[nodiscard]]
    ast::Expr *CSVReaderAdvance(ast::Expr *reader);
     ...
     */
    [[nodiscard]]
    ast::Expr *CSVReaderGetField(ast::Expr *reader, uint32_t field_index, ast::Expr *result);
     ...
     */
    [[nodiscard]]
    ast::Expr *CSVReaderGetRecordNumber(ast::Expr *reader);
     ...
     */
    [[nodiscard]]
    ast::Expr *CSVReaderClose(ast::Expr *reader);
     ...
     * @return The expression corresponding to the builtin call.
     */
    ast::Expr *StorageInterfaceInit(ast::Expr      *storage_interface_ptr,
                                    ast::Expr      *exec_ctx,
                                    uint32_t        table_oid,
                                    ast::Identifier col_oids,
                                    bool            need_indexes);
     ...
     * @return The expression corresponding to the builtin call.
     */
    ast::Expr *CteScanIteratorInit(ast::Expr           *csi,
     ...
     * @return The expression corresponding to the builtin call.
     */
    ast::Expr *IndCteScanIteratorInit(ast::Expr           *csi,
                                      catalog::table_oid_t table_oid,
                                      ast::Identifier      col_ids,
                                      ast::Identifier      col_types,
                                      bool                 is_recursive,
    ...
    common::ManagedPointer<ast::Context> GetAstContext() const {
        return common::ManagedPointer(context_);
    }
