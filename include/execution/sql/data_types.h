...
public:
    ...
    bool operator==(const SqlType &that) const noexcept {
        return Equals(that);
    }
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Boolean;
    } // NOLINT
...
public:
    ...
    TypeId GetPrimitiveTypeId() const override {
        return GetTypeId<CppType>();
    }

    /** @return True if this type is an integer type. */
    bool IsIntegral() const override {
        return std::is_integral_v<CppType>;
    }

    /** @return True if this type is a floating-point type. */
    bool IsFloatingPoint() const override {
        return std::is_floating_point_v<CppType>;
    }
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::TinyInt;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::SmallInt;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Integer;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::BigInt;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Real;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Double;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Decimal;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Date;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Timestamp;
    } // NOLINT
...
public:
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Char;
    } // NOLINT
...
public:
    ...
    const SqlType &GetNonNullableVersion() const override {
        return InstanceNonNullable(MaxLength());
    }

    const SqlType &GetNullableVersion() const override {
        return InstanceNullable(MaxLength());
    }
    ...
    static bool classof(const SqlType *type) {
        return type->GetId() == SqlTypeId::Varchar;
    } // NOLINT
