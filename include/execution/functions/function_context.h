...
public:
     ...
     */
    FunctionContext(std::string                              func_name,
     ...
     */
    const std::vector<execution::sql::SqlTypeId> &GetFunctionArgsType() const {
        return args_type_;
    }
     ...
     */
    execution::sql::SqlTypeId GetFunctionReturnType() const {
        return func_ret_type_;
    }
