...
#define MESSAGE_LIST(F)                                                                                                \
    ...
    F(MismatchedCallArgsBetween,                                                                                       \
      "wrong number of arguments in call to '%0': expected between %1 and %2, received %3.",                           \
    ...
    F(BadKeyEqualityCheckFunctionForJoinTableLookup,                                                                   \
      "key equality check function must have type: (*,*,*)->bool, received '%0'",                                      \
      (ast::Type *) )                                                                                                  \
