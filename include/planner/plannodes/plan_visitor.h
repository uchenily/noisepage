...
public:
     ...
     */
    virtual void Visit([[maybe_unused]] const AggregatePlanNode *plan) {}

    /**
     * Visit an AnalyzePlanNode
     * @param plan AnalyzePlanNode
     */
    virtual void Visit([[maybe_unused]] const AnalyzePlanNode *plan) {}

    /**
     * Visit an CreateDatabasePlanNode
     * @param plan CreateDatabasePlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateDatabasePlanNode *plan) {}

    /**
     * Visit an CreateFunctionPlanNode
     * @param plan CreateFunctionPlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateFunctionPlanNode *plan) {}

    /**
     * Visit an CreateIndexPlanNode
     * @param plan CreateIndexPlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateIndexPlanNode *plan) {}

    /**
     * Visit an CreateNamespacePlanNode
     * @param plan CreateNamespacePlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateNamespacePlanNode *plan) {}

    /**
     * Visit an CreateTablePlanNode
     * @param plan CreateTablePlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateTablePlanNode *plan) {}

    /**
     * Visit an CreateTriggerPlanNode
     * @param plan CreateTriggerPlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateTriggerPlanNode *plan) {}

    /**
     * Visit an CreateViewPlanNode
     * @param plan CreateViewPlanNode
     */
    virtual void Visit([[maybe_unused]] const CreateViewPlanNode *plan) {}

    /**
     * Visit an CSVScanPlanNode
     * @param plan CSVScanPlanNode
     */
    virtual void Visit([[maybe_unused]] const CSVScanPlanNode *plan) {}

    /**
     * Visit an DeletePlanNode
     * @param plan DeletePlanNode
     */
    virtual void Visit([[maybe_unused]] const DeletePlanNode *plan) {}

    /**
     * Visit an DropDatabasePlanNode
     * @param plan DropDatabasePlanNode
     */
    virtual void Visit([[maybe_unused]] const DropDatabasePlanNode *plan) {}

    /**
     * Visit an DropIndexPlanNode
     * @param plan DropIndexPlanNode
     */
    virtual void Visit([[maybe_unused]] const DropIndexPlanNode *plan) {}

    /**
     * Visit an DropNamespacePlanNode
     * @param plan DropNamespacePlanNode
     */
    virtual void Visit([[maybe_unused]] const DropNamespacePlanNode *plan) {}

    /**
     * Visit an DropTablePlanNode
     * @param plan DropTablePlanNode
     */
    virtual void Visit([[maybe_unused]] const DropTablePlanNode *plan) {}

    /**
     * Visit an DropTriggerPlanNode
     * @param plan DropTriggerPlanNode
     */
    virtual void Visit([[maybe_unused]] const DropTriggerPlanNode *plan) {}

    /**
     * Visit an DropViewPlanNode
     * @param plan DropViewPlanNode
     */
    virtual void Visit([[maybe_unused]] const DropViewPlanNode *plan) {}

    /**
     * Visit an ExportExternalFilePlanNode
     * @param plan ExportExternalFilePlanNode
     */
    virtual void Visit([[maybe_unused]] const ExportExternalFilePlanNode *plan) {}

    /**
     * Visit an HashJoinPlanNode
     * @param plan HashJoinPlanNode
     */
    virtual void Visit([[maybe_unused]] const HashJoinPlanNode *plan) {}

    /**
     * Visit an IndexJoinPlanNode
     * @param plan IndexJoinPlanNode
     */
    virtual void Visit([[maybe_unused]] const IndexJoinPlanNode *plan) {}

    /**
     * Visit an IndexScanPlanNode
     * @param plan IndexScanPlanNode
     */
    virtual void Visit([[maybe_unused]] const IndexScanPlanNode *plan) {}

    /**
     * Visit an InsertPlanNode
     * @param plan InsertPlanNode
     */
    virtual void Visit([[maybe_unused]] const InsertPlanNode *plan) {}

    /**
     * Visit an LimitPlanNode
     * @param plan LimitPlanNode
     */
    virtual void Visit([[maybe_unused]] const LimitPlanNode *plan) {}

    /**
     * Visit an CteScanPlanNode
     * @param plan CteScanPlanNode
     */
    virtual void Visit([[maybe_unused]] const CteScanPlanNode *plan) {}

    /**
     * Visit an NestedLoopJoinPlanNode
     * @param plan NestedLoopJoinPlanNode
     */
    virtual void Visit([[maybe_unused]] const NestedLoopJoinPlanNode *plan) {}

    /**
     * Visit an OrderByPlanNode
     * @param plan OrderByPlanNode
     */
    virtual void Visit([[maybe_unused]] const OrderByPlanNode *plan) {}

    /**
     * Visit an ProjectionPlanNode
     * @param plan ProjectionPlanNode
     */
    virtual void Visit([[maybe_unused]] const ProjectionPlanNode *plan) {}

    /**
     * Visit an SeqScanPlanNode
     * @param plan SeqScanPlanNode
     */
    virtual void Visit([[maybe_unused]] const SeqScanPlanNode *plan) {}

    /**
     * Visit an UpdatePlanNode
     * @param plan UpdatePlanNode
     */
    virtual void Visit([[maybe_unused]] const UpdatePlanNode *plan) {}

    /**
     * Visit an SetOpPlanNode
     * @param plan SetOpPlanNode
     */
    virtual void Visit([[maybe_unused]] const SetOpPlanNode *plan) {}

    /**
     * Visit an ResultPlanNode
     * @param plan ResultPlanNode
     */
    virtual void Visit([[maybe_unused]] const ResultPlanNode *plan) {}
};
