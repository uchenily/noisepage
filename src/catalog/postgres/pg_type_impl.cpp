...
PgTypeImpl::PgTypeImpl(db_oid_t db_oid)
    : db_oid_(db_oid) {}
...
void PgTypeImpl::Bootstrap(common::ManagedPointer<transaction::TransactionContext> txn,
    ...
    dbc->BootstrapIndex(txn,
                        PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
                        PgType::TYPE_TABLE_OID,
                        PgType::TYPE_OID_INDEX_OID,
                        "pg_type_oid_index",
                        Builder::GetTypeOidIndexSchema(db_oid_),
                        types_oid_index_);
    dbc->BootstrapIndex(txn,
                        PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
                        PgType::TYPE_TABLE_OID,
                        PgType::TYPE_NAME_INDEX_OID,
                        "pg_type_name_index",
...
void PgTypeImpl::BootstrapTypes(const common::ManagedPointer<DatabaseCatalog>                 dbc,
    ...
    auto insert_base_type
        = [&](const execution::sql::SqlTypeId type, const std::string &type_name, const int16_t type_size) {
              InsertType(txn,
                         dbc->GetTypeOidForType(type),
                         type_name,
                         PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
                         type_size,
                         true,
    ...
    InsertType(txn,
               dbc->GetTypeOidForType(execution::sql::SqlTypeId::Varbinary),
               "varbinary",
               PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
               -1,
               false,
