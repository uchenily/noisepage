...
PgConstraintImpl::PgConstraintImpl(db_oid_t db_oid)
    : db_oid_(db_oid) {}
...
void PgConstraintImpl::Bootstrap(common::ManagedPointer<transaction::TransactionContext> txn,
    ...
    dbc->BootstrapTable(txn,
                        PgConstraint::CONSTRAINT_TABLE_OID,
                        PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
                        "pg_constraint",
                        Builder::GetConstraintTableSchema(),
                        constraints_);
    dbc->BootstrapIndex(txn,
                        PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
                        PgConstraint::CONSTRAINT_TABLE_OID,
                        PgConstraint::CONSTRAINT_OID_INDEX_OID,
                        "pg_constraint_oid_index",
                        Builder::GetConstraintOidIndexSchema(db_oid_),
                        constraints_oid_index_);
    dbc->BootstrapIndex(txn,
                        PgNamespace::NAMESPACE_CATALOG_NAMESPACE_OID,
                        PgConstraint::CONSTRAINT_TABLE_OID,
