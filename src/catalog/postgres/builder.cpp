...
Builder::CreateDatabaseCatalog(const common::ManagedPointer<storage::BlockStore>       block_store,
    ...
    dbc->pg_constraint_.constraints_name_index_ = Builder::BuildUniqueIndex(Builder::GetConstraintNameIndexSchema(oid),
                                                                            PgConstraint::CONSTRAINT_NAME_INDEX_OID);
    dbc->pg_constraint_.constraints_namespace_index_
        = Builder::BuildLookupIndex(Builder::GetConstraintNamespaceIndexSchema(oid),
                                    PgConstraint::CONSTRAINT_NAMESPACE_INDEX_OID);
    dbc->pg_constraint_.constraints_table_index_
        = Builder::BuildLookupIndex(Builder::GetConstraintTableIndexSchema(oid),
                                    PgConstraint::CONSTRAINT_TABLE_INDEX_OID);
    dbc->pg_constraint_.constraints_index_index_
        = Builder::BuildLookupIndex(Builder::GetConstraintIndexIndexSchema(oid),
                                    PgConstraint::CONSTRAINT_INDEX_INDEX_OID);
    dbc->pg_constraint_.constraints_foreigntable_index_
        = Builder::BuildLookupIndex(Builder::GetConstraintForeignTableIndexSchema(oid),
...
Schema Builder::GetColumnTableSchema() {
    ...
    columns.emplace_back("atttypid",
                         execution::sql::SqlTypeId::Integer,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
    columns.back().SetOid(PgAttribute::ATTTYPID.oid_);

    columns.emplace_back("attlen",
    ...
    columns.emplace_back("atttypmod",
                         execution::sql::SqlTypeId::Integer,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
    columns.back().SetOid(PgAttribute::ATTTYPMOD.oid_);

    columns.emplace_back("attnotnull",
...
Schema Builder::GetClassTableSchema() {
    ...
    columns.emplace_back("reloptions",
                         execution::sql::SqlTypeId::Varchar,
                         MAX_NAME_LENGTH,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
    ...
    columns.emplace_back("nextcoloid",
                         execution::sql::SqlTypeId::Integer,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
...
Schema Builder::GetTypeTableSchema() {
    ...
    columns.emplace_back("typlen",
                         execution::sql::SqlTypeId::SmallInt,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::SmallInt));
    columns.back().SetOid(PgType::TYPLEN.oid_);

    columns.emplace_back("typbyval",
                         execution::sql::SqlTypeId::Boolean,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Boolean));
    columns.back().SetOid(PgType::TYPBYVAL.oid_);

    columns.emplace_back("typtype",
                         execution::sql::SqlTypeId::TinyInt,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
...
Schema Builder::GetStatisticTableSchema() {
    ...
    columns.emplace_back("stahistogram",
                         execution::sql::SqlTypeId::Varbinary,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varbinary));
...
Schema Builder::GetProcTableSchema() {
    ...
    columns.emplace_back("prolang",
                         execution::sql::SqlTypeId::Integer,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
    columns.back().SetOid(PgProc::PROLANG.oid_);

    columns.emplace_back("procost",
    ...
    columns.emplace_back("proallargtypes",
                         execution::sql::SqlTypeId::Varbinary,
                         4096,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varbinary));
    ...
    columns.emplace_back("proargmodes",
                         execution::sql::SqlTypeId::Varbinary,
                         4096,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varbinary));
    ...
    columns.emplace_back("proargdefaults",
                         execution::sql::SqlTypeId::Varbinary,
                         4096,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varbinary));
    ...
    columns.emplace_back("proargnames",
                         execution::sql::SqlTypeId::Varbinary,
                         4096,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varbinary));
    ...
    columns.emplace_back("proconfig",
                         execution::sql::SqlTypeId::Varbinary,
                         4096,
                         false,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::Varbinary));
    ...
    columns.emplace_back("ctx_pointer",
                         execution::sql::SqlTypeId::BigInt,
                         true,
                         parser::ConstantValueExpression(execution::sql::SqlTypeId::BigInt));
