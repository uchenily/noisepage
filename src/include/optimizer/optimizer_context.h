...
namespace optimizer {
    ...
    public:
         ...
         * @returns CTE Schema
         */
        catalog::Schema &GetCTESchema(const catalog::table_oid_t cte_oid) {
            return cte_schemas_.find(cte_oid)->second;
        }
         ...
         */
        common::ManagedPointer<std::vector<parser::ConstantValueExpression>> GetParams() {
            return params_;
        }
         ...
         */
        void AddOptimizationContext(OptimizationContext *ctx) {
         ...
         */
        void SetStatsStorage(StatsStorage *storage) {
            stats_storage_ = storage;
        }
         ...
         */
        void SetParams(common::ManagedPointer<std::vector<parser::ConstantValueExpression>> params) {
            params_ = params;
        }
         ...
         * @returns Whether the AbstractOptimizerNode has been added before
         */
        bool RecordOptimizerNodeIntoGroup(common::ManagedPointer<AbstractOptimizerNode> node,
