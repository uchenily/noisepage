...
namespace optimizer {
    ...
    public:
         ...
         */
        static Operator Make(catalog::db_oid_t                  database_oid,
         ...
         */
        const catalog::db_oid_t &GetDatabaseOID() const {
         ...
         */
        const catalog::table_oid_t &GetTableOID() const {
            return table_oid_;
        }
         ...
         */
        const std::vector<AnnotatedExpression> &GetPredicates() const {
            return predicates_;
        }
         ...
         */
        const parser::AliasType &GetTableAlias() const {
            return table_alias_;
        }
         ...
         */
        bool GetIsForUpdate() const {
            return is_for_update_;
        }
    ...
    public:
         ...
         */
        static Operator
        Make(catalog::db_oid_t                                                                     database_oid,
         ...
         */
        const catalog::index_oid_t &GetIndexOID() const {
            return index_oid_;
        }
         ...
         */
        planner::IndexScanType GetIndexScanType() const {
            return scan_type_;
        }
         ...
         */
        bool GetCoverAllColumns() const {
            return cover_all_columns_;
        }
    ...
    public:
         ...
         */
        static Operator
        Make(parser::ExternalFileFormat format, std::string file_name, char delimiter, char quote, char escape);
         ...
         */
        const parser::ExternalFileFormat &GetFormat() const {
            return format_;
        }
    ...
    public:
         ...
         */
        static Operator Make(parser::AliasType table_alias,
    ...
    public:
         ...
         */
        static Operator Make(size_t                                                            offset,
                             size_t                                                            limit,
         ...
         */
        const std::vector<optimizer::OrderByOrderingType> &GetSortAscending() const {
            return sort_directions_;
        }
    ...
    public:
         ...
         */
        static Operator
        Make(catalog::table_oid_t                                                                  tbl_oid,
         ...
         * @return Index OID
         */
        catalog::index_oid_t GetIndexOID() const {
            return idx_oid_;
        }
         ...
         * @return scan type
         */
        planner::IndexScanType GetScanType() const {
            return scan_type_;
        }
         ...
         * @return Join Keys
         */
        const std::unordered_map<catalog::indexkeycol_oid_t, std::vector<planner::IndexExpression>> &
        GetJoinKeys() const {
            return join_keys_;
        }
         ...
         */
        const std::vector<AnnotatedExpression> &GetJoinPredicates() const {
    ...
    public:
         ...
         */
        const common::ManagedPointer<parser::AbstractExpression> &GetJoinPredicate() const {
    ...
    public:
         ...
         */
        const std::vector<common::ManagedPointer<parser::AbstractExpression>> &GetLeftKeys() const {
            return left_keys_;
        }
         ...
         */
        const std::vector<common::ManagedPointer<parser::AbstractExpression>> &GetRightKeys() const {
            return right_keys_;
        }
    ...
    public:
         ...
         */
        const std::vector<catalog::col_oid_t> &GetColumns() const {
            return columns_;
        }
    ...
    public:
         ...
         */
        static Operator
        Make(catalog::db_oid_t database_oid, catalog::table_oid_t table_oid, std::vector<catalog::col_oid_t> &&columns);
    ...
    public:
         ...
         */
        const std::vector<common::ManagedPointer<parser::UpdateClause>> &GetUpdateClauses() const {
            return updates_;
        }
    ...
    public:
         ...
         */
        const std::vector<common::ManagedPointer<parser::AbstractExpression>> &GetColumns() const {
            return columns_;
        }
         ...
         */
        const std::vector<AnnotatedExpression> &GetHaving() const {
            return having_;
        }
    ...
    public:
         ...
         */
        const catalog::namespace_oid_t &GetNamespaceOid() const {
         ...
         */
        const std::vector<common::ManagedPointer<parser::ColumnDefinition>> &GetColumns() const {
            return columns_;
        }
        /**
         * @return foreign key references for the table
         */
        const std::vector<common::ManagedPointer<parser::ColumnDefinition>> &GetForeignKeys() const {
    ...
    public:
         ...
         */
        common::ManagedPointer<catalog::IndexSchema> GetSchema() const {
            return common::ManagedPointer(schema_);
        }
    ...
    public:
         ...
         * @return view query
         */
        common::ManagedPointer<parser::SelectStatement> GetViewQuery() const {
    ...
    public:
        ...
        std::vector<std::string> GetTriggerFuncName() const {
            return trigger_funcnames_;
        }

        /**
         * @return trigger args
         */
        std::vector<std::string> GetTriggerArgs() const {
            return trigger_args_;
        }

        /**
         * @return trigger columns
         */
        std::vector<catalog::col_oid_t> GetTriggerColumns() const {
            return trigger_columns_;
        }
    ...
    public:
         ...
         */
        parser::PLType GetUDFLanguage() const {
            return language_;
        }
         ...
         */
        std::vector<std::string> GetFunctionBody() const {
         ...
         */
        std::vector<std::string> GetFunctionParameterNames() const {
            return function_param_names_;
        }
         ...
         */
        parser::BaseFunctionParameter::DataType GetReturnType() const {
            return return_type_;
        }
    ...
    public:
         ...
         */
        catalog::trigger_oid_t GetTriggerOid() const {
            return trigger_oid_;
        }
    ...
    public:
         ...
         */
        catalog::view_oid_t GetViewOid() const {
            return view_oid_;
        }
    ...
    public:
         ...
         * @return columns
         */
        std::vector<catalog::col_oid_t> GetColumns() const {
            return columns_;
        }
    ...
    public:
         ...
         */
        static Operator
        Make(std::vector<std::vector<common::ManagedPointer<parser::AbstractExpression>>> child_expressions,
             std::string                                                                  table_name,
             catalog::table_oid_t                                                         table_oid,
        ...
        parser::CteType GetCTEType() const {
            return cte_type_;
        }

        /** @return `true` if the CTE is recursive, `false` otherwise */
        bool GetIsRecursive() const {
            return cte_type_ == parser::CteType::STRUCTURALLY_RECURSIVE;
        }

        /** @return `true` if the CTE is iterative, `false` otherwise */
        bool GetIsIterative() const {
            return cte_type_ == parser::CteType::STRUCTURALLY_ITERATIVE;
        }

        /** @return `true` if the CTE is inductive (recursive or iterative), `false` otherwise */
        bool GetIsInductive() const {
            return GetIsRecursive() || GetIsIterative();
        }
