...
public:
     ...
     * @return the column oid
     */
    catalog::col_oid_t GetColumnID() const override {
        return column_id_;
    }
     ...
     * @return number of non null rows
     */
    size_t GetNonNullRows() override {
     ...
     * @return number of null rows
     */
    size_t GetNullRows() override {
        return num_rows_ - non_null_rows_;
    }
     ...
     * @return distinct values
     */
    size_t GetDistinctValues() override {
     ...
     */
    common::ManagedPointer<Histogram<CppType>> GetHistogram() const {
        return common::ManagedPointer(histogram_);
    }
     ...
     */
    common::ManagedPointer<TopKElements<CppType>> GetTopK() {
        return common::ManagedPointer(top_k_);
    }
     ...
     * @return type id of the column
     */
    execution::sql::SqlTypeId GetTypeId() override {
        return type_id_;
    }
