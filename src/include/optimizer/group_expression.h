...
public:
     ...
     */
    const std::vector<group_id_t> &GetChildGroupIDs() const {
     ...
     */
    bool HasDerivedStats() {
        return stats_derived_;
    }
     ...
     */
    size_t GetChildrenGroupsSize() const {
