...
public:
     ...
     */
    ParamInfo(std::string                       name,
              parser::ConstantValueExpression &&value,
              std::string                       desc,
              parser::ConstantValueExpression &&default_value,
              bool                              is_mutable,
              double                            min_value,
              double                            max_value,
    ...
    const parser::ConstantValueExpression &GetValue() const {
        return value_;
    }
