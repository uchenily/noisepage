...
public:
    ...
    static void ForecastSampleLimit(void                                         *old_value,
                                    void                                         *new_value,
                                    DBMain                                       *db_main,
                                    common::ManagedPointer<common::ActionContext> action_context);

    /** Set the number of task manager threads. */
    static void TaskPoolSize(void                                         *old_value,
                             void                                         *new_value,
                             DBMain                                       *db_main,
                             common::ManagedPointer<common::ActionContext> action_context);

    /** Enable or disable planning in Pilot thread. */
    static void PilotEnablePlanning(void                                         *old_value,
                                    void                                         *new_value,
                                    DBMain                                       *db_main,
                                    common::ManagedPointer<common::ActionContext> action_context);

    /** Train the forecast model. */
    static void TrainForecastModel(void                                         *old_value,
                                   void                                         *new_value,
                                   DBMain                                       *db_main,
                                   common::ManagedPointer<common::ActionContext> action_context);

    /** Train the interference model. */
    static void TrainInterferenceModel(void                                         *old_value,
                                       void                                         *new_value,
                                       DBMain                                       *db_main,
                                       common::ManagedPointer<common::ActionContext> action_context);

    /** Train the OU model. */
    static void TrainOUModel(void                                         *old_value,
                             void                                         *new_value,
                             DBMain                                       *db_main,
                             common::ManagedPointer<common::ActionContext> action_context);
...
#define SETTINGS_GENERATE_LOGGER_CALLBACK(component)                                                                   \
    ...
    static void LogLevelSet##component(void                                         *old_value,                        \
                                       void                                         *new_value,                        \
                                       DBMain                                       *db_main,                          \
                                       common::ManagedPointer<common::ActionContext> action_context);
