...
public:
    ...
    RecordTranslators(const std::vector<execution::compiler::OperatorTranslator *> &translators);
...
private:
    ...
    void RecordAggregateTranslator(common::ManagedPointer<Translator> translator,
     ...
     */
    void AggregateFeatures(selfdriving::ExecutionOperatingUnitType type,
                           size_t                                  key_size,
                           size_t                                  num_keys,
     ...
     */
    double
    ComputeMemoryScaleFactor(execution::ast::StructDecl *decl, size_t total_offset, size_t key_size, size_t ref_offset);
     ...
     * @return key size
     */
    size_t ComputeKeySize(common::ManagedPointer<const catalog::IndexSchema> schema,
                          bool                                               restrict_cols,
     ...
     */
    size_t
    ComputeKeySize(catalog::index_oid_t idx_oid, const std::vector<catalog::indexkeycol_oid_t> &cols, size_t *num_key);
