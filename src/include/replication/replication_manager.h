...
protected:
    /**
     * On construction, the replication manager establishes a listen destination on the messenger and connects to all
     * the replicas specified in the replication.config file located at @p replication_hosts_path.
     *
     ...
     */
    ReplicationManager(
        common::ManagedPointer<messenger::Messenger>                                          messenger,
        const std::string                                                                    &network_identity,
        uint16_t                                                                              port,
    ...
    virtual void EventLoop(common::ManagedPointer<messenger::Messenger>   messenger,
