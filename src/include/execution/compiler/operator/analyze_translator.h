...
public:
     ...
     */
    AnalyzeTranslator(const planner::AnalyzePlanNode &plan,
...
private:
    ...
    void
    DeleteFromPgStatisticIndex(FunctionBuilder *function, ast::Identifier slot, catalog::index_oid_t index_oid) const;
