...
public:
     ...
     */
    DistinctAggregationFilter(size_t                        agg_term_idx,
     ...
     */
    ast::StructDecl *GenerateKeyStruct(CodeGen                                 *codegen,
                                       const planner::AggregateTerm            &agg_term,
     ...
     */
    void AggregateDistinct(CodeGen                        *codegen,
...
private:
     ...
     */
    ast::Identifier FillLookupKey(CodeGen                        *codegen,
                                  FunctionBuilder                *function,
                                  ast::Expr                      *agg_val,
                                  const std::vector<ast::Expr *> &group_bys) const;
     ...
     */
    void AssignPayload(CodeGen         *codegen,
                       FunctionBuilder *function,
