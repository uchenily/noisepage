...
namespace compiler {
    ...
    public:
        ...
        public:
             ...
             */
            bool IsFromSource() const noexcept {
             ...
             */
            ast::Context *GetContext() const noexcept {
                return context_;
            }

            /** @return The settings to be used when compiling the input. */
            const CompilerSettings &GetSettings() const noexcept {
                return settings_;
            }
        ...
        public:
             ...
             */
            virtual bool BeginPhase(Phase phase, Compiler *compiler) {
                return true;
            }
         ...
         */
        vm::BytecodeModule *GetBytecodeModule() const {
    ...
    public:
        ...
        explicit TimePasses(Compiler::Callbacks *wrapped_callbacks)
            : wrapped_callbacks_(wrapped_callbacks)
            , phase_timings_{0.0} {}
