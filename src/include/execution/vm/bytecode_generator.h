...
private:
    ...
    ExpressionResultScope *GetExecutionResult() {
    ...
    void SetExecutionResult(ExpressionResultScope *exec_result) {
        execution_result_ = exec_result;
    }
