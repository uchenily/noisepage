...
public:
     ...
     */
    static void SelectEqualVal(const exec::ExecutionSettings &exec_settings,
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectGreaterThanVal(const exec::ExecutionSettings &exec_settings,
                                     VectorProjection              *vector_projection,
                                     uint32_t                       col_idx,
                                     const GenericValue            &val,
                                     TupleIdList                   *tid_list);
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectLessThanEqualVal(const exec::ExecutionSettings &exec_settings,
                                       VectorProjection              *vector_projection,
                                       uint32_t                       col_idx,
                                       const GenericValue            &val,
                                       TupleIdList                   *tid_list);
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectLessThanVal(const exec::ExecutionSettings &exec_settings,
                                  VectorProjection              *vector_projection,
                                  uint32_t                       col_idx,
                                  const GenericValue            &val,
                                  TupleIdList                   *tid_list);
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectNotEqualVal(const exec::ExecutionSettings &exec_settings,
                                  VectorProjection              *vector_projection,
                                  uint32_t                       col_idx,
                                  const GenericValue            &val,
                                  TupleIdList                   *tid_list);
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectLikeVal(const exec::ExecutionSettings &exec_settings,
                              VectorProjection              *vector_projection,
                              uint32_t                       col_idx,
                              const Val                     &val,
                              TupleIdList                   *tid_list);
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectNotLikeVal(const exec::ExecutionSettings &exec_settings,
                                 VectorProjection              *vector_projection,
                                 uint32_t                       col_idx,
                                 const Val                     &val,
                                 TupleIdList                   *tid_list);
     ...
     * @param tid_list The tuple ID list to use.
     */
    static void SelectLike(const exec::ExecutionSettings &exec_settings,
                           VectorProjection              *vector_projection,
                           uint32_t                       left_col_idx,
                           uint32_t                       right_col_idx,
                           TupleIdList                   *tid_list);
