...
public:
    ...
    static void Lpad(StringVal              *result,
    ...
    static void Rpad(StringVal              *result,
                     exec::ExecutionContext *ctx,
                     const StringVal        &str,
                     const Integer          &len,
                     const StringVal        &pad);
    ...
    static void SplitPart(StringVal              *result,
                          exec::ExecutionContext *ctx,
                          const StringVal        &str,
    ...
    static void Substring(StringVal              *result,
                          exec::ExecutionContext *ctx,
                          const StringVal        &str,
                          const Integer          &pos,
                          const Integer          &len);
    ...
    static void Position(Integer                *result,
                         exec::ExecutionContext *ctx,
