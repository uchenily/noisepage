...
private:
     ...
     */
    CteScanPlanNode(std::string                                      &&cte_table_name,
        ...
        : SeqScanPlanNode(std::move(children),
...
public:
     ...
     */
    void SetLeader(common::ManagedPointer<const planner::CteScanPlanNode> leader) {
        leader_ = leader;
    }
     ...
     */
    common::ManagedPointer<const planner::CteScanPlanNode> GetLeader() const {
        return leader_;
    }
     ...
     */
    void SetCTEType(parser::CteType cte_type) {
        cte_type_ = cte_type;
    }
