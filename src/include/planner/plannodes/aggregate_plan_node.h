...
public:
     ...
     */
    const std::vector<GroupByTerm> &GetGroupByTerms() const {
        return groupby_terms_;
    }
     ...
     */
    const std::vector<AggregateTerm> &GetAggregateTerms() const {
     ...
     */
    AggregateStrategyType GetAggregateStrategyType() const {
    ...
    bool IsStaticAggregation() const {
        return GetGroupByTerms().empty();
    }
