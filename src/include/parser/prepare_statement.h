...
namespace parser {
    ...
    public:
        ...
        /** @return query */
        common::ManagedPointer<SQLStatement> GetQuery() {
            return common::ManagedPointer(query_);
        }

        /** @return placeholders */
        const std::vector<common::ManagedPointer<ParameterValueExpression>> &GetPlaceholders() {
