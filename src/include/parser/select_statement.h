...
namespace parser {
    ...
    public:
         ...
         */
        std::vector<OrderType> GetOrderByTypes() {
            return types_;
        }
         ...
         */
        size_t GetOrderByExpressionsSize() const {
            return exprs_.size();
        }
         ...
         */
        std::vector<common::ManagedPointer<AbstractExpression>> &GetOrderByExpressions() {
            return exprs_;
        }
    ...
    public:
        ...
        const std::vector<common::ManagedPointer<AbstractExpression>> &GetColumns() {
            return columns_;
        }

        /** @return having clause */
        common::ManagedPointer<AbstractExpression> GetHaving() {
            return common::ManagedPointer(having_);
        }
    ...
    public:
         ...
         */
        SelectStatement(std::vector<common::ManagedPointer<AbstractExpression>> select,
        ...
        bool IsSelectDistinct() const {
            return select_distinct_;
        }

        /** @return The table over which SELECT is performed */
        common::ManagedPointer<TableRef> GetSelectTable() {
            return common::ManagedPointer(from_);
        }

        /** @return `true` if the SELECT statement has a target table, `false` otherwise */
        bool HasSelectTable() const {
            return static_cast<bool>(from_);
        }

        /** @return The predicate associated with SELECT */
        common::ManagedPointer<AbstractExpression> GetSelectCondition() {
            return where_;
        }

        /** @return The GROUP BY associated with SELECT */
        common::ManagedPointer<GroupByDescription> GetSelectGroupBy() {
            return common::ManagedPointer(group_by_);
        }

        /** @return The ORDER BY associated with SELECT */
        common::ManagedPointer<OrderByDescription> GetSelectOrderBy() {
            return common::ManagedPointer(order_by_);
        }

        /** @return The LIMIT associated with SELECT */
        common::ManagedPointer<LimitDescription> GetSelectLimit() {
            return common::ManagedPointer(limit_);
        }
        ...
        std::vector<common::ManagedPointer<TableRef>> GetSelectWith() {
            ...
            std::transform(with_table_.cbegin(),
                           with_table_.cend(),
         ...
         */
        bool HasUnionSelect() const {
            return static_cast<bool>(union_select_);
        }
    ...
    private:
        ...
        void SetSelectColumns(std::vector<common::ManagedPointer<AbstractExpression>> select) {
            select_ = std::move(select);
        }
