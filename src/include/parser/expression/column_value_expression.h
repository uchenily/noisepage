...
public:
     ...
     */
    ColumnValueExpression(std::string               table_name,
                          std::string               col_name,
     ...
     * @param column_oid Oid of the column (it should be a temp oid in this case)
     */
    ColumnValueExpression(AliasType                 table_alias,
                          std::string               col_name,
                          execution::sql::SqlTypeId type,
                          AliasType                 alias,
                          catalog::col_oid_t        column_oid)
    ...
    /** @return column oid */
    catalog::col_oid_t GetColumnOid() const {
        return column_oid_;
    }
...
private:
    ...
    void SetTableOID(catalog::table_oid_t table_oid) {
        table_oid_ = table_oid;
    }
    /** @param column_oid Column OID to be assigned to this expression */
    void SetColumnOID(catalog::col_oid_t column_oid) {
        column_oid_ = column_oid;
    }
    /** @param column_oid Column OID to be assigned to this expression */
