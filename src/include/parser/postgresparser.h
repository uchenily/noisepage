...
private:
    ...
    // SELECT helpers
    static std::vector<common::ManagedPointer<AbstractExpression>> TargetTransform(ParseResult *parse_result,
                                                                                   List        *root);
    ...
    static std::unique_ptr<std::vector<std::vector<common::ManagedPointer<AbstractExpression>>>>
