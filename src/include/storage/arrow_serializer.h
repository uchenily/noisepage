...
public:
     ...
     */
    explicit ArrowSerializer(const DataTable &dataTable)
     ...
     *
     * Message body is the data. They are organized as several Buffers, where a Buffer corresponds to a continuous
     * memory block and is exactly the same concept as the Buffer above. Therefore, by parsing the metadata_flatbuffer,
     * we can pinpoint and read the corresponding data.
     *
