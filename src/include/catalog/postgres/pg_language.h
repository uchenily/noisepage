...
private:
    ...
    static constexpr CatalogColumnDef<proc_oid_t, uint32_t> LANVALIDATOR{
        col_oid_t{7}}; // INTEGER (skey) (fkey: pg_proc)

    static constexpr uint8_t NUM_PG_LANGUAGE_COLS = 7;

    static constexpr std::array<col_oid_t, NUM_PG_LANGUAGE_COLS> PG_LANGUAGE_ALL_COL_OIDS = {LANOID.oid_,
                                                                                             LANNAME.oid_,
                                                                                             LANISPL.oid_,
                                                                                             LANPLTRUSTED.oid_,
                                                                                             LANPLCALLFOID.oid_,
