...
private:
     ...
     */
    bool SetProcCtxPtr(common::ManagedPointer<transaction::TransactionContext> txn,
                       proc_oid_t                                              proc_oid,
    ...
    GetProcCtxPtr(common::ManagedPointer<transaction::TransactionContext> txn, proc_oid_t proc_oid);
     ...
     * @param is_exec_ctx_required    True if this function requires an execution context variable as its first
     * argument.
     */
