...
public:
     ...
     */
    static void
    RecordQueryParameters(uint64_t timestamp_to_record,
     ...
     * @param task_manager Task manager to use for submitting jobs
     */
    static void RecordForecastClusters(uint64_t                                       timestamp_to_record,
     ...
     * @param task_manager Task Manager to use for submitting jobs
     */
    static void RecordAppliedAction(uint64_t                                  timestamp_to_record,
