...
void Callbacks::NoOp(void                                         *old_value,
                     void                                         *new_value,
                     DBMain *const                                 db_main,
                     common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::SUCCESS);
}

void Callbacks::BufferSegmentPoolSizeLimit(void *const                                   old_value,
...
void Callbacks::BlockStoreSizeLimit(void *const                                   old_value,
                                    void *const                                   new_value,
                                    DBMain *const                                 db_main,
                                    common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::WalNumBuffers(void *const                                   old_value,
                              void *const                                   new_value,
                              DBMain *const                                 db_main,
                              common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsLogging(void *const                                   old_value,
                               void *const                                   new_value,
                               DBMain *const                                 db_main,
                               common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsTransaction(void *const                                   old_value,
                                   void *const                                   new_value,
                                   DBMain *const                                 db_main,
                                   common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsGC(void *const                                   old_value,
                          void *const                                   new_value,
                          DBMain *const                                 db_main,
                          common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsExecution(void *const                                   old_value,
                                 void *const                                   new_value,
                                 DBMain *const                                 db_main,
                                 common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsPipeline(void *const                                   old_value,
                                void *const                                   new_value,
                                DBMain *const                                 db_main,
                                common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsPipelineSampleRate(void                                         *old_value,
                                          void                                         *new_value,
                                          DBMain                                       *db_main,
                                          common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsLoggingSampleRate(void                                         *old_value,
                                         void                                         *new_value,
                                         DBMain                                       *db_main,
                                         common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
    int interval = *static_cast<int *>(new_value);
    db_main->GetMetricsManager()->SetMetricSampleRate(metrics::MetricsComponent::LOGGING,
                                                      static_cast<uint8_t>(interval));
    action_context->SetState(common::ActionState::SUCCESS);
}

void Callbacks::MetricsBindCommand(void *const                                   old_value,
                                   void *const                                   new_value,
                                   DBMain *const                                 db_main,
                                   common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsExecuteCommand(void *const                                   old_value,
                                      void *const                                   new_value,
                                      DBMain *const                                 db_main,
                                      common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsQueryTrace(void *const                                   old_value,
                                  void *const                                   new_value,
                                  DBMain *const                                 db_main,
                                  common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::MetricsQueryTraceOutput(void *const                                   old_value,
                                        void *const                                   new_value,
                                        DBMain *const                                 db_main,
                                        common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::CompiledQueryExecution(void *const                                   old_value,
                                       void *const                                   new_value,
                                       DBMain *const                                 db_main,
                                       common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::ClearQueryCache(void                                         *old_value,
                                void                                         *new_value,
                                DBMain                                       *db_main,
                                common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::ForecastSampleLimit(void                                         *old_value,
                                    void                                         *new_value,
                                    DBMain                                       *db_main,
                                    common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::TaskPoolSize(void                                         *old_value,
                             void                                         *new_value,
                             DBMain                                       *db_main,
                             common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::PilotEnablePlanning(void *const                                   old_value,
                                    void *const                                   new_value,
                                    DBMain *const                                 db_main,
                                    common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::TrainForecastModel(void                                         *old_value,
                                   void                                         *new_value,
                                   DBMain                                       *db_main,
                                   common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
...
void Callbacks::TrainInterferenceModel(void                                         *old_value,
                                       void                                         *new_value,
                                       DBMain                                       *db_main,
                                       common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
    ...
    std::vector<std::string> methods;
    {
        auto method_str = std::string(
            settings->GetValue(settings::Param::interference_model_train_methods).Peek<std::string_view>());
    ...
    ms_manager->TrainInterferenceModel(methods,
                                       input_path,
                                       interference_model_save,
                                       ou_model_save,
                                       sample_rate,
...
void Callbacks::TrainOUModel(void                                         *old_value,
                             void                                         *new_value,
                             DBMain                                       *db_main,
                             common::ManagedPointer<common::ActionContext> action_context) {
    action_context->SetState(common::ActionState::IN_PROGRESS);
    ...
    {
        auto method_str
            = std::string(settings->GetValue(settings::Param::ou_model_train_methods).Peek<std::string_view>());
        std::stringstream ss(method_str);
        while (ss.good()) {
            std::string token;
            std::getline(ss, token, ',');
    ...
    modelserver::ModelServerFuture<std::string> future;
    ms_manager->TrainModel(modelserver::ModelType::Type::OperatingUnit,
                           methods,
                           &input_path,
                           ou_model_save,
                           nullptr,
...
#define SETTINGS_GENERATE_LOGGER_CALLBACK(component)                                                                   \
    void Callbacks::LogLevelSet##component(void                                         *old_value,                    \
                                           void                                         *new_value,                    \
                                           DBMain                                       *db_main,                      \
                                           common::ManagedPointer<common::ActionContext> action_context) {             \
        action_context->SetState(common::ActionState::IN_PROGRESS);                                                    \
