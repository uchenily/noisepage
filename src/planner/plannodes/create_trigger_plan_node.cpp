...
auto CreateTriggerPlanNode::Builder::Build() -> std::unique_ptr<CreateTriggerPlanNode> {
    return std::unique_ptr<CreateTriggerPlanNode>(new CreateTriggerPlanNode(std::move(children_),
                                                                            ...
                                                                            namespace_oid_,
                                                                            table_oid_,
                                                                            std::move(trigger_name_),
                                                                            std::move(trigger_funcnames_),
                                                                            std::move(trigger_args_),
                                                                            std::move(trigger_columns_),
                                                                            trigger_when_,
                                                                            trigger_type_,
                                                                            plan_node_id_));
}

CreateTriggerPlanNode::CreateTriggerPlanNode(std::vector<std::unique_ptr<AbstractPlanNode>>   &&children,
