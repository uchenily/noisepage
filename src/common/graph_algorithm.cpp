...
bool Isomorphic(const Graph &lhs, const Graph &rhs) {
    ...
    std::set_symmetric_difference(lhs_nodes.cbegin(),
                                  lhs_nodes.cend(),
                                  rhs_nodes.cbegin(),
                                  rhs_nodes.cend(),
    ...
    for (const auto &id : lhs_nodes) {
        ...
        std::set_symmetric_difference(lhs_edges.cbegin(),
                                      lhs_edges.cend(),
                                      rhs_edges.cbegin(),
                                      rhs_edges.cend(),
                                      std::back_inserter(difference));
...
namespace detail {
     ...
     */
    static void FinishingTimeDFSVisit(const Graph                                  &graph,
                                      std::size_t                                   vertex,
...
std::vector<std::size_t> TopologicalSort(const Graph &graph) {
    ...
    std::sort(topological_sort.begin(),
