...
template void StorageUtil::CopyWithNullCheck<ProjectedColumns::RowView>(const byte *,
                                                                        ProjectedColumns::RowView *,
                                                                        uint16_t,
                                                                        uint16_t);
template void
StorageUtil::CopyWithNullCheck<execution::sql::VectorProjection::RowView>(const byte *,
                                                                          execution::sql::VectorProjection::RowView *,
                                                                          uint16_t,
                                                                          uint16_t);
...
template void
StorageUtil::CopyAttrIntoProjection<ProjectedRow>(const TupleAccessStrategy &, TupleSlot, ProjectedRow *, uint16_t);
template void StorageUtil::CopyAttrIntoProjection<ProjectedColumns::RowView>(const TupleAccessStrategy &,
                                                                             TupleSlot,
                                                                             ProjectedColumns::RowView *,
                                                                             uint16_t);
template void StorageUtil::CopyAttrIntoProjection<execution::sql::VectorProjection::RowView>(
    const TupleAccessStrategy &,
    TupleSlot,
    execution::sql::VectorProjection::RowView *,
    uint16_t);
...
template void StorageUtil::CopyAttrFromProjection<ProjectedRow>(const TupleAccessStrategy &,
                                                                ...
                                                                const ProjectedRow &,
                                                                uint16_t);
template void StorageUtil::CopyAttrFromProjection<ProjectedColumns::RowView>(const TupleAccessStrategy &,
                                                                             TupleSlot,
...
template void StorageUtil::CopyAttrFromProjection<execution::sql::VectorProjection::RowView>(
    const TupleAccessStrategy &,
    TupleSlot,
    const execution::sql::VectorProjection::RowView &,
    uint16_t);
...
template void
StorageUtil::ApplyDelta<ProjectedRow>(const BlockLayout &layout, const ProjectedRow &delta, ProjectedRow *buffer);
template void StorageUtil::ApplyDelta<ProjectedColumns::RowView>(const BlockLayout         &layout,
                                                                 const ProjectedRow        &delta,
                                                                 ProjectedColumns::RowView *buffer);
template void
StorageUtil::ApplyDelta<execution::sql::VectorProjection::RowView>(const BlockLayout                         &layout,
                                                                   const ProjectedRow                        &delta,
...
void StorageUtil::ComputeAttributeSizeBoundaries(const noisepage::storage::BlockLayout &layout,
                                                 const col_id_t                        *col_ids,
                                                 const uint16_t                         num_cols,
                                                 uint16_t                              *attr_boundaries) {
...
void StorageUtil::PopulateColumnMap(ColumnMap                                  *col_map,
