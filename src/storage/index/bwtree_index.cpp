...
BwTreeIndex<KeyType>::BwTreeIndex(IndexMetadata metadata)
    ...
    , bwtree_(std::make_unique<third_party::bwtree::BwTree<KeyType, TupleSlot>>(false)) {}
...
template <typename KeyType>
void BwTreeIndex<KeyType>::ScanKey(const transaction::TransactionContext &txn,
...
template <typename KeyType>
void BwTreeIndex<KeyType>::ScanAscending(const transaction::TransactionContext &txn,
                                         ScanType                               scan_type,
                                         uint32_t                               num_attrs,
...
template <typename KeyType>
void BwTreeIndex<KeyType>::ScanLimitDescending(const transaction::TransactionContext &txn,
                                               const ProjectedRow                    &low_key,
                                               const ProjectedRow                    &high_key,
                                               std::vector<TupleSlot>                *value_list,
