        ...
        if (enabled_metrics_.test(component)) {
            ...
            case MetricsComponent::GARBAGECOLLECTION: {
                NOISEPAGE_ASSERT(gc_metric_ != nullptr,
                                 "GarbageCollectionMetric cannot be a nullptr. Check the MetricsStore constructor that "
                                 "it was allocated.");
            ...
            case MetricsComponent::EXECUTE_COMMAND: {
                NOISEPAGE_ASSERT(execute_command_metric_ != nullptr,
                                 "ExecuteCommandMetric cannot be a nullptr. Check the MetricsStore constructor that it "
                                 "was allocated.");
