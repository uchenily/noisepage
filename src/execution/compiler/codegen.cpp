...
ast::Expr *CodeGen::IndexIteratorInit(ast::Identifier iter,
...
ast::Expr *CodeGen::IndexIteratorInit(ast::Expr      *iter_ptr,
                                      ast::Expr      *exec_ctx_var,
                                      uint32_t        num_attrs,
                                      uint32_t        table_oid,
                                      uint32_t        index_oid,
...
ast::Expr *CodeGen::PRSet(ast::Expr                *pr,
...
catalog::CatalogAccessor *CodeGen::GetCatalogAccessor() const {
    return accessor_;
}

ast::Expr *CodeGen::TableIterInit(ast::Expr           *table_iter,
                                  ast::Expr           *exec_ctx,
...
ast::Expr *CodeGen::TempTableIterInit(ast::Identifier tvi,
...
ast::Expr *CodeGen::IterateTableParallel(catalog::table_oid_t table_oid,
                                         ast::Identifier      col_oids,
...
ast::Expr *CodeGen::VPIFilter(ast::Expr             *exec_ctx,
                              ast::Expr             *vp,
...
ast::Expr *
CodeGen::ExecOUFeatureVectorRecordFeature(ast::Expr                                           *ouvec,
...
ast::Expr *CodeGen::TLSReset(ast::Expr      *tls,
...
ast::Expr *
CodeGen::JoinHashTableInit(ast::Expr *join_hash_table, ast::Expr *exec_ctx, ast::Identifier build_row_type_name) {
    ast::Expr *call
...
ast::Expr *
CodeGen::JoinHashTableInsert(ast::Expr *join_hash_table, ast::Expr *hash_val, ast::Identifier tuple_type_name) {
...
ast::Expr *
CodeGen::JoinHashTableBuildParallel(ast::Expr *join_hash_table, ast::Expr *thread_state_container, ast::Expr *offset) {
    ast::Expr *call
...
ast::Expr *CodeGen::AggHashTableLookup(ast::Expr      *agg_ht,
                                       ast::Expr      *hash_val,
...
ast::Expr *CodeGen::AggHashTableInsert(ast::Expr      *agg_ht,
                                       ast::Expr      *hash_val,
                                       bool            partitioned,
                                       ast::Identifier agg_payload_type) {
...
ast::Expr *CodeGen::AggHashTableMovePartitions(ast::Expr      *agg_ht,
                                               ast::Expr      *tls,
...
ast::Expr *CodeGen::AggHashTableParallelScan(ast::Expr      *agg_ht,
                                             ast::Expr      *query_state,
...
ast::Expr *
CodeGen::AggregatorResult(ast::Expr *exec_ctx, ast::Expr *agg, const parser::ExpressionType &expression_type) {
...
ast::Expr *CodeGen::SorterInit(ast::Expr      *sorter,
                               ast::Expr      *exec_ctx,
...
ast::Expr *CodeGen::StorageInterfaceInit(ast::Expr      *storage_interface_ptr,
                                         ast::Expr      *exec_ctx,
                                         uint32_t        table_oid,
                                         ast::Identifier col_oids,
                                         bool            need_indexes) {
...
ast::Expr *CodeGen::CteScanIteratorInit(ast::Expr           *csi,
...
ast::Expr *CodeGen::IndCteScanIteratorInit(ast::Expr           *csi,
                                           catalog::table_oid_t table_oid,
                                           ast::Identifier      col_ids,
                                           ast::Identifier      col_types,
                                           bool                 is_recursive,
...
ast::AstNodeFactory *CodeGen::GetFactory() {
