...
void IndCteScanLeaderTranslator::DeclareIndCteScanIterator(FunctionBuilder *builder) const {
    ...
    ast::Expr *cte_scan_iterator_setup
        = codegen->IndCteScanIteratorInit(cte_scan_val_entry_.GetPtr(codegen),
                                          plan.GetTableOid(),
                                          col_oids_var_,
                                          col_types_,
                                          plan.GetIsRecursive(),
    ...
    ast::Stmt *pointer_setup = codegen->Assign(
        cte_scan_ptr_entry_.Get(codegen),
...
void IndCteScanLeaderTranslator::FillPRFromChild(WorkContext     *context,
