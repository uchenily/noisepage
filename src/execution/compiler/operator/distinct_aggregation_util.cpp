...
DistinctAggregationFilter::DistinctAggregationFilter(size_t                        agg_term_idx,
...
void DistinctAggregationFilter::AggregateDistinct(CodeGen                        *codegen,
    ...
    auto lookup_call = codegen->AggHashTableLookup(ht_.GetPtr(codegen),
                                                   codegen->MakeExpr(hash_keys),
                                                   key_check_fn_,
                                                   codegen->AddressOf(codegen->MakeExpr(lookup_key)),
                                                   key_type_);
    ...
    If check_new_key(function, codegen->IsNilPointer(codegen->MakeExpr(lookup_payload)));
    {
        ...
        auto insert_call
            = codegen->AggHashTableInsert(ht_.GetPtr(codegen), codegen->MakeExpr(hash_keys), false, key_type_);
...
void DistinctAggregationFilter::AssignPayload(CodeGen         *codegen,
                                              FunctionBuilder *function,
