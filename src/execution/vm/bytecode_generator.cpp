...
public:
    ...
    virtual ~ExpressionResultScope() {
        generator_->SetExecutionResult(outer_scope_);
    }
     ...
     */
    void SetDestination(LocalVar destination) {
        destination_ = destination;
    }
...
public:
    BytecodePositionScope(BytecodeGenerator *generator, FunctionInfo *func)
        : generator_(generator)
        , func_(func)
        , start_offset_(generator->GetEmitter()->GetPosition()) {}
...
void BytecodeGenerator::VisitIfStmt(ast::IfStmt *node) {
    ...
    VisitExpressionForTest(node->Condition(),
                           if_builder.GetThenLabel(),
                           if_builder.GetElseLabel(),
...
void BytecodeGenerator::VisitBuiltinTableIterCall(ast::CallExpr *call, ast::Builtin builtin) {
    ...
    case ast::Builtin::TableIterInit: {
        ...
        GetEmitter()->EmitTableIterInit(Bytecode::TableVectorIteratorInit,
                                        iter,
                                        exec_ctx,
                                        table_oid,
                                        arr,
...
void BytecodeGenerator::VisitBuiltinTableIterParallelCall(ast::CallExpr *call) {
    ...
    // Emit the bytecode.
    GetEmitter()->EmitParallelTableScan(table_oid,
                                        col_oids,
                                        static_cast<uint32_t>(arr_type->GetLength()),
                                        query_state,
                                        exec_ctx,
...
void BytecodeGenerator::VisitBuiltinAggHashTableCall(ast::CallExpr *call, ast::Builtin builtin) {
    ...
    case ast::Builtin::AggHashTableProcessBatch: {
        ...
        GetEmitter()
            ->EmitAggHashTableProcessBatch(agg_ht, vpi, num_keys, key_cols, init_agg_fn, merge_agg_fn, partitioned);
        break;
    }
...
#define AGG_CODES(F)                                                                                                   \
    ...
    F(AvgAggregate,                                                                                                    \
      AvgAggregateInit,                                                                                                \
      AvgAggregateAdvanceInteger,                                                                                      \
      AvgAggregateGetResult,                                                                                           \
      AvgAggregateMerge,                                                                                               \
      AvgAggregateReset,                                                                                               \
      AvgAggregateFree)                                                                                                \
    /* MAX(int_col) */                                                                                                 \
    F(IntegerMaxAggregate,                                                                                             \
    ...
    F(RealSumAggregate,                                                                                                \
      ...
      RealSumAggregateFree)                                                                                            \
    /* MAX(date_col) */                                                                                                \
    F(DateMaxAggregate,                                                                                                \
      DateMaxAggregateInit,                                                                                            \
      DateMaxAggregateAdvance,                                                                                         \
      DateMaxAggregateGetResult,                                                                                       \
      DateMaxAggregateMerge,                                                                                           \
      DateMaxAggregateReset,                                                                                           \
      DateMaxAggregateFree)                                                                                            \
    /* MIN(date_col) */                                                                                                \
    F(DateMinAggregate,                                                                                                \
      DateMinAggregateInit,                                                                                            \
      DateMinAggregateAdvance,                                                                                         \
      DateMinAggregateGetResult,                                                                                       \
      DateMinAggregateMerge,                                                                                           \
      DateMinAggregateReset,                                                                                           \
      DateMinAggregateFree)                                                                                            \
    /* MAX(string_col) */                                                                                              \
    F(StringMaxAggregate,                                                                                              \
      StringMaxAggregateInit,                                                                                          \
      StringMaxAggregateAdvance,                                                                                       \
      StringMaxAggregateGetResult,                                                                                     \
      StringMaxAggregateMerge,                                                                                         \
      StringMaxAggregateReset,                                                                                         \
      StringMaxAggregateFree)                                                                                          \
    /* MIN(string_col) */                                                                                              \
    F(StringMinAggregate,                                                                                              \
      StringMinAggregateInit,                                                                                          \
      StringMinAggregateAdvance,                                                                                       \
      StringMinAggregateGetResult,                                                                                     \
      StringMinAggregateMerge,                                                                                         \
      StringMinAggregateReset,                                                                                         \
      StringMinAggregateFree)                                                                                          \
    /* TOPK(bool_col) */                                                                                               \
    F(BooleanTopKAggregate,                                                                                            \
      BooleanTopKAggregateInit,                                                                                        \
      BooleanTopKAggregateAdvance,                                                                                     \
      BooleanTopKAggregateGetResult,                                                                                   \
      BooleanTopKAggregateMerge,                                                                                       \
      BooleanTopKAggregateReset,                                                                                       \
      BooleanTopKAggregateFree)                                                                                        \
    /* TOPK(int_col) */                                                                                                \
    F(IntegerTopKAggregate,                                                                                            \
      IntegerTopKAggregateInit,                                                                                        \
      IntegerTopKAggregateAdvance,                                                                                     \
      IntegerTopKAggregateGetResult,                                                                                   \
      IntegerTopKAggregateMerge,                                                                                       \
      IntegerTopKAggregateReset,                                                                                       \
      IntegerTopKAggregateFree)                                                                                        \
    /* TOPK(real_col) */                                                                                               \
    F(RealTopKAggregate,                                                                                               \
      RealTopKAggregateInit,                                                                                           \
      RealTopKAggregateAdvance,                                                                                        \
      RealTopKAggregateGetResult,                                                                                      \
      RealTopKAggregateMerge,                                                                                          \
      RealTopKAggregateReset,                                                                                          \
      RealTopKAggregateFree)                                                                                           \
    /* TOPK(decimal_col) */                                                                                            \
    F(DecimalTopKAggregate,                                                                                            \
      DecimalTopKAggregateInit,                                                                                        \
      DecimalTopKAggregateAdvance,                                                                                     \
      DecimalTopKAggregateGetResult,                                                                                   \
      DecimalTopKAggregateMerge,                                                                                       \
      DecimalTopKAggregateReset,                                                                                       \
      DecimalTopKAggregateFree)                                                                                        \
    /* TOPK(string_col) */                                                                                             \
    F(StringTopKAggregate,                                                                                             \
      StringTopKAggregateInit,                                                                                         \
      StringTopKAggregateAdvance,                                                                                      \
      StringTopKAggregateGetResult,                                                                                    \
      StringTopKAggregateMerge,                                                                                        \
      StringTopKAggregateReset,                                                                                        \
      StringTopKAggregateFree)                                                                                         \
    /* TOPK(date_col) */                                                                                               \
    F(DateTopKAggregate,                                                                                               \
      DateTopKAggregateInit,                                                                                           \
      DateTopKAggregateAdvance,                                                                                        \
      DateTopKAggregateGetResult,                                                                                      \
      DateTopKAggregateMerge,                                                                                          \
      DateTopKAggregateReset,                                                                                          \
      DateTopKAggregateFree)                                                                                           \
    /* TOPK(timestamp_col) */                                                                                          \
    F(TimestampTopKAggregate,                                                                                          \
      TimestampTopKAggregateInit,                                                                                      \
      TimestampTopKAggregateAdvance,                                                                                   \
      TimestampTopKAggregateGetResult,                                                                                 \
      TimestampTopKAggregateMerge,                                                                                     \
      TimestampTopKAggregateReset,                                                                                     \
      TimestampTopKAggregateFree)                                                                                      \
    /* HISTOGRAM(bool_col) */                                                                                          \
    F(BooleanHistogramAggregate,                                                                                       \
      BooleanHistogramAggregateInit,                                                                                   \
      BooleanHistogramAggregateAdvance,                                                                                \
      BooleanHistogramAggregateGetResult,                                                                              \
      BooleanHistogramAggregateMerge,                                                                                  \
      BooleanHistogramAggregateReset,                                                                                  \
      BooleanHistogramAggregateFree)                                                                                   \
    /* HISTOGRAM(int_col) */                                                                                           \
    F(IntegerHistogramAggregate,                                                                                       \
      IntegerHistogramAggregateInit,                                                                                   \
      IntegerHistogramAggregateAdvance,                                                                                \
      IntegerHistogramAggregateGetResult,                                                                              \
      IntegerHistogramAggregateMerge,                                                                                  \
      IntegerHistogramAggregateReset,                                                                                  \
      IntegerHistogramAggregateFree)                                                                                   \
    /* HISTOGRAM(real_col) */                                                                                          \
    F(RealHistogramAggregate,                                                                                          \
      RealHistogramAggregateInit,                                                                                      \
      RealHistogramAggregateAdvance,                                                                                   \
      RealHistogramAggregateGetResult,                                                                                 \
      RealHistogramAggregateMerge,                                                                                     \
      RealHistogramAggregateReset,                                                                                     \
      RealHistogramAggregateFree)                                                                                      \
    /* HISTOGRAM(decimal_col) */                                                                                       \
    F(DecimalHistogramAggregate,                                                                                       \
      DecimalHistogramAggregateInit,                                                                                   \
      DecimalHistogramAggregateAdvance,                                                                                \
      DecimalHistogramAggregateGetResult,                                                                              \
      DecimalHistogramAggregateMerge,                                                                                  \
      DecimalHistogramAggregateReset,                                                                                  \
      DecimalHistogramAggregateFree)                                                                                   \
    /* HISTOGRAM(string_col) */                                                                                        \
    F(StringHistogramAggregate,                                                                                        \
      StringHistogramAggregateInit,                                                                                    \
      StringHistogramAggregateAdvance,                                                                                 \
      StringHistogramAggregateGetResult,                                                                               \
      StringHistogramAggregateMerge,                                                                                   \
      StringHistogramAggregateReset,                                                                                   \
      StringHistogramAggregateFree)                                                                                    \
    /* HISTOGRAM(date_col) */                                                                                          \
    F(DateHistogramAggregate,                                                                                          \
      DateHistogramAggregateInit,                                                                                      \
      DateHistogramAggregateAdvance,                                                                                   \
      DateHistogramAggregateGetResult,                                                                                 \
      DateHistogramAggregateMerge,                                                                                     \
      DateHistogramAggregateReset,                                                                                     \
      DateHistogramAggregateFree)                                                                                      \
    /* HISTOGRAM(timestamp_col) */                                                                                     \
    F(TimestampHistogramAggregate,                                                                                     \
      TimestampHistogramAggregateInit,                                                                                 \
      TimestampHistogramAggregateAdvance,                                                                              \
      TimestampHistogramAggregateGetResult,                                                                            \
      TimestampHistogramAggregateMerge,                                                                                \
      TimestampHistogramAggregateReset,                                                                                \
...
void BytecodeGenerator::VisitBuiltinSorterCall(ast::CallExpr *call, ast::Builtin builtin) {
    ...
    case ast::Builtin::SorterInit: {
        ...
        GetEmitter()->EmitSorterInit(Bytecode::SorterInit,
                                     sorter,
                                     exec_ctx,
                                     LookupFuncIdByName(cmp_func_name),
                                     entry_size);
        break;
    }
...
void BytecodeGenerator::VisitBuiltinStorageInterfaceCall(ast::CallExpr *call, ast::Builtin builtin) {
    ...
    case ast::Builtin::StorageInterfaceInit: {
        ...
        GetEmitter()->EmitStorageInterfaceInit(Bytecode::StorageInterfaceInit,
                                               storage_interface,
                                               exec_ctx,
                                               table_oid,
                                               col_oids,
    ...
    case ast::Builtin::TableDelete: {
        LocalVar cond
            = GetExecutionResult()->GetOrCreateDestination(ast::BuiltinType::Get(ctx, ast::BuiltinType::Bool));
    ...
    case ast::Builtin::GetIndexPR: {
        ...
        GetEmitter()->EmitStorageInterfaceGetIndexPR(Bytecode::StorageInterfaceGetIndexPR,
                                                     pr,
                                                     storage_interface,
                                                     index_oid);
        break;
...
void BytecodeGenerator::VisitBuiltinCallExpr(ast::CallExpr *call) {
    ...
    case ast::Builtin::ExecOUFeatureVectorRecordFeature: {
        ...
        GetEmitter()->Emit(Bytecode::ExecOUFeatureVectorRecordFeature,
                           ouvec,
                           pipeline_id,
                           feature_id,
                           feature_attribute,
...
void BytecodeGenerator::VisitBuiltinIndexIteratorCall(ast::CallExpr *call, ast::Builtin builtin) {
    ...
    case ast::Builtin::IndexIteratorInit: {
        ...
        // Emit the initialization codes
        GetEmitter()->EmitIndexIteratorInit(Bytecode::IndexIteratorInit,
                                            iterator,
                                            exec_ctx,
                                            num_attrs,
                                            table_oid,
...
std::unique_ptr<BytecodeModule> BytecodeGenerator::Compile(ast::AstNode *root, const std::string &name) {
    ...
    return std::make_unique<BytecodeModule>(name,
                                            std::move(generator.code_),
                                            std::move(generator.data_),
...
void BytecodeGenerator::VisitBuiltinCteScanCall(ast::CallExpr *call, ast::Builtin builtin) {
    ...
    case ast::Builtin::CteScanInit: {
        ...
        // Emit the initialization codes
        GetEmitter()->EmitCteScanIteratorInit(Bytecode::CteScanInit,
                                              iterator,
                                              exec_ctx,
                                              table_oid,
                                              col_oids,
    ...
    case ast::Builtin::IndCteScanInit: {
        ...
        // Emit the initialization codes
        GetEmitter()->EmitIndCteScanIteratorInit(Bytecode::IndCteScanInit,
                                                 iterator,
                                                 exec_ctx,
                                                 table_oid,
                                                 col_oids,
