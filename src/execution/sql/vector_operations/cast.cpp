...
namespace {
    ...
    void
    StandardTemplatedCastOperation(const exec::ExecutionSettings &exec_settings, const Vector &source, Vector *target) {
    ...
    template <typename InType>
    void CastNumericOperation(const exec::ExecutionSettings &exec_settings,
                              const Vector                  &source,
                              Vector                        *target,
    ...
    void CastDateOperation(const exec::ExecutionSettings &exec_settings,
                           const Vector                  &source,
                           Vector                        *target,
                           SqlTypeId                      target_type) {
        switch (target_type) {
    ...
    void CastTimestampOperation(const exec::ExecutionSettings &exec_settings,
                                const Vector                  &source,
                                Vector                        *target,
                                SqlTypeId                      target_type) {
        switch (target_type) {
    ...
    void CastStringOperation(const exec::ExecutionSettings &exec_settings,
                             const Vector                  &source,
                             Vector                        *target,
                             SqlTypeId                      target_type) {
        switch (target_type) {
...
void VectorOps::Cast(const exec::ExecutionSettings &exec_settings,
                     const Vector                  &source,
                     Vector                        *target,
