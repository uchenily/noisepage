...
void StringFunctions::Concat(StringVal              *result,
...
void StringFunctions::Lpad(StringVal              *result,
                           exec::ExecutionContext *ctx,
                           const StringVal        &str,
                           const Integer          &len,
                           const StringVal        &pad) {
...
void StringFunctions::Rpad(StringVal              *result,
                           exec::ExecutionContext *ctx,
                           const StringVal        &str,
                           const Integer          &len,
                           const StringVal        &pad) {
...
void StringFunctions::StartsWith(BoolVal                *result,
                                 exec::ExecutionContext *ctx,
                                 const StringVal        &str,
...
void StringFunctions::Position(Integer                *result,
                               exec::ExecutionContext *ctx,
                               const StringVal        &search_str,
    ...
    auto it = std::search(search_str_view.begin(),
                          search_str_view.end(),
                          search_sub_str_view.begin(),
                          search_sub_str_view.end(),
                          [](char ch1, char ch2) {
