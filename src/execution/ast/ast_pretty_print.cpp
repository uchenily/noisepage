...
namespace {
    ...
    public:
        explicit AstPrettyPrintImpl(std::ostream &os, AstNode *root)
            : os_(os)
            , root_(root)
            , indent_(0) {}
...
#undef DECLARE_VISIT_METHOD
    ...
    void AstPrettyPrintImpl::VisitBadExpr(BadExpr *node) {
        NOISEPAGE_ASSERT(false, "Invalid");
    }
    ...
    void AstPrettyPrintImpl::VisitDeclStmt(DeclStmt *node) {
    ...
    void AstPrettyPrintImpl::VisitExpressionStmt(ExpressionStmt *node) {
