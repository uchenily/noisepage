...
template double
SelectivityUtil::Equal<execution::sql::Real>(common::ManagedPointer<ColumnStats<execution::sql::Real>> column_stats,
                                             const ValueCondition                                     &condition);
template double SelectivityUtil::Equal<execution::sql::Integer>(
    common::ManagedPointer<ColumnStats<execution::sql::Integer>> column_stats,
    const ValueCondition                                        &condition);
template double SelectivityUtil::Equal<execution::sql::BoolVal>(
    common::ManagedPointer<ColumnStats<execution::sql::BoolVal>> column_stats,
    const ValueCondition                                        &condition);

template double SelectivityUtil::LessThanOrEqualTo<execution::sql::Real>(
    common::ManagedPointer<ColumnStats<execution::sql::Real>> column_stats,
    const ValueCondition                                     &condition);
