...
void ExecutionOperatingUnitFeature::ApplyValueUpdate(ExecutionOperatingUnitFeatureUpdateMode mode,
                                                     size_t                                 *target,
                                                     size_t                                  update) {
    switch (mode) {
...
void ExecOUFeatureVector::UpdateFeature(execution::pipeline_id_t                pipeline_id,
