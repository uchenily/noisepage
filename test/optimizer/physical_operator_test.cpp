...
TEST(OperatorTests, SeqScanTest) {
    ...
    Operator seq_scan_01 = SeqScan::Make(catalog::db_oid_t(2),
                                         catalog::table_oid_t(3),
                                         std::vector<AnnotatedExpression>(),
                                         parser::AliasType("table"),
                                         false)
                               .RegisterWithTxnContext(txn_context);
    Operator seq_scan_03 = SeqScan::Make(catalog::db_oid_t(1),
                                         catalog::table_oid_t(4),
                                         std::vector<AnnotatedExpression>(),
                                         parser::AliasType("table"),
                                         false)
                               .RegisterWithTxnContext(txn_context);
    Operator seq_scan_04 = SeqScan::Make(catalog::db_oid_t(1),
                                         catalog::table_oid_t(3),
                                         std::vector<AnnotatedExpression>(),
                                         parser::AliasType("tableTable"),
                                         false)
                               .RegisterWithTxnContext(txn_context);
    Operator seq_scan_05 = SeqScan::Make(catalog::db_oid_t(1),
                                         catalog::table_oid_t(3),
                                         std::vector<AnnotatedExpression>(),
                                         parser::AliasType("table"),
                                         true)
                               .RegisterWithTxnContext(txn_context);
    Operator seq_scan_1 = SeqScan::Make(catalog::db_oid_t(1),
                                        catalog::table_oid_t(3),
                                        std::vector<AnnotatedExpression>(),
                                        parser::AliasType("table"),
                                        false)
                              .RegisterWithTxnContext(txn_context);
    Operator seq_scan_2 = SeqScan::Make(catalog::db_oid_t(1),
                                        catalog::table_oid_t(3),
                                        std::vector<AnnotatedExpression>(),
                                        parser::AliasType("table"),
                                        false)
                              .RegisterWithTxnContext(txn_context);
    Operator seq_scan_3 = SeqScan::Make(catalog::db_oid_t(1),
                                        catalog::table_oid_t(3),
                                        std::vector<AnnotatedExpression>{annotated_expr_0},
                                        parser::AliasType("table"),
                                        false)
                              .RegisterWithTxnContext(txn_context);
    Operator seq_scan_4 = SeqScan::Make(catalog::db_oid_t(1),
                                        catalog::table_oid_t(3),
                                        std::vector<AnnotatedExpression>{annotated_expr_1},
                                        parser::AliasType("table"),
                                        false)
                              .RegisterWithTxnContext(txn_context);
    Operator seq_scan_5 = SeqScan::Make(catalog::db_oid_t(1),
                                        catalog::table_oid_t(3),
                                        std::vector<AnnotatedExpression>{annotated_expr_2},
                                        parser::AliasType("table"),
                                        false)
                              .RegisterWithTxnContext(txn_context);
    Operator seq_scan_6 = SeqScan::Make(catalog::db_oid_t(1),
                                        catalog::table_oid_t(3),
...
TEST(OperatorTests, IndexScanTest) {
    ...
    Operator index_scan_01 = IndexScan::Make(catalog::db_oid_t(2),
                                             catalog::table_oid_t(4),
    ...
    Operator index_scan_03 = IndexScan::Make(catalog::db_oid_t(1),
                                             catalog::table_oid_t(4),
                                             catalog::index_oid_t(4),
                                             std::vector<AnnotatedExpression>(),
                                             false,
                                             type,
                                             {},
    ...
    Operator index_scan_04 = IndexScan::Make(catalog::db_oid_t(1),
                                             catalog::table_oid_t(5),
                                             catalog::index_oid_t(3),
                                             std::vector<AnnotatedExpression>(),
                                             false,
                                             type,
    ...
    Operator index_scan_05 = IndexScan::Make(catalog::db_oid_t(1),
                                             catalog::table_oid_t(4),
                                             catalog::index_oid_t(3),
                                             std::vector<AnnotatedExpression>(),
                                             true,
                                             ...
                                             true)
                                 .RegisterWithTxnContext(txn_context);
    Operator index_scan_1 = IndexScan::Make(catalog::db_oid_t(1),
                                            catalog::table_oid_t(4),
                                            catalog::index_oid_t(3),
                                            std::vector<AnnotatedExpression>(),
                                            false,
                                            ...
                                            true)
                                .RegisterWithTxnContext(txn_context);
    Operator index_scan_2 = IndexScan::Make(catalog::db_oid_t(1),
                                            catalog::table_oid_t(4),
                                            catalog::index_oid_t(3),
                                            std::vector<AnnotatedExpression>(),
                                            false,
    ...
    Operator index_scan_3 = IndexScan::Make(catalog::db_oid_t(1),
                                            catalog::table_oid_t(4),
                                            catalog::index_oid_t(3),
                                            std::vector<AnnotatedExpression>{annotated_expr_0},
                                            false,
                                            ...
                                            true)
                                .RegisterWithTxnContext(txn_context);
    Operator index_scan_4 = IndexScan::Make(catalog::db_oid_t(1),
                                            catalog::table_oid_t(4),
                                            catalog::index_oid_t(3),
                                            std::vector<AnnotatedExpression>{annotated_expr_1},
                                            false,
                                            ...
                                            true)
                                .RegisterWithTxnContext(txn_context);
    Operator index_scan_5 = IndexScan::Make(catalog::db_oid_t(1),
                                            catalog::table_oid_t(4),
                                            catalog::index_oid_t(3),
                                            std::vector<AnnotatedExpression>{annotated_expr_2},
                                            false,
                                            ...
                                            true)
                                .RegisterWithTxnContext(txn_context);
    Operator index_scan_6 = IndexScan::Make(catalog::db_oid_t(1),
                                            catalog::table_oid_t(4),
                                            catalog::index_oid_t(3),
                                            std::vector<AnnotatedExpression>{annotated_expr_3},
                                            false,
...
TEST(OperatorTests, InnerNLJoinTest) {
    ...
    Operator inner_nl_join_1
        = InnerNLJoin::Make(std::vector<AnnotatedExpression>()).RegisterWithTxnContext(txn_context);
...
TEST(OperatorTests, InnerHashJoinTest) {
    ...
    EXPECT_EQ(inner_hash_join_1.GetContentsAs<InnerHashJoin>()->GetJoinPredicates(),
              std::vector<AnnotatedExpression>());
...
TEST(OperatorTests, InsertTest) {
    ...
    // Check that all of our GET methods work as expected
    Operator op1 = Insert::Make(database_oid,
                                table_oid,
    ...
    // Check that if we make a new object with the same values, then it will
    // be equal to our first object and have the same hash
    Operator op2 = Insert::Make(database_oid,
                                table_oid,
                                std::vector<catalog::col_oid_t>(columns, std::end(columns)),
                                std::vector<std::vector<common::ManagedPointer<parser::AbstractExpression>>>(values))
                       .RegisterWithTxnContext(txn_context);
...
TEST(OperatorTests, ExportExternalFileTest) {
    ...
    Operator    op2
        = ExportExternalFile::Make(parser::ExternalFileFormat::BINARY, file_name_copy, delimiter, quote, escape)
              .RegisterWithTxnContext(txn_context);
    EXPECT_TRUE(op1 == op2);
    EXPECT_EQ(op1.Hash(), op2.Hash());
...
TEST(OperatorTests, HashGroupByTest) {
    ...
    EXPECT_EQ(group_by_3.GetContentsAs<HashGroupBy>()->GetColumns(),
              std::vector<common::ManagedPointer<parser::AbstractExpression>>{x_3});
    EXPECT_EQ(group_by_1_1.GetContentsAs<HashGroupBy>()->GetHaving(),
              std::vector<AnnotatedExpression>{annotated_expr_1});
    EXPECT_EQ(group_by_7_4.GetContentsAs<HashGroupBy>()->GetHaving(),
              std::vector<AnnotatedExpression>{annotated_expr_4});
...
TEST(OperatorTests, SortGroupByTest) {
    ...
    EXPECT_EQ(group_by_3.GetContentsAs<SortGroupBy>()->GetColumns(),
              std::vector<common::ManagedPointer<parser::AbstractExpression>>{x_3});
    EXPECT_EQ(group_by_1_1.GetContentsAs<SortGroupBy>()->GetHaving(),
              std::vector<AnnotatedExpression>{annotated_expr_1});
    EXPECT_EQ(group_by_7_4.GetContentsAs<SortGroupBy>()->GetHaving(),
              std::vector<AnnotatedExpression>{annotated_expr_4});
    EXPECT_TRUE(group_by_1_1 == group_by_2_2);
    EXPECT_FALSE(group_by_1_1 == group_by_7_4);
    EXPECT_FALSE(group_by_1_0 == group_by_1_1);
...
TEST(OperatorTests, CreateFunctionTest) {
    ...
    Operator op1 = CreateFunction::Make(catalog::db_oid_t(1),
    ...
    Operator op2 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function1",
                                        parser::PLType::PL_C,
                                        {},
    ...
    Operator op3 = CreateFunction::Make(catalog::db_oid_t(1),
    ...
    Operator op4 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function4",
                                        parser::PLType::PL_C,
                                        {},
    ...
    Operator op5 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function1",
    ...
    Operator op6 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function1",
                                        parser::PLType::PL_C,
                                        {"body", "body2"},
    ...
    Operator op7 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function1",
                                        parser::PLType::PL_C,
                                        {},
    ...
    Operator op8 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function1",
                                        parser::PLType::PL_C,
                                        {},
    ...
    Operator op9 = CreateFunction::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        "function1",
                                        parser::PLType::PL_C,
                                        {},
    ...
    Operator op10 = CreateFunction::Make(catalog::db_oid_t(1),
                                         catalog::namespace_oid_t(1),
                                         "function1",
                                         parser::PLType::PL_C,
                                         {},
    ...
    Operator op11 = CreateFunction::Make(catalog::db_oid_t(1),
                                         catalog::namespace_oid_t(1),
                                         "function1",
                                         parser::PLType::PL_C,
                                         {},
...
TEST(OperatorTests, CreateIndexTest) {
    ...
    auto                  idx_schema = std::make_unique<catalog::IndexSchema>(
        ...
        storage::index::IndexType::BPLUSTREE,
        true,
        true,
        true,
        true,
...
TEST(OperatorTests, CreateTableTest) {
    ...
    auto col_def = new parser::ColumnDefinition(
        ...
        nullptr,
        4);
    Operator op1 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_1",
    ...
    Operator op2 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_1",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                         common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
    ...
    Operator op3 = CreateTable::Make(catalog::namespace_oid_t(2),
                                     "Table_1",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                         common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
    ...
    Operator op4 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_2",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                         common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
    ...
    Operator op5 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_1",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                         common::ManagedPointer<parser::ColumnDefinition>(col_def),
                                         common::ManagedPointer<parser::ColumnDefinition>(col_def)},
    ...
    Operator op6 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_1",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{},
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
                       .RegisterWithTxnContext(txn_context);
    ...
    auto col_def_2
        = new parser::ColumnDefinition("col_1",
                                       ...
                                       nullptr,
                                       20);
    Operator op7 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_2",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
    ...
    Operator op8 = CreateTable::Make(catalog::namespace_oid_t(1),
                                     "Table_1",
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                         common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                     std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
...
TEST(OperatorTests, CreateTriggerTest) {
    ...
    Operator op1 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
    ...
    Operator op2 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
                                       catalog::table_oid_t(1),
                                       "Trigger_1",
                                       {},
    ...
    Operator op3 = CreateTrigger::Make(catalog::db_oid_t(2),
                                       catalog::namespace_oid_t(1),
                                       catalog::table_oid_t(1),
                                       "Trigger_1",
                                       {},
    ...
    Operator op4 = CreateTrigger::Make(catalog::db_oid_t(1),
    ...
    Operator op5 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
    ...
    Operator op6 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
                                       catalog::table_oid_t(1),
                                       "Trigger_2",
                                       {},
    ...
    Operator op7 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
                                       catalog::table_oid_t(1),
                                       "Trigger_1",
                                       {"func_name"},
    ...
    Operator op8 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
                                       catalog::table_oid_t(1),
                                       "Trigger_1",
                                       {"func_name"},
    ...
    Operator op9 = CreateTrigger::Make(catalog::db_oid_t(1),
                                       catalog::namespace_oid_t(1),
                                       catalog::table_oid_t(1),
                                       "Trigger_1",
                                       {"func_name", "func_name"},
    ...
    Operator op10 = CreateTrigger::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        catalog::table_oid_t(1),
                                        "Trigger_1",
                                        {},
    ...
    Operator op11 = CreateTrigger::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        catalog::table_oid_t(1),
                                        "Trigger_1",
                                        {},
    ...
    Operator op12 = CreateTrigger::Make(catalog::db_oid_t(1),
                                        catalog::namespace_oid_t(1),
                                        catalog::table_oid_t(1),
                                        "Trigger_1",
                                        {},
...
TEST(OperatorTests, CreateViewTest) {
    ...
    auto     stmt = new parser::SelectStatement(std::vector<common::ManagedPointer<parser::AbstractExpression>>{},
                                            ...
                                            nullptr,
                                                {});
    Operator op6 = CreateView::Make(catalog::db_oid_t(1),
                                    catalog::namespace_oid_t(1),
                                    "test_view",
...
TEST(OperatorTests, DropViewTest) {
    ...
    Operator op6
        = DropView::Make(catalog::db_oid_t(1), catalog::view_oid_t(1), true).RegisterWithTxnContext(txn_context);
    EXPECT_FALSE(op1 == op6);
    EXPECT_NE(op1.Hash(), op6.Hash());
