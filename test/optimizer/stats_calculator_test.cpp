...
TEST_F(StatsCalculatorTests, TestLogicalGet) {
    ...
    // CVE for column 1
    parser::ColumnValueExpression col_a(parser::AliasType(table_name_1_),
                                        table_1_col_1_name_,
                                        test_db_oid_,
                                        table_oid_1_,
                                        table_1_col_oid_,
...
TEST_F(StatsCalculatorTests, TestNotPredicate) {
    ...
    parser::ColumnValueExpression col_a(parser::AliasType(table_name_1_),
                                        ...
                                        table_1_col_oid_,
                                        execution::sql::SqlTypeId::Integer);
    auto one = std::make_unique<parser::ConstantValueExpression>(execution::sql::SqlTypeId::Integer,
                                                                 execution::sql::Integer(1));
    ...
    parser::OperatorExpression                         not_op(parser::ExpressionType::OPERATOR_NOT,
...
TEST_F(StatsCalculatorTests, TestLeftSideParamPredicate) {
    ...
    // Constructing Logical Get with predicate with column value on the left side of predicate and param on the right
    // side of predicate "colA = param" from "empty_nullable_table". (param is 1)
    parser::ColumnValueExpression col_a(parser::AliasType(table_name_1_),
                                        table_1_col_1_name_,
                                        test_db_oid_,
                                        table_oid_1_,
...
TEST_F(StatsCalculatorTests, TestRightSidePredicate) {
    ...
    parser::ColumnValueExpression col_a(parser::AliasType(table_name_1_),
                                        ...
                                        table_1_col_oid_,
                                        execution::sql::SqlTypeId::Integer);
    auto three = std::make_unique<parser::ConstantValueExpression>(execution::sql::SqlTypeId::Integer,
...
TEST_F(StatsCalculatorTests, TestRightSideParamPredicate) {
    ...
    // Constructing Logical Get with predicate with column value on the right side of predicate and param on the left
    // side of predicate "param = colA" from "empty_nullable_table". (param is 3)
    parser::ColumnValueExpression col_a(parser::AliasType(table_name_1_),
                                        table_1_col_1_name_,
                                        test_db_oid_,
                                        table_oid_1_,
...
TEST_F(StatsCalculatorTests, TestMultipleParamPredicate) {
    ...
    parser::ColumnValueExpression col_a(parser::AliasType(table_name_2_),
                                        table_2_col_1_name_,
                                        test_db_oid_,
                                        table_oid_2_,
                                        table_2_col_1_oid_,
                                        execution::sql::SqlTypeId::Integer);
    parser::ColumnValueExpression col_b(parser::AliasType(table_name_2_),
                                        table_2_col_2_name_,
                                        test_db_oid_,
                                        table_oid_2_,
                                        table_2_col_2_oid_,
    ...
    Operator logical_get = LogicalGet::Make(test_db_oid_,
                                            table_oid_2_,
                                            {annotated_equals1, annotated_equals2},
                                            parser::AliasType(table_name_2_),
                                            false)
                               .RegisterWithTxnContext(test_txn_);
    GroupExpression *gexpr = new GroupExpression(logical_get, {}, test_txn_);
    gexpr->SetGroupID(group_id_t(1));
...
TEST_F(StatsCalculatorTests, TestAndPredicate) {
    ...
    parser::ComparisonExpression equals_three(parser::ExpressionType::COMPARE_EQUAL,
                                              std::move(equal_three_child_exprs));
...
TEST_F(StatsCalculatorTests, TestLogicalSemiJoin) {
    ...
    parser::ColumnValueExpression col_a1(parser::AliasType(table_name_1_),
                                         table_1_col_1_name_,
                                         test_db_oid_,
                                         table_oid_1_,
                                         table_1_col_oid_,
                                         execution::sql::SqlTypeId::Integer);
    parser::ColumnValueExpression col_a2(parser::AliasType(table_name_2_),
                                         table_2_col_1_name_,
                                         test_db_oid_,
                                         table_oid_2_,
                                         table_2_col_1_oid_,
