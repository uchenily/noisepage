...
protected:
    ...
    void SetUpTables() {
        ...
        auto col = catalog::IndexSchema::Column(
            ...
            true,
            parser::ColumnValueExpression(db_oid_,
                                          table_a_oid_,
                                          accessor_->GetSchema(table_a_oid_).GetColumn("a1").Oid()));
...
TEST_F(OperatorTransformerTest, InsertStatementSelectTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalInsertSelect\",\"Children\":"
...
TEST_F(OperatorTransformerTest, UpdateStatementSimpleTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalUpdate\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, SelectStatementAggregateTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalAggregateAndGroupBy\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, SelectStatementOrderByTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalLimit\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, SelectStatementLeftJoinTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalLeftJoin\",\"Children\":"
...
TEST_F(OperatorTransformerTest, SelectStatementRightJoinTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalRightJoin\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",},{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, SelectStatementInnerJoinTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalInnerJoin\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",},{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, SelectStatementOuterJoinTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalOuterJoin\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",},{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, DeleteStatementWhereTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalDelete\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",}]}";
...
TEST_F(OperatorTransformerTest, CreateDatabaseTest) {
    ...
    auto plan_node = plan_generator.ConvertOpNode(txn_,
                                                  accessor_.get(),
                                                  transformed[0].get(),
                                                  &property_set,
                                                  required_cols,
                                                  output_cols,
                                                  std::move(children_plans),
...
TEST_F(OperatorTransformerTest, CreateFunctionTest) {
    std::string create_sql = "CREATE OR REPLACE FUNCTION increment ("
                             " i DOUBLE"
                             " )"
                             " RETURNS DOUBLE AS $$ "
...
TEST_F(OperatorTransformerTest, SelectWithSingleCteTest) {
    ...
    std::string ref = "{\"Op\":\"LogicalCteScan\",\"Children\":"
                      "[{\"Op\":\"LogicalQueryDerivedGet\",\"Children\":"
                      "[{\"Op\":\"LogicalGet\",}]}]}";
