...
TEST(OperatorTests, LogicalInsertTest) {
    ...
    transaction::TransactionManager txn_manager
        = transaction::TransactionManager(common::ManagedPointer(&timestamp_manager),
                                          common::ManagedPointer(&deferred_action_manager),
                                          common::ManagedPointer(&buffer_pool),
                                          false,
                                          false,
                                          nullptr);
...
TEST(OperatorTests, LogicalInsertSelectTest) {
    ...
    Operator                        op3 = LogicalInsertSelect::Make(other_database_oid, table_oid, std::move(cols3))
                       .RegisterWithTxnContext(txn_context);
    EXPECT_FALSE(op1 == op3);
    EXPECT_NE(op1.Hash(), op3.Hash());
...
TEST(OperatorTests, LogicalGetTest) {
    ...
    Operator logical_get_01 = LogicalGet::Make(catalog::db_oid_t(2),
                                               catalog::table_oid_t(3),
                                               std::vector<AnnotatedExpression>(),
                                               parser::AliasType("table"),
                                               false)
                                  .RegisterWithTxnContext(txn_context);
    Operator logical_get_03 = LogicalGet::Make(catalog::db_oid_t(1),
                                               catalog::table_oid_t(4),
                                               std::vector<AnnotatedExpression>(),
                                               parser::AliasType("table"),
                                               false)
                                  .RegisterWithTxnContext(txn_context);
    Operator logical_get_04 = LogicalGet::Make(catalog::db_oid_t(1),
                                               catalog::table_oid_t(3),
                                               std::vector<AnnotatedExpression>(),
                                               parser::AliasType("tableTable"),
                                               false)
                                  .RegisterWithTxnContext(txn_context);
    Operator logical_get_05 = LogicalGet::Make(catalog::db_oid_t(1),
                                               catalog::table_oid_t(3),
                                               std::vector<AnnotatedExpression>(),
                                               parser::AliasType("table"),
                                               true)
                                  .RegisterWithTxnContext(txn_context);
    Operator logical_get_1 = LogicalGet::Make(catalog::db_oid_t(1),
                                              catalog::table_oid_t(3),
                                              std::vector<AnnotatedExpression>(),
                                              parser::AliasType("table"),
                                              false)
                                 .RegisterWithTxnContext(txn_context);
    Operator logical_get_3 = LogicalGet::Make(catalog::db_oid_t(1),
                                              catalog::table_oid_t(3),
                                              std::vector<AnnotatedExpression>{annotated_expr_0},
                                              parser::AliasType("table"),
                                              false)
                                 .RegisterWithTxnContext(txn_context);
    Operator logical_get_4 = LogicalGet::Make(catalog::db_oid_t(1),
                                              catalog::table_oid_t(3),
                                              std::vector<AnnotatedExpression>{annotated_expr_1},
                                              parser::AliasType("table"),
                                              false)
                                 .RegisterWithTxnContext(txn_context);
    Operator logical_get_5 = LogicalGet::Make(catalog::db_oid_t(1),
                                              catalog::table_oid_t(3),
                                              std::vector<AnnotatedExpression>{annotated_expr_2},
                                              parser::AliasType("table"),
                                              false)
                                 .RegisterWithTxnContext(txn_context);
    Operator logical_get_6 = LogicalGet::Make(catalog::db_oid_t(1),
                                              catalog::table_oid_t(3),
...
TEST(OperatorTests, LogicalCteScanTest) {
    ...
    Operator logical_cte_1
        = LogicalCteScan::Make("cte_1",
                               "cte_1",
                               catalog::MakeTempOid<catalog::table_oid_t>(1000),
                               catalog::Schema(),
    ...
    Operator logical_cte_2
        = LogicalCteScan::Make("cte_1",
                               "cte_1",
                               catalog::MakeTempOid<catalog::table_oid_t>(1001),
                               catalog::Schema(),
    ...
    Operator logical_cte_3
        = LogicalCteScan::Make("cte_2",
                               "cte_1",
                               catalog::MakeTempOid<catalog::table_oid_t>(1002),
                               catalog::Schema(),
...
TEST(OperatorTests, LogicalCreateFunctionTest) {
    ...
    Operator op1 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {},
                                               {"param"},
    ...
    EXPECT_EQ(op1.GetContentsAs<LogicalCreateFunction>()->GetFunctionParameterNames(),
    ...
    Operator op2 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {},
    ...
    Operator op3 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(3),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {},
                                               {"param"},
    ...
    Operator op4 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function4",
                                               parser::PLType::PL_C,
                                               {},
    ...
    Operator op5 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_PGSQL,
                                               {},
                                               {"param"},
                                               {parser::BaseFunctionParameter::DataType::INTEGER},
                                               parser::BaseFunctionParameter::DataType::BOOLEAN,
    ...
    Operator op6 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {"body", "body2"},
    ...
    Operator op7 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {},
    ...
    Operator op8 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {},
    ...
    Operator op9 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               "function1",
                                               parser::PLType::PL_C,
                                               {},
                                               {"param"},
                                               {parser::BaseFunctionParameter::DataType::VARCHAR},
                                               parser::BaseFunctionParameter::DataType::BOOLEAN,
                                               1,
                                               false)
                       .RegisterWithTxnContext(txn_context);
    ...
    Operator op10 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                                catalog::namespace_oid_t(1),
                                                "function1",
                                                parser::PLType::PL_C,
                                                {},
    ...
    Operator op11 = LogicalCreateFunction::Make(catalog::db_oid_t(1),
                                                catalog::namespace_oid_t(1),
                                                "function1",
                                                parser::PLType::PL_C,
                                                {},
...
TEST(OperatorTests, LogicalCreateIndexTest) {
    ...
    Operator op1 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            true,
                                            "index_1",
    ...
    Operator op2 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            true,
    ...
    Operator op3 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            true,
                                            "index_1",
                                            std::move(raw_values_copy),
                                            options)
                       .RegisterWithTxnContext(txn_context);
    ...
    Operator op4 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            true,
                                            "index_1",
                                            std::move(raw_values_copy2),
                                            options)
                       .RegisterWithTxnContext(txn_context);
    ...
    Operator op10 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                             catalog::namespace_oid_t(1),
                                             catalog::table_oid_t(1),
                                             parser::IndexType::BPLUSTREE,
                                             true,
                                             "index_1",
                                             std::move(raw_values_copy3),
                                             options)
                        .RegisterWithTxnContext(txn_context);
    ...
    Operator op5 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(2),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            true,
                                            "index_1",
    ...
    Operator op6 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(2),
                                            parser::IndexType::BPLUSTREE,
                                            true,
                                            "index_1",
                                            std::vector<common::ManagedPointer<parser::AbstractExpression>>{},
    ...
    Operator op7 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::HASH,
                                            true,
                                            "index_1",
                                            std::vector<common::ManagedPointer<parser::AbstractExpression>>{},
                                            options)
    ...
    Operator op8 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            false,
    ...
    Operator op9 = LogicalCreateIndex::Make(catalog::db_oid_t(1),
                                            catalog::namespace_oid_t(1),
                                            catalog::table_oid_t(1),
                                            parser::IndexType::BPLUSTREE,
                                            true,
...
TEST(OperatorTests, LogicalCreateTableTest) {
    ...
    auto col_def = new parser::ColumnDefinition(
        "col_1",
        parser::ColumnDefinition::DataType::INTEGER,
        true,
        true,
        true,
        common::ManagedPointer<parser::AbstractExpression>(
        ...
        nullptr,
        4);
    Operator op1 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_1",
    ...
    Operator op2 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_1",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                                common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
    ...
    Operator op3 = LogicalCreateTable::Make(catalog::namespace_oid_t(2),
                                            "Table_1",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                                common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
    ...
    Operator op4 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_2",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                                common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
    ...
    Operator op5 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_1",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                                common::ManagedPointer<parser::ColumnDefinition>(col_def),
                                                common::ManagedPointer<parser::ColumnDefinition>(col_def)},
    ...
    Operator op6 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_1",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{},
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{})
                       .RegisterWithTxnContext(txn_context);
    ...
    auto col_def_2
        = new parser::ColumnDefinition("col_1",
                                       parser::ColumnDefinition::DataType::VARCHAR,
                                       true,
                                       true,
                                       true,
                                       common::ManagedPointer<parser::AbstractExpression>(
                                           new parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar,
                                                                               col_def_2_string_val.first,
                                                                               std::move(col_def_2_string_val.second))),
                                       nullptr,
                                       20);
    Operator op7 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_2",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
    ...
    auto     foreign_def = new parser::ColumnDefinition({"foreign_col_1"},
                                                        {"col_1"},
                                                    "foreign",
                                                    parser::FKConstrActionType::SETNULL,
                                                    parser::FKConstrActionType::CASCADE,
                                                    parser::FKConstrMatchType::FULL);
    Operator op8 = LogicalCreateTable::Make(catalog::namespace_oid_t(1),
                                            "Table_1",
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
                                                common::ManagedPointer<parser::ColumnDefinition>(col_def)},
                                            std::vector<common::ManagedPointer<parser::ColumnDefinition>>{
...
TEST(OperatorTests, LogicalCreateTriggerTest) {
    ...
    Operator op1 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {},
                                              {},
                                              {catalog::col_oid_t(1)},
                                              common::ManagedPointer<parser::AbstractExpression>(when),
                                              0)
                       .RegisterWithTxnContext(txn_context);
    ...
    Operator op2 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {},
    ...
    Operator op3 = LogicalCreateTrigger::Make(catalog::db_oid_t(2),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {},
    ...
    Operator op4 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(2),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {},
    ...
    Operator op5 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(2),
                                              "Trigger_1",
                                              {},
    ...
    Operator op6 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_2",
                                              {},
    ...
    Operator op7 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {"func_name"},
    ...
    Operator op8 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {"func_name"},
    ...
    Operator op9 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                              catalog::namespace_oid_t(1),
                                              catalog::table_oid_t(1),
                                              "Trigger_1",
                                              {"func_name", "func_name"},
    ...
    Operator op10 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               catalog::table_oid_t(1),
                                               "Trigger_1",
                                               {},
    ...
    Operator op11 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               catalog::table_oid_t(1),
                                               "Trigger_1",
                                               {},
                                               {},
                                               {catalog::col_oid_t(1)},
                                               common::ManagedPointer<parser::AbstractExpression>(when_2),
                                               0)
                        .RegisterWithTxnContext(txn_context);
    EXPECT_FALSE(op11 == op1);
    EXPECT_NE(op1.Hash(), op11.Hash());

    Operator op12 = LogicalCreateTrigger::Make(catalog::db_oid_t(1),
                                               catalog::namespace_oid_t(1),
                                               catalog::table_oid_t(1),
                                               "Trigger_1",
                                               {},
...
TEST(OperatorTests, LogicalCreateViewTest) {
    ...
    auto     stmt = new parser::SelectStatement(std::vector<common::ManagedPointer<parser::AbstractExpression>>{},
                                            true,
                                            nullptr,
                                            nullptr,
                                            nullptr,
                                            ...
                                            nullptr,
                                                {});
    Operator op6 = LogicalCreateView::Make(catalog::db_oid_t(1),
                                           catalog::namespace_oid_t(1),
                                           "test_view",
...
TEST(OperatorTests, LogicalDropViewTest) {
    ...
    Operator op1 = LogicalDropView::Make(catalog::db_oid_t(1), catalog::view_oid_t(1), false)
                       .RegisterWithTxnContext(txn_context);
    ...
    Operator op2 = LogicalDropView::Make(catalog::db_oid_t(1), catalog::view_oid_t(1), false)
                       .RegisterWithTxnContext(txn_context);
    EXPECT_TRUE(op1 == op2);
    EXPECT_EQ(op1.Hash(), op2.Hash());

    Operator op3 = LogicalDropView::Make(catalog::db_oid_t(2), catalog::view_oid_t(1), false)
                       .RegisterWithTxnContext(txn_context);
    EXPECT_TRUE(op1 != op3);
    EXPECT_NE(op1.Hash(), op3.Hash());

    Operator op5 = LogicalDropView::Make(catalog::db_oid_t(1), catalog::view_oid_t(2), false)
                       .RegisterWithTxnContext(txn_context);
    EXPECT_FALSE(op1 == op5);
    EXPECT_NE(op1.Hash(), op5.Hash());
