...
TPCHQuery::MakeExecutableQ1(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper l_seq_scan_out{0, &expr_maker};
    {
        ...
        auto l_returnflag
            = expr_maker.CVE(l_schema.GetColumn("l_returnflag").Oid(), execution::sql::SqlTypeId::Varchar);
        auto l_linestatus
            = expr_maker.CVE(l_schema.GetColumn("l_linestatus").Oid(), execution::sql::SqlTypeId::Varchar);
        ...
        std::vector<catalog::col_oid_t> col_oids = {l_schema.GetColumn("l_returnflag").Oid(),
                                                    l_schema.GetColumn("l_linestatus").Oid(),
                                                    l_schema.GetColumn("l_extendedprice").Oid(),
                                                    l_schema.GetColumn("l_discount").Oid(),
                                                    l_schema.GetColumn("l_tax").Oid(),
...
TPCHQuery::MakeExecutableQ5(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper r_seq_scan_out{0, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> r_col_oids
            = {r_schema.GetColumn("r_name").Oid(), r_schema.GetColumn("r_regionkey").Oid()};
        // Make the output schema
    ...
    execution::compiler::test::OutputSchemaHelper c_seq_scan_out{1, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> c_col_oids
            = {c_schema.GetColumn("c_custkey").Oid(), c_schema.GetColumn("c_nationkey").Oid()};
        // Make the output schema
    ...
    execution::compiler::test::OutputSchemaHelper l_seq_scan_out{1, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> l_col_oids = {l_schema.GetColumn("l_extendedprice").Oid(),
                                                      l_schema.GetColumn("l_discount").Oid(),
                                                      l_schema.GetColumn("l_orderkey").Oid(),
                                                      l_schema.GetColumn("l_suppkey").Oid()};
        // Make the output schema
        l_seq_scan_out.AddOutput("l_extendedprice", l_extendedprice);
        l_seq_scan_out.AddOutput("l_discount", l_discount);
        l_seq_scan_out.AddOutput("l_orderkey", l_orderkey);
    ...
    execution::compiler::test::OutputSchemaHelper s_seq_scan_out{0, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> s_col_oids
...
TPCHQuery::MakeExecutableQ7(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper l_seq_scan_out{1, &expr_maker};
    {
        ...
        auto date_part_oid = accessor->GetProcOid("date_part",
                                                  {accessor->GetTypeOidFromTypeId(execution::sql::SqlTypeId::Date),
        ...
        auto extract_year = expr_maker.Function("extract_year",
                                                {l_shipdate, year_type},
...
TPCHQuery::MakeExecutableQ11(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper ps_seq_scan_out1{1, &expr_maker};
    {
        ...
        auto ps_supplycost
            = expr_maker.CVE(ps_schema.GetColumn("ps_supplycost").Oid(), execution::sql::SqlTypeId::Double);
        ...
        std::vector<catalog::col_oid_t> ps_col_oids = {ps_schema.GetColumn("ps_suppkey").Oid(),
                                                       ...
                                                       ps_schema.GetColumn("ps_supplycost").Oid(),
                                                       ps_schema.GetColumn("ps_availqty").Oid()};
        // Make the output schema
    ...
    execution::compiler::test::OutputSchemaHelper ps_seq_scan_out2{1, &expr_maker};
    {
        ...
        auto ps_supplycost
            = expr_maker.CVE(ps_schema.GetColumn("ps_supplycost").Oid(), execution::sql::SqlTypeId::Double);
        auto ps_availqty = expr_maker.CVE(ps_schema.GetColumn("ps_availqty").Oid(), execution::sql::SqlTypeId::Integer);
        std::vector<catalog::col_oid_t> ps2_col_oids = {ps_schema.GetColumn("ps_suppkey").Oid(),
                                                        ps_schema.GetColumn("ps_partkey").Oid(),
                                                        ps_schema.GetColumn("ps_supplycost").Oid(),
                                                        ps_schema.GetColumn("ps_availqty").Oid()};
        // Make the output schema
...
TPCHQuery::MakeExecutableQ16(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper p_seq_scan_out{0, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> p_col_oids = {p_schema.GetColumn("p_brand").Oid(),
                                                      p_schema.GetColumn("p_type").Oid(),
                                                      p_schema.GetColumn("p_partkey").Oid(),
    ...
    execution::compiler::test::OutputSchemaHelper s_seq_scan_out{0, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> s_col_oids
            = {s_schema.GetColumn("s_suppkey").Oid(), s_schema.GetColumn("s_comment").Oid()};
        // Make the output schema
        s_seq_scan_out.AddOutput("s_suppkey", s_suppkey);
        auto schema = s_seq_scan_out.MakeSchema();
        // Predicate
...
TPCHQuery::MakeExecutableQ18(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper c_seq_scan_out{0, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> c_col_oids
            = {c_schema.GetColumn("c_custkey").Oid(), c_schema.GetColumn("c_name").Oid()};
        // Make the output schema
        c_seq_scan_out.AddOutput("c_custkey", c_custkey);
    ...
    execution::compiler::test::OutputSchemaHelper o_seq_scan_out{1, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> o_col_oids = {o_schema.GetColumn("o_orderkey").Oid(),
                                                      o_schema.GetColumn("o_custkey").Oid(),
                                                      o_schema.GetColumn("o_orderdate").Oid(),
                                                      o_schema.GetColumn("o_totalprice").Oid()};
        // Make the output schema
        o_seq_scan_out.AddOutput("o_orderkey", o_orderkey);
        o_seq_scan_out.AddOutput("o_custkey", o_custkey);
...
TPCHQuery::MakeExecutableQ19(const std::unique_ptr<catalog::CatalogAccessor> &accessor,
    ...
    execution::compiler::test::OutputSchemaHelper l_seq_scan_out{1, &expr_maker};
    {
        ...
        std::vector<catalog::col_oid_t> l_col_oids = {l_schema.GetColumn("l_extendedprice").Oid(),
                                                      l_schema.GetColumn("l_discount").Oid(),
                                                      l_schema.GetColumn("l_partkey").Oid(),
                                                      l_schema.GetColumn("l_quantity").Oid(),
                                                      l_schema.GetColumn("l_shipmode").Oid(),
                                                      l_schema.GetColumn("l_shipinstruct").Oid()};
        // Make the output schema
        l_seq_scan_out.AddOutput("l_extendedprice", l_extendedprice);
        l_seq_scan_out.AddOutput("l_discount", l_discount);
        ...
        // Predicate.
        auto shipmode_comp
            = expr_maker.ConjunctionOr(expr_maker.ComparisonEq(l_shipmode, expr_maker.Constant("AIR")),
    ...
    execution::compiler::test::OutputSchemaHelper p_seq_scan_out{0, &expr_maker};
    {
        ...
        auto p_size = expr_maker.CVE(p_schema.GetColumn("p_size").Oid(), execution::sql::SqlTypeId::Integer);
        std::vector<catalog::col_oid_t> p_col_oids = {p_schema.GetColumn("p_brand").Oid(),
                                                      p_schema.GetColumn("p_container").Oid(),
                                                      p_schema.GetColumn("p_partkey").Oid(),
                                                      p_schema.GetColumn("p_size").Oid()};
        // Make the output schema
        p_seq_scan_out.AddOutput("p_brand", p_brand);
    ...
    execution::compiler::test::OutputSchemaHelper hash_join_out1{0, &expr_maker};
    {
        ...
        auto gen_predicate_clause = [&](const std::string              &brand,
                                        const std::vector<std::string> &sm,
                                        float                           lo_qty,
                                        float                           hi_qty,
                                        int32_t                         lo_size,
                                        int32_t                         hi_size) {
            ...
            return expr_maker.ConjunctionAnd(
                brand_comp,
                expr_maker.ConjunctionAnd(container_comp, expr_maker.ConjunctionAnd(qty_comp, size_comp)));
        };
