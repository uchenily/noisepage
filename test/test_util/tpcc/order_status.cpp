...
// 2.6.2
bool OrderStatus::Execute(transaction::TransactionManager *const txn_manager,
                          Database *const                        db,
                          Worker *const                          worker,
    ...
    *reinterpret_cast<int32_t *>(order_secondary_high_key->AccessForceNotNull(o_id_secondary_key_pr_offset_))
        = 10000000;
    ...
    *reinterpret_cast<int32_t *>(order_secondary_high_key->AccessForceNotNull(o_c_id_secondary_key_pr_offset_)) = c_id;
    ...
    index_scan_results.clear();
    db->order_secondary_index_->ScanLimitDescending(*txn,
                                                    *order_secondary_low_key,
                                                    *order_secondary_high_key,
                                                    &index_scan_results,
                                                    1);
