...
void TpccPlanTest::CheckIndexScan(TpccPlanTest                              *test,
...
TpccPlanTest::Optimize(const std::string &query, catalog::table_oid_t tbl_oid, parser::StatementType stmt_type) {
...
void TpccPlanTest::OptimizeUpdate(const std::string   &query,
                                  catalog::table_oid_t tbl_oid,
...
void TpccPlanTest::OptimizeDelete(const std::string   &query,
                                  catalog::table_oid_t tbl_oid,
                                  void (*Check)(TpccPlanTest                              *test,
                                                catalog::table_oid_t                       tbl_oid,
                                                std::unique_ptr<planner::AbstractPlanNode> plan)) {
...
void TpccPlanTest::OptimizeQuery(const std::string   &query,
                                 catalog::table_oid_t tbl_oid,
                                 void (*Check)(TpccPlanTest                              *test,
                                               parser::SelectStatement                   *sel_stmt,
                                               catalog::table_oid_t                       tbl_oid,
