...
public:
    ...
    catalog::namespace_oid_t NSOid() {
        return test_ns_oid_;
    }

    common::ManagedPointer<storage::BlockStore> BlockStore() {
        return block_store_;
    }
    ...
    std::unique_ptr<exec::ExecutionContext> MakeExecCtx(exec::OutputCallback        *callback = nullptr,
        ...
        return std::make_unique<exec::ExecutionContext>(test_db_oid_,
                                                        common::ManagedPointer(test_txn_),
                                                        callback_ref,
                                                        schema,
