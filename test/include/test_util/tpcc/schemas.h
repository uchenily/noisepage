...
public:
    ...
    static catalog::Schema BuildWarehouseTableSchema() {
        ...
        // 2*W unique IDs
        warehouse_columns.emplace_back("w_id",
                                       execution::sql::SqlTypeId::TinyInt,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // variable text, size 10
        warehouse_columns.emplace_back("w_name",
                                       execution::sql::SqlTypeId::Varchar,
                                       10,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        warehouse_columns.emplace_back("w_street_1",
                                       execution::sql::SqlTypeId::Varchar,
                                       20,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        warehouse_columns.emplace_back("w_street_2",
                                       execution::sql::SqlTypeId::Varchar,
                                       20,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        warehouse_columns.emplace_back("w_city",
                                       execution::sql::SqlTypeId::Varchar,
                                       20,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 2
        warehouse_columns.emplace_back("w_state",
                                       execution::sql::SqlTypeId::Varchar,
                                       2,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 9
        warehouse_columns.emplace_back("w_zip",
                                       execution::sql::SqlTypeId::Varchar,
                                       9,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // signed numeric(4,4)
        warehouse_columns.emplace_back("w_tax",
                                       execution::sql::SqlTypeId::Double,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // signed numeric(12,2)
        warehouse_columns.emplace_back("w_ytd",
                                       execution::sql::SqlTypeId::Double,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
    ...
    static catalog::IndexSchema BuildWarehousePrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        // Primary Key: W_ID
        warehouse_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                          schema.GetColumn(0).Type(),
    ...
    static catalog::Schema BuildDistrictTableSchema() {
        ...
        // 20 unique IDs
        district_columns.emplace_back("d_id",
                                      execution::sql::SqlTypeId::TinyInt,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        district_columns.emplace_back("d_w_id",
                                      execution::sql::SqlTypeId::TinyInt,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // variable text, size 10
        district_columns.emplace_back("d_name",
                                      execution::sql::SqlTypeId::Varchar,
                                      10,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        district_columns.emplace_back("d_street_1",
                                      execution::sql::SqlTypeId::Varchar,
                                      20,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        district_columns.emplace_back("d_street_2",
                                      execution::sql::SqlTypeId::Varchar,
                                      20,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        district_columns.emplace_back("d_city",
                                      execution::sql::SqlTypeId::Varchar,
                                      20,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 2
        district_columns.emplace_back("d_state",
                                      execution::sql::SqlTypeId::Varchar,
                                      2,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 9
        district_columns.emplace_back("d_zip",
                                      execution::sql::SqlTypeId::Varchar,
                                      9,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // signed numeric(4,4)
        district_columns.emplace_back("d_tax",
                                      execution::sql::SqlTypeId::Double,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // signed numeric(12,2)
        district_columns.emplace_back("d_ytd",
                                      execution::sql::SqlTypeId::Double,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // 10,000,000 unique IDs
        district_columns.emplace_back("d_next_o_id",
    ...
    static catalog::IndexSchema BuildDistrictPrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        district_key_schema.emplace_back(schema.GetColumn(1).Name(),
                                         schema.GetColumn(1).Type(),
                                         schema.GetColumn(1).Nullable(),
                                         parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        district_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                         schema.GetColumn(0).Type(),
                                         schema.GetColumn(0).Nullable(),
                                         parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
    ...
    static catalog::Schema BuildCustomerTableSchema() {
        ...
        // 96,000 unique IDs
        customer_columns.emplace_back("c_id",
                                      execution::sql::SqlTypeId::Integer,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 20 unique IDs
        customer_columns.emplace_back("c_d_id",
                                      execution::sql::SqlTypeId::TinyInt,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        customer_columns.emplace_back("c_w_id",
                                      execution::sql::SqlTypeId::TinyInt,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // variable text, size 16
        customer_columns.emplace_back("c_first",
                                      execution::sql::SqlTypeId::Varchar,
                                      16,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 2
        customer_columns.emplace_back("c_middle",
                                      execution::sql::SqlTypeId::Varchar,
                                      2,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 16
        customer_columns.emplace_back("c_last",
                                      execution::sql::SqlTypeId::Varchar,
                                      16,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        customer_columns.emplace_back("c_street_1",
                                      execution::sql::SqlTypeId::Varchar,
                                      20,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        customer_columns.emplace_back("c_street_2",
                                      execution::sql::SqlTypeId::Varchar,
                                      20,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // variable text, size 20
        customer_columns.emplace_back("c_city",
                                      execution::sql::SqlTypeId::Varchar,
                                      20,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 2
        customer_columns.emplace_back("c_state",
                                      execution::sql::SqlTypeId::Varchar,
                                      2,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 9
        customer_columns.emplace_back("c_zip",
                                      execution::sql::SqlTypeId::Varchar,
                                      9,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 16
        customer_columns.emplace_back("c_phone",
                                      execution::sql::SqlTypeId::Varchar,
                                      16,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // date and time
        customer_columns.emplace_back("c_since",
                                      execution::sql::SqlTypeId::Timestamp,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Timestamp));
        // fixed text, size 2
        customer_columns.emplace_back("c_credit",
                                      execution::sql::SqlTypeId::Varchar,
                                      2,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // signed numeric(12,2)
        customer_columns.emplace_back("c_credit_lim",
                                      execution::sql::SqlTypeId::Double,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // signed numeric(4,4)
        customer_columns.emplace_back("c_discount",
                                      execution::sql::SqlTypeId::Double,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // signed numeric(12,2)
        customer_columns.emplace_back("c_balance",
                                      execution::sql::SqlTypeId::Double,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // signed numeric(12,2)
        customer_columns.emplace_back("c_ytd_payment",
                                      execution::sql::SqlTypeId::Double,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // numeric(4)
        customer_columns.emplace_back("c_payment_cnt",
                                      execution::sql::SqlTypeId::SmallInt,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::SmallInt));
        // numeric(4)
        customer_columns.emplace_back("c_delivery_cnt",
                                      execution::sql::SqlTypeId::SmallInt,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::SmallInt));
        // variable text, size 500
        customer_columns.emplace_back("c_data",
                                      execution::sql::SqlTypeId::Varchar,
                                      500,
                                      false,
                                      parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
    ...
    static catalog::IndexSchema BuildCustomerPrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        customer_key_schema.emplace_back(schema.GetColumn(2).Name(),
                                         schema.GetColumn(2).Type(),
                                         schema.GetColumn(2).Nullable(),
                                         parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(2).Oid()));
        customer_key_schema.emplace_back(schema.GetColumn(1).Name(),
                                         schema.GetColumn(1).Type(),
                                         schema.GetColumn(1).Nullable(),
                                         parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        customer_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                         schema.GetColumn(0).Type(),
                                         schema.GetColumn(0).Nullable(),
                                         parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
    ...
    static catalog::IndexSchema BuildCustomerSecondaryIndexSchema(const catalog::Schema          &schema,
        ...
        customer_secondary_key_schema.emplace_back(
            schema.GetColumn(2).Name(),
            schema.GetColumn(2).Type(),
            schema.GetColumn(2).Nullable(),
            parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(2).Oid()));
        customer_secondary_key_schema.emplace_back(
            schema.GetColumn(1).Name(),
            schema.GetColumn(1).Type(),
            schema.GetColumn(1).Nullable(),
            parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        customer_secondary_key_schema.emplace_back(
            schema.GetColumn(5).Name(),
            schema.GetColumn(5).Type(),
            schema.GetColumn(5).TypeModifier(),
            schema.GetColumn(5).Nullable(),
            parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(5).Oid()));
    ...
    static catalog::Schema BuildHistoryTableSchema() {
        ...
        // 96,000 unique IDs
        history_columns.emplace_back("h_c_id",
                                     execution::sql::SqlTypeId::Integer,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 20 unique IDs
        history_columns.emplace_back("h_c_d_id",
                                     execution::sql::SqlTypeId::TinyInt,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        history_columns.emplace_back("h_c_w_id",
                                     execution::sql::SqlTypeId::TinyInt,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 20 unique IDs
        history_columns.emplace_back("h_d_id",
                                     execution::sql::SqlTypeId::TinyInt,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        history_columns.emplace_back("h_w_id",
                                     execution::sql::SqlTypeId::TinyInt,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // date and time
        history_columns.emplace_back("h_date",
                                     execution::sql::SqlTypeId::Timestamp,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::Timestamp));
        // signed numeric(6,2)
        history_columns.emplace_back("h_amount",
                                     execution::sql::SqlTypeId::Double,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // variable text, size 24
        history_columns.emplace_back("h_data",
                                     execution::sql::SqlTypeId::Varchar,
                                     24,
                                     false,
                                     parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
    ...
    static catalog::Schema BuildNewOrderTableSchema() {
        ...
        // 10,000,000 unique IDs
        new_order_columns.emplace_back("no_o_id",
                                       execution::sql::SqlTypeId::Integer,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 20 unique IDs
        new_order_columns.emplace_back("no_d_id",
                                       execution::sql::SqlTypeId::TinyInt,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        new_order_columns.emplace_back("no_w_id",
                                       execution::sql::SqlTypeId::TinyInt,
                                       false,
                                       parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
    ...
    static catalog::IndexSchema BuildNewOrderPrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        new_order_key_schema.emplace_back(schema.GetColumn(2).Name(),
                                          schema.GetColumn(2).Type(),
                                          schema.GetColumn(2).Nullable(),
                                          parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(2).Oid()));
        new_order_key_schema.emplace_back(schema.GetColumn(1).Name(),
                                          schema.GetColumn(1).Type(),
                                          schema.GetColumn(1).Nullable(),
                                          parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        new_order_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                          schema.GetColumn(0).Type(),
                                          schema.GetColumn(0).Nullable(),
                                          parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
    ...
    static catalog::Schema BuildOrderTableSchema() {
        ...
        // 10,000,000 unique IDs
        order_columns.emplace_back("o_id",
                                   execution::sql::SqlTypeId::Integer,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 20 unique IDs
        order_columns.emplace_back("o_d_id",
                                   execution::sql::SqlTypeId::TinyInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        order_columns.emplace_back("o_w_id",
                                   execution::sql::SqlTypeId::TinyInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 96,000 unique IDs
        order_columns.emplace_back("o_c_id",
                                   execution::sql::SqlTypeId::Integer,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // date and time
        order_columns.emplace_back("o_entry_d",
                                   execution::sql::SqlTypeId::Timestamp,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Timestamp));
        // 10 unique IDs, or null
        order_columns.emplace_back("o_carrier_id",
                                   execution::sql::SqlTypeId::TinyInt,
                                   true,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // numeric(2)
        order_columns.emplace_back("o_ol_cnt",
                                   execution::sql::SqlTypeId::TinyInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // numeric(1)
        order_columns.emplace_back("o_all_local",
                                   execution::sql::SqlTypeId::TinyInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));

        NOISEPAGE_ASSERT(order_columns.size() == NUM_ORDER_TABLE_COLS,
                         "Wrong number of columns for Order table schema.");
    ...
    static catalog::IndexSchema BuildOrderPrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        order_key_schema.emplace_back(schema.GetColumn(2).Name(),
                                      schema.GetColumn(2).Type(),
                                      schema.GetColumn(2).Nullable(),
                                      parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(2).Oid()));
        order_key_schema.emplace_back(schema.GetColumn(1).Name(),
                                      schema.GetColumn(1).Type(),
                                      schema.GetColumn(1).Nullable(),
                                      parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        order_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                      schema.GetColumn(0).Type(),
                                      schema.GetColumn(0).Nullable(),
                                      parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
    ...
    static catalog::IndexSchema BuildOrderSecondaryIndexSchema(const catalog::Schema          &schema,
        ...
        order_secondary_key_schema.emplace_back(
            ...
            parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        order_secondary_key_schema.emplace_back(
            schema.GetColumn(3).Name(),
            schema.GetColumn(3).Type(),
    ...
    static catalog::Schema BuildOrderLineTableSchema() {
        ...
        // 10,000,000 unique IDs
        order_line_columns.emplace_back("ol_o_id",
                                        execution::sql::SqlTypeId::Integer,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 20 unique IDs
        order_line_columns.emplace_back("ol_d_id",
                                        execution::sql::SqlTypeId::TinyInt,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 2*W unique IDs
        order_line_columns.emplace_back("ol_w_id",
                                        execution::sql::SqlTypeId::TinyInt,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 15 unique IDs
        order_line_columns.emplace_back("ol_number",
                                        execution::sql::SqlTypeId::TinyInt,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // 200,000 unique IDs
        order_line_columns.emplace_back("ol_i_id",
                                        execution::sql::SqlTypeId::Integer,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 2*W unique IDs
        order_line_columns.emplace_back("ol_supply_w_id",
                                        execution::sql::SqlTypeId::TinyInt,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // date and time, or null
        order_line_columns.emplace_back("ol_delivery_d",
                                        execution::sql::SqlTypeId::Timestamp,
                                        true,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::Timestamp));
        // numeric(2)
        order_line_columns.emplace_back("ol_quantity",
                                        execution::sql::SqlTypeId::TinyInt,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // signed numeric(6,2)
        order_line_columns.emplace_back("ol_amount",
                                        execution::sql::SqlTypeId::Double,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // fixed text, size 24
        order_line_columns.emplace_back("ol_dist_info",
                                        execution::sql::SqlTypeId::Varchar,
                                        24,
                                        false,
                                        parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
    ...
    static catalog::IndexSchema BuildOrderLinePrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        order_line_key_schema.emplace_back(schema.GetColumn(2).Name(),
                                           schema.GetColumn(2).Type(),
                                           schema.GetColumn(2).Nullable(),
                                           parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(2).Oid()));
        order_line_key_schema.emplace_back(schema.GetColumn(1).Name(),
                                           schema.GetColumn(1).Type(),
                                           schema.GetColumn(1).Nullable(),
                                           parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        order_line_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                           schema.GetColumn(0).Type(),
                                           schema.GetColumn(0).Nullable(),
                                           parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
        order_line_key_schema.emplace_back(schema.GetColumn(3).Name(),
                                           schema.GetColumn(3).Type(),
                                           schema.GetColumn(3).Nullable(),
                                           parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(3).Oid()));
    ...
    static catalog::Schema BuildItemTableSchema() {
        ...
        // 200,000 unique IDs
        item_columns.emplace_back("i_id",
                                  execution::sql::SqlTypeId::Integer,
                                  false,
                                  parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 200,000 unique IDs
        item_columns.emplace_back("i_im_id",
                                  execution::sql::SqlTypeId::Integer,
                                  false,
                                  parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // variable text, size 24
        item_columns.emplace_back("i_name",
                                  execution::sql::SqlTypeId::Varchar,
                                  24,
                                  false,
                                  parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // numeric(5,2)
        item_columns.emplace_back("i_price",
                                  execution::sql::SqlTypeId::Double,
                                  false,
                                  parser::ConstantValueExpression(execution::sql::SqlTypeId::Double));
        // variable text, size 50
        item_columns.emplace_back("i_data",
                                  execution::sql::SqlTypeId::Varchar,
                                  50,
                                  false,
                                  parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
    ...
    static catalog::IndexSchema BuildItemPrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        // Primary Key: I_ID
        item_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                     schema.GetColumn(0).Type(),
                                     schema.GetColumn(0).Nullable(),
                                     parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
    ...
    static catalog::Schema BuildStockTableSchema() {
        ...
        // 200,000 unique IDs
        stock_columns.emplace_back("s_i_id",
                                   execution::sql::SqlTypeId::Integer,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // 2*W unique IDs
        stock_columns.emplace_back("s_w_id",
                                   execution::sql::SqlTypeId::TinyInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::TinyInt));
        // signed numeric(4)
        stock_columns.emplace_back("s_quantity",
                                   execution::sql::SqlTypeId::SmallInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::SmallInt));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_01",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_02",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_03",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_04",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_05",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_06",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_07",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_08",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_09",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // fixed text, size 24
        stock_columns.emplace_back("s_dist_10",
                                   execution::sql::SqlTypeId::Varchar,
                                   24,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));
        // numeric(8)
        stock_columns.emplace_back("s_ytd",
                                   execution::sql::SqlTypeId::Integer,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Integer));
        // numeric(4)
        stock_columns.emplace_back("s_order_cnt",
                                   execution::sql::SqlTypeId::SmallInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::SmallInt));
        // numeric(4)
        stock_columns.emplace_back("s_remote_cnt",
                                   execution::sql::SqlTypeId::SmallInt,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::SmallInt));
        // variable text, size 50
        stock_columns.emplace_back("s_data",
                                   execution::sql::SqlTypeId::Varchar,
                                   50,
                                   false,
                                   parser::ConstantValueExpression(execution::sql::SqlTypeId::Varchar));

        NOISEPAGE_ASSERT(stock_columns.size() == NUM_STOCK_TABLE_COLS,
                         "Wrong number of columns for Stock table schema.");
    ...
    static catalog::IndexSchema BuildStockPrimaryIndexSchema(const catalog::Schema          &schema,
        ...
        stock_key_schema.emplace_back(schema.GetColumn(1).Name(),
                                      schema.GetColumn(1).Type(),
                                      schema.GetColumn(1).Nullable(),
                                      parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(1).Oid()));
        stock_key_schema.emplace_back(schema.GetColumn(0).Name(),
                                      schema.GetColumn(0).Type(),
                                      schema.GetColumn(0).Nullable(),
                                      parser::ColumnValueExpression(db_oid, table_oid, schema.GetColumn(0).Oid()));
