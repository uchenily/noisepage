...
private:
    ...
    Database(catalog::Schema item_schema,
             catalog::Schema warehouse_schema,
             catalog::Schema stock_schema,
             catalog::Schema district_schema,
             catalog::Schema customer_schema,
             catalog::Schema history_schema,
             catalog::Schema new_order_schema,
             catalog::Schema order_schema,
             catalog::Schema order_line_schema,

             const common::ManagedPointer<storage::SqlTable> item,
             const common::ManagedPointer<storage::SqlTable> warehouse,
             const common::ManagedPointer<storage::SqlTable> stock,
             const common::ManagedPointer<storage::SqlTable> district,
             const common::ManagedPointer<storage::SqlTable> customer,
             const common::ManagedPointer<storage::SqlTable> history,
             const common::ManagedPointer<storage::SqlTable> new_order,
             const common::ManagedPointer<storage::SqlTable> order,
             ...
             const catalog::index_oid_t warehouse_primary_index_oid,
             const catalog::index_oid_t district_primary_index_oid,
             const catalog::index_oid_t customer_primary_index_oid,
             const catalog::index_oid_t customer_secondary_index_oid,
             const catalog::index_oid_t new_order_primary_index_oid,
             const catalog::index_oid_t order_primary_index_oid,
             const catalog::index_oid_t order_secondary_index_oid,
             const catalog::index_oid_t order_line_primary_index_oid,
             const catalog::index_oid_t item_primary_index_oid,
             const catalog::index_oid_t stock_primary_index_oid)
