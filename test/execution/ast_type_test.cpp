...
public:
    ...
    ast::Identifier Name(const std::string &s) {
...
TEST_F(TypeTest, FunctionTypeCacheTest) {
...

    {
        ...
        auto *type1 = ast::FunctionType::Get(util::RegionVector<ast::Field>(
                                                 {
                                                     {Name("a"), bool_type_1}
        },
                                                 Region()),
        ...
        auto *type2 = ast::FunctionType::Get(util::RegionVector<ast::Field>(
                                                 {
                                                     {Name("a"), bool_type_2}
        },
                                                 Region()),
