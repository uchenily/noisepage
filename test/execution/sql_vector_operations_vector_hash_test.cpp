...
TEST_F(VectorHashTest, HashWithNullInput) {
    ...
    auto input = MakeDateVector({Date::FromYMD(2001, 01, 01),
                                 Date::FromYMD(2002, 01, 01),
                                 Date::FromYMD(2003, 01, 01),
                                 Date::FromYMD(2004, 01, 01),
                                 Date::FromYMD(2005, 01, 01)},
...
TEST_F(VectorHashTest, StringHash) {
    // input = [s, NULL, s, s]
    const char *refs[] = {"short",
                          "medium sized",
                          "quite long indeed, but why, so?",
