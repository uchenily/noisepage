...
TEST_F(AtomicsTest, InterpretedAndOr1) {
    AndOrTest<uint8_t>("uint8", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedAndOr2) {
    AndOrTest<uint16_t>("uint16", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedAndOr4) {
    AndOrTest<uint32_t>("uint32", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedAndOr8) {
    AndOrTest<uint64_t>("uint64", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedCompareExchange1) {
    CompareExchangeTest<uint8_t>("uint8", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedCompareExchange2) {
    CompareExchangeTest<uint16_t>("uint16", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedCompareExchange4) {
    CompareExchangeTest<uint32_t>("uint32", false);
} // NOLINT
TEST_F(AtomicsTest, InterpretedCompareExchange8) {
    CompareExchangeTest<uint64_t>("uint64", false);
} // NOLINT

TEST_F(AtomicsTest, CompiledAndOr1) {
    AndOrTest<uint8_t>("uint8", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledAndOr2) {
    AndOrTest<uint16_t>("uint16", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledAndOr4) {
    AndOrTest<uint32_t>("uint32", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledAndOr8) {
    AndOrTest<uint64_t>("uint64", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledCompareExchange1) {
    CompareExchangeTest<uint8_t>("uint8", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledCompareExchange2) {
    CompareExchangeTest<uint16_t>("uint16", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledCompareExchange4) {
    CompareExchangeTest<uint32_t>("uint32", true);
} // NOLINT
TEST_F(AtomicsTest, CompiledCompareExchange8) {
    CompareExchangeTest<uint64_t>("uint64", true);
} // NOLINT
