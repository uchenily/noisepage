...
protected:
    void SetUp() override {
        ...
        db_main_
            = noisepage::DBMain::Builder().SetUseGC(true).SetUseGCThread(true).SetRecordBufferSegmentSize(1e6).Build();
        ...
        unique_schema_
            = catalog::IndexSchema(keycols, storage::index::IndexType::BWTREE, true, true, false, true, options);
        default_schema_
