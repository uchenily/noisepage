...
TEST(PGParserTests, CreateFunctionTest) {
    ...
    queries.emplace_back("CREATE OR REPLACE FUNCTION increment ("
                         " i DOUBLE"
                         " )"
                         " RETURNS DOUBLE AS $$ "
    ...
    queries.emplace_back("CREATE FUNCTION increment1 ("
                         " i DOUBLE, j DOUBLE"
                         " )"
                         " RETURNS DOUBLE AS $$ "
    ...
    queries.emplace_back("CREATE OR REPLACE FUNCTION increment2 ("
                         " i INTEGER, j INTEGER"
                         " )"
                         " RETURNS INTEGER AS $$ "
                         " BEGIN RETURN i + 1; END; $$ ("
