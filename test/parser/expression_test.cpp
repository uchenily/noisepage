...
TEST(ExpressionTests, ConstantValueExpressionTest) {
    ...
    auto expr_d_2
        = new ConstantValueExpression(execution::sql::SqlTypeId::Double, execution::sql::Real(static_cast<double>(1)));
    auto expr_d_3 = new ConstantValueExpression(execution::sql::SqlTypeId::Double,
                                                execution::sql::Real(static_cast<double>(32768)));
...
TEST(ExpressionTests, AggregateExpressionJsonTest) {
    ...
    std::unique_ptr<AggregateExpression> original_expr
        = std::make_unique<AggregateExpression>(ExpressionType::AGGREGATE_COUNT,
                                                std::move(children),
                                                true /* distinct */);
...
TEST(ExpressionTests, CaseExpressionTest) {
    ...
    auto case_expr = new CaseExpression(execution::sql::SqlTypeId::Boolean,
    ...
    when_clauses_2.emplace_back(
        CaseExpression::WhenClause{std::make_unique<StarExpression>(), std::make_unique<StarExpression>()});
    auto case_expr_2 = new CaseExpression(execution::sql::SqlTypeId::Boolean,
                                          std::move(when_clauses_2),
                                          std::make_unique<StarExpression>());
    ...
    when_clauses_4.emplace_back(
        CaseExpression::WhenClause{std::make_unique<StarExpression>(), std::make_unique<StarExpression>()});
    auto case_expr_4 = new CaseExpression(execution::sql::SqlTypeId::Integer,
                                          std::move(when_clauses_4),
                                          std::make_unique<StarExpression>());
...
TEST(ExpressionTests, CaseExpressionJsonTest) {
    ...
    when_clauses.emplace_back(
        CaseExpression::WhenClause{std::make_unique<StarExpression>(), std::make_unique<StarExpression>()});
    auto case_expr = std::make_unique<CaseExpression>(execution::sql::SqlTypeId::Boolean,
                                                      std::move(when_clauses),
                                                      std::make_unique<StarExpression>());
...
TEST(ExpressionTests, FunctionExpressionTest) {
    auto func_expr_1 = std::make_unique<FunctionExpression>("FullHouse",
                                                            execution::sql::SqlTypeId::Varchar,
                                                            std::vector<std::unique_ptr<AbstractExpression>>());
    auto func_expr_2 = std::make_unique<FunctionExpression>("FullHouse",
                                                            execution::sql::SqlTypeId::Varchar,
                                                            std::vector<std::unique_ptr<AbstractExpression>>());
    auto func_expr_3 = std::make_unique<FunctionExpression>("Flush",
                                                            execution::sql::SqlTypeId::Varchar,
                                                            std::vector<std::unique_ptr<AbstractExpression>>());
    auto func_expr_4 = std::make_unique<FunctionExpression>("FullHouse",
...
TEST(ExpressionTests, OperatorExpressionTest) {
    ...
    auto op_expr_1 = new OperatorExpression(ExpressionType::OPERATOR_NOT,
                                            op_ret_type,
                                            std::vector<std::unique_ptr<AbstractExpression>>());
    ...
    auto op_expr_2 = new OperatorExpression(ExpressionType::OPERATOR_PLUS,
    ...
    auto child3
        = std::make_unique<ConstantValueExpression>(execution::sql::SqlTypeId::Date, execution::sql::DateVal(1));
    children_cp.push_back(std::move(child3));
    auto op_expr_3 = new OperatorExpression(ExpressionType::OPERATOR_CONCAT,
                                            execution::sql::SqlTypeId::Invalid,
...
TEST(ExpressionTests, OperatorExpressionJsonTest) {
    auto operators = {ExpressionType::OPERATOR_UNARY_MINUS,
...
TEST(ExpressionTests, ColumnValueExpressionJsonTest) {
    ...
    std::unique_ptr<ColumnValueExpression> original_expr
        = std::make_unique<ColumnValueExpression>(parser::AliasType("table_name"),
                                                  "column_name",
...
TEST(ExpressionTests, SubqueryExpressionTest) {
    ...
    auto stmts3 = parser::PostgresParser::BuildParseTree("SELECT DISTINCT a, b FROM foo INNER JOIN bar ON foo.a = "
                                                         "bar.a WHERE foo.a > 0 GROUP BY foo.b ORDER BY bar.b ASC "
                                                         "LIMIT 5;");
