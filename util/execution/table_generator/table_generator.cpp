...
void TableGenerator::FillTable(catalog::table_oid_t                      table_oid,
...
void TableGenerator::CreateTable(TableInsertMeta *metadata) {
    ...
    for (const auto &col_meta : metadata->col_meta_) {
        if (col_meta.type_ != execution::sql::SqlTypeId::Varchar) {
            cols.emplace_back(col_meta.name_,
                              col_meta.type_,
                              col_meta.nullable_,
...
void TableGenerator::CreateIndex(IndexInsertMeta *index_meta) {
    ...
    catalog::IndexSchema
        tmp_index_schema{index_cols, storage::index::IndexType::BPLUSTREE, false, false, false, false, options};
    // Create Index
    auto index_oid
...
void TableGenerator::GenerateTestTables() {
 ...
 // Table 1
        {                        "test_1",
         TEST1_SIZE,     {{"colA", execution::sql::SqlTypeId::Integer, false, Dist::Serial, 0, 0},
 ...
 // Table 2
        {                        "test_2",
         TEST2_SIZE,                                   {{"col1", execution::sql::SqlTypeId::SmallInt, false, Dist::Serial, 0, 0},
                                   ...
                                   Dist::Uniform,
                                   0,
                                   common::Constants::K_DEFAULT_VECTOR_SIZE},
                                   {"col4",
 ...
 // Empty table with two columns
        {                  "empty_table2",
         0,         {{"colA", execution::sql::SqlTypeId::Integer, false, Dist::Serial, 0, 0},
         {"colB", execution::sql::SqlTypeId::Boolean, false, Dist::Uniform, 0, 0}}                                           },

 // Table with all types
        {               "all_types_table",
         TABLE_ALLTYPES_SIZE, {// {"varchar_col", execution::sql::SqlTypeId::Varchar, false, Dist::Serial, 0, 0},
 ...
 // Empty table with nullable columns of various types
        {"all_types_empty_nullable_table",
         0,  {{"varchar_col", execution::sql::SqlTypeId::Varchar, true, Dist::Serial, 0, 0},
 ...
 // Empty table with columns of various types
        {         "all_types_empty_table",
         0, {{"varchar_col", execution::sql::SqlTypeId::Varchar, false, Dist::Serial, 0, 0},
 {"date_col", execution::sql::SqlTypeId::Date, false, Dist::Serial, 0, 0},
 {"real_col", execution::sql::SqlTypeId::Double, false, Dist::Serial, 0, 0},
 {"bool_col", execution::sql::SqlTypeId::Boolean, false, Dist::Serial, 0, 0},
 {"tinyint_col", execution::sql::SqlTypeId::TinyInt, false, Dist::Uniform, 0, 127},
 ...
 // Index_test
        {              "index_test_table",
         INDEX_TEST_SIZE,          {{"colA", execution::sql::SqlTypeId::Integer, false, Dist::Serial, 0, 0},
          {"colB", execution::sql::SqlTypeId::Integer, false, Dist::Uniform, 0, 9},
          {"colC", execution::sql::SqlTypeId::Integer, false, Dist::Uniform, 0, 9999},
          {"colD", execution::sql::SqlTypeId::Integer, false, Dist::Uniform, 0, 99999},
        ...
        {       "index_action_test_table",
         INDEX_ACTION_TEST_SIZE,          {{"col1", execution::sql::SqlTypeId::Integer, false, Dist::Serial, 0, 0},
                ...
                for (uint32_t cardinality : cardinalities) {
                    ...
                    for (size_t col_idx = 0; col_idx < col_dist.size(); col_idx++) {
                        for (uint32_t j = 1; j <= col_dist[col_idx]; j++) {
                            ...
                            if (col_metas.empty()) {
                                col_metas.emplace_back(col_name.str(),
                                                       types[col_idx],
                                                       false,
                                                       Dist::Rotate,
                                                       0,
...
void TableGenerator::BuildExecutionRunnerIndex(execution::sql::SqlTypeId type,
                                               uint32_t                  tbl_cols,
                                               int64_t                   row_num,
                                               int64_t                   key_num) {
...
bool TableGenerator::DropExecutionRunnerIndex(execution::sql::SqlTypeId type,
                                              uint32_t                  tbl_cols,
                                              int64_t                   row_num,
                                              int64_t                   key_num) {
    auto table_name = GenerateTableName({type}, {tbl_cols}, row_num, row_num);
    ...
    for (const storage::TupleSlot &slot : *table) {
        ...
        for (uint32_t index_col_idx = 0; index_col_idx < index_meta.cols_.size(); index_col_idx++) {
            ...
            if (index_col.Nullable() && table_pr->IsNull(table_offset)) {
                ...
                auto  type_size = storage::AttrSizeBytes(execution::sql::GetSqlTypeIdSize(index_col.Type()))
...
void TableGenerator::InitTestIndexes() {
 ...
 // Table 2: two cols
        {     "index_2_multi",
         "test_2",        {{"index_col1", execution::sql::SqlTypeId::SmallInt, false, "col1"},
        {"index_col2", execution::sql::SqlTypeId::Integer, true, "col2"}}                                    },

 // Index on a varchar
        {     "varchar_index",
         "all_types_empty_table", {{"index_varchar_col", execution::sql::SqlTypeId::Varchar, false, "varchar_col"}}            },

 // Index action table
        {"index_index_action",
         "index_action_test_table",               {{"index_col1", execution::sql::SqlTypeId::Integer, false, "col1"}}          },
    };
