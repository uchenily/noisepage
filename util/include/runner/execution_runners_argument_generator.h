...
public:
    ...
    using GenArgFn
        = void (*)(OutputArgs *b, const ExecutionRunnersSettings &settings, const ExecutionRunnersDataConfig &config);
     ...
     */
    static void GenArithArguments(OutputArgs                       *b,
     ...
     * @param config MiniRunners data parameters
     */
    static void GenOutputArguments(OutputArgs                       *b,
                                   const ExecutionRunnersSettings   &settings,
                                   const ExecutionRunnersDataConfig &config);
     ...
     */
    static void
    GenScanArguments(OutputArgs *b, const ExecutionRunnersSettings &settings, const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenScanMixedArguments(OutputArgs                       *b,
                                      const ExecutionRunnersSettings   &settings,
                                      const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenIdxScanArguments(OutputArgs                       *b,
                                    const ExecutionRunnersSettings   &settings,
                                    const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenIdxJoinArguments(OutputArgs                       *b,
                                    const ExecutionRunnersSettings   &settings,
                                    const ExecutionRunnersDataConfig &config);
     ...
     */
    static void
    GenSortArguments(OutputArgs *b, const ExecutionRunnersSettings &settings, const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenJoinSelfArguments(OutputArgs                       *b,
                                     const ExecutionRunnersSettings   &settings,
                                     const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenJoinNonSelfArguments(OutputArgs                       *b,
                                        const ExecutionRunnersSettings   &settings,
                                        const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenAggregateArguments(OutputArgs                       *b,
                                      const ExecutionRunnersSettings   &settings,
                                      const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenAggregateKeylessArguments(OutputArgs                       *b,
                                             const ExecutionRunnersSettings   &settings,
                                             const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenInsertArguments(OutputArgs                       *b,
                                   const ExecutionRunnersSettings   &settings,
                                   const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenInsertMixedArguments(OutputArgs                       *b,
                                        const ExecutionRunnersSettings   &settings,
                                        const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenUpdateIndexArguments(OutputArgs                       *b,
                                        const ExecutionRunnersSettings   &settings,
                                        const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenDeleteIndexArguments(OutputArgs                       *b,
                                        const ExecutionRunnersSettings   &settings,
                                        const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenCreateIndexArguments(OutputArgs                       *b,
                                        const ExecutionRunnersSettings   &settings,
                                        const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenCreateIndexMixedArguments(OutputArgs                       *b,
                                             const ExecutionRunnersSettings   &settings,
                                             const ExecutionRunnersDataConfig &config);
     ...
     * @param config MiniRunners data parameters
     */
    static void GenIndexInsertDeleteArguments(OutputArgs                       *b,
                                              const ExecutionRunnersSettings   &settings,
                                              const ExecutionRunnersDataConfig &config);
...
private:
     ...
     */
    static void GenerateMixedArguments(std::vector<std::vector<int64_t>> *args,
                                       const ExecutionRunnersSettings    &settings,
                                       const ExecutionRunnersDataConfig  &config,
