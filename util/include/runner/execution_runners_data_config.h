...
public:
     ...
     */
    std::vector<std::pair<uint32_t, uint32_t>> sweep_scan_mixed_dist_ = {
        { 3, 12},
        { 7,  8},
        {11,  4}
    };
     ...
     */
    std::vector<std::pair<uint32_t, uint32_t>> sweep_scan_mixed_varchar_dist_ = {
        {2, 3},
        {3, 2},
        {4, 1}
    };
     ...
     */
    std::vector<uint32_t> sweep_index_lookup_sizes_
        = {1, 10, 20, 30, 40, 50, 75, 100, 1000, 10000, 20000, 30000, 40000, 50000};
     ...
     */
    std::vector<std::pair<uint32_t, uint32_t>> sweep_insert_mixed_dist_ = {
        { 1, 14},
        { 3, 12},
        { 5, 10},
        { 7,  8},
