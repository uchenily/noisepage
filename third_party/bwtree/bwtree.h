...
public:
    ...
    NO_ASAN int GetInnerDeltaChainLengthThreshold() const {
        return inner_delta_chain_length_threshold_;
    }
    /** @return leaf_delta_chain_length_threshold */
    NO_ASAN int GetLeafDeltaChainLengthThreshold() const {
        return leaf_delta_chain_length_threshold_;
    }
    /** @return inner_node_size_upper_threshold */
    NO_ASAN int GetInnerNodeSizeUpperThreshold() const {
        return inner_node_size_upper_threshold_;
    }
    /** @return inner_node_size_lower_threshold */
    NO_ASAN int GetInnerNodeSizeLowerThreshold() const {
        return inner_node_size_lower_threshold_;
    }
    /** @return leaf_node_size_upper_threshold */
    NO_ASAN int GetLeafNodeSizeUpperThreshold() const {
        return leaf_node_size_upper_threshold_;
    }
    /** @return leaf_node_size_lower_threshold */
    NO_ASAN int GetLeafNodeSizeLowerThreshold() const {
        return leaf_node_size_lower_threshold_;
    }
...
public:
    ...
    NO_ASAN void PrepareThreadLocal() {
        ...
        gc_metadata_p = reinterpret_cast<PaddedGCMetadata *>(
            (reinterpret_cast<size_t>(original_p) + CACHE_LINE_SIZE - 1) & CACHE_LINE_MASK);
     ...
     */
    NO_ASAN void SetThreadNum(size_t p_thread_num) {
...
public:
     ...
     *                  BwTree is serving
     */
    NO_ASAN inline size_t GetThreadNum() {
        return thread_num;
    }
     ...
     */
    NO_ASAN inline void AssignGCID(int p_gc_id) {
        gc_id = p_gc_id;
    }
     ...
     */
    NO_ASAN static void RegisterThread() {
     ...
     */
    NO_ASAN inline void IncreaseEpoch() {
        epoch++;
    }
     ...
     */
    NO_ASAN inline void UpdateLastActiveEpoch() {
     ...
     */
    NO_ASAN inline uint64_t GetGlobalEpoch() {
        return epoch;
    }
     ...
     */
    NO_ASAN inline GCMetaData *GetCurrentGCMetaData() {
...
public:
    ...
    using KeyValuePairBloomFilter
        = bwtree::BloomFilter<KeyValuePair, KeyValuePairEqualityChecker, KeyValuePairHashFunc>;
    ...
    public:
         ...
         */
        NO_ASAN KeyNodeIDPairComparator(BwTree *p_tree_p)
    ...
    public:
         ...
         */
        NO_ASAN KeyNodeIDPairEqualityChecker(BwTree *p_tree_p)
    ...
    public:
         ...
         */
        NO_ASAN KeyNodeIDPairHashFunc(BwTree *p_tree_p)
         ...
         * single hash value
         */
        NO_ASAN inline size_t operator()(const KeyNodeIDPair &knp) const {
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN KeyValuePairComparator(BwTree *p_tree_p)
            : key_cmp_obj_p{&p_tree_p->key_cmp_obj} {}
     ...
     */
    NO_ASAN inline bool KeyCmpLess(const KeyType &key1, const KeyType &key2) const {
     ...
     */
    NO_ASAN inline bool KeyCmpEqual(const KeyType &key1, const KeyType &key2) const {
     ...
     */
    NO_ASAN inline bool KeyCmpGreater(const KeyType &key1, const KeyType &key2) const {
     ...
     */
    NO_ASAN inline bool ValueCmpEqual(const ValueType &v1, const ValueType &v2) {
    ...
    public:
         ...
         */
        NO_ASAN inline bool HasParentNode() const {
         ...
         */
        NO_ASAN inline bool IsOnRootNode() const {
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN NodeMetaData(const KeyNodeIDPair *p_low_key_p,
    ...
    public:
         ...
         */
        NO_ASAN BaseNode(NodeType             p_type,
         ...
         */
        NO_ASAN inline NodeType GetType() const {
         ...
         */
        NO_ASAN inline const NodeMetaData &GetNodeMetaData() const {
            return metadata;
        }
         ...
         */
        NO_ASAN inline bool IsInnerNode() const {
         ...
         *
         */
        NO_ASAN inline bool IsOnLeafDeltaChain() const {
         ...
         */
        NO_ASAN inline const KeyType &GetLowKey() const {
         ...
         * and inner nodes.
         */
        NO_ASAN inline const KeyType &GetHighKey() const {
         ...
         */
        NO_ASAN inline const KeyNodeIDPair &GetHighKeyPair() const {
         ...
         */
        NO_ASAN inline const KeyNodeIDPair &GetLowKeyPair() const {
         ...
         */
        NO_ASAN inline NodeID GetNextNodeID() const {
         ...
         */
        NO_ASAN inline int GetDepth() const {
         ...
         */
        NO_ASAN inline int GetItemCount() const {
         ...
         */
        NO_ASAN inline void SetLowKeyPair(const KeyNodeIDPair *p_low_key_p) {
         ...
         */
        NO_ASAN inline void SetHighKeyPair(const KeyNodeIDPair *p_high_key_p) {
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN DeltaNode(NodeType             p_type,
    ...
    public:
        ...
        NO_ASAN LeafDataNode(const KeyValuePair  &p_item,
                             NodeType             p_type,
                             const BaseNode      *p_child_node_p,
         ...
         */
        NO_ASAN std::pair<int, bool> GetIndexPair() const {
            return index_pair;
        }
    };
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN LeafInsertNode(const KeyType       &p_insert_key,
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN LeafDeleteNode(const KeyType       &p_delete_key,
                               const ValueType     &p_value,
                               const BaseNode      *p_child_node_p,
                               std::pair<int, bool> p_index_pair)
    ...
    public:
         ...
         * the current node
         */
        NO_ASAN LeafSplitNode(const KeyNodeIDPair &p_insert_item,
                              const BaseNode      *p_child_node_p,
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN LeafMergeNode(const KeyType  &p_merge_key,
    ...
    public:
        ...
        NO_ASAN InnerDataNode(const KeyNodeIDPair &p_item,
                              NodeType             p_type,
                              const BaseNode      *p_child_node_p,
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN InnerInsertNode(const KeyNodeIDPair &p_insert_item,
    ...
    public:
         ...
         */
        NO_ASAN InnerDeleteNode(const KeyNodeIDPair &p_delete_item,
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN InnerSplitNode(const KeyNodeIDPair &p_insert_item,
                               const BaseNode      *p_child_node_p,
                               const BaseNode      *p_split_node_p)
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN InnerMergeNode(const KeyType  &p_merge_key,
                               const BaseNode *p_right_merge_p,
                               NodeID          p_deleted_node_id,
                               const BaseNode *p_child_node_p)
    ...
    public:
         ...
         */
        NO_ASAN NodeSnapshot(NodeID p_node_id, const BaseNode *p_node_p)
            : node_id{p_node_id}
            , node_p{p_node_p} {}
         ...
         */
        NO_ASAN inline bool IsLeaf() const {
    ...
    public:
         ...
         * Constructor
         */
        NO_ASAN AllocationMeta(char *p_tail, char *p_limit)
            : tail{p_tail}
            , limit{p_limit}
            , next{nullptr} {}
    ...
    public:
         ...
         */
        NO_ASAN ElasticNode(NodeType             p_type,
                            int                  p_depth,
                            int                  p_item_count,
        ...
        NO_ASAN static ElasticNode *Copy(const ElasticNode &other) {
            ElasticNode *node_p = ElasticNode::Get(other.GetItemCount(),
                                                   other.GetType(),
                                                   other.GetDepth(),
                                                   other.GetItemCount(),
                                                   other.GetLowKeyPair(),
         ...
         */
        NO_ASAN inline ElementType *Begin() {
            return start;
        }

        NO_ASAN inline const ElementType *Begin() const {
            return start;
        }
         ...
         */
        NO_ASAN inline ElementType *End() {
            return end;
        }

        NO_ASAN inline const ElementType *End() const {
            return end;
        }
         ...
         */
        NO_ASAN inline const ElementType *REnd() {
            return start - 1;
        }

        NO_ASAN inline const ElementType *REnd() const {
            return start - 1;
        }
         ...
         * the size of a node
         */
        NO_ASAN inline int GetSize() const {
    ...
    public:
        ...
        NO_ASAN inline static ElasticNode *Get(int                  size, // Number of elements
            ...
            auto *alloc_base
                = new char[sizeof(ElasticNode) + size * sizeof(ElementType) + AllocationMeta::CHUNK_SIZE()];
        ...
        NO_ASAN static AllocationMeta *GetAllocationHeader(const ElasticNode *node_p) {
            return reinterpret_cast<AllocationMeta *>(reinterpret_cast<uint64_t>(node_p)
    ...
    public:
        ...
        NO_ASAN InnerNode *GetSplitSibling() const {
            ...
            auto *inner_node_p
                = reinterpret_cast<InnerNode *>(ElasticNode<KeyNodeIDPair>::Get(sibling_size,
                                                                                NodeType::InnerType,
                                                                                0,
                                                                                sibling_size,
            ...
            NOISEPAGE_ASSERT(inner_node_p->GetSize() == inner_node_p->GetItemCount(),
                             "Copied number of elements must match.");
    ...
    public:
        ...
        NO_ASAN LeafNode *GetSplitSibling(const BwTree *t) const {
            ...
            auto *leaf_node_p = reinterpret_cast<LeafNode *>(
                ElasticNode<KeyValuePair>::Get(sibling_size,
                                               NodeType::LeafType,
                                               0,
                                               sibling_size,
            ...
            NOISEPAGE_ASSERT(leaf_node_p->GetSize() == leaf_node_p->GetItemCount(),
                             "Copied number of elements must match.");
...
public:
     ...
     */
    NO_ASAN BwTree(bool                 start_gc_thread = true,
        ...
        epoch_manager{this} {
        INDEX_LOG_TRACE("Bw-Tree Constructor called. "
    ...
    NO_ASAN void InitNodeLayout() {
        ...
        InnerNode *root_node_p = reinterpret_cast<InnerNode *>(
            ElasticNode<KeyNodeIDPair>::Get(1,
                                            NodeType::InnerType,
                                            0,
                                            1,
        ...
        LeafNode *left_most_leaf
            = reinterpret_cast<LeafNode *>(ElasticNode<KeyValuePair>::Get(0,
                                                                          NodeType::LeafType,
                                                                          0,
                                                                          0,
                                                                          std::make_pair(KeyType{}, INVALID_NODE_ID),
    ...
    NO_ASAN void InitMappingTable() {
        mapping_table = (std::atomic<const BaseNode *> *) mmap(nullptr,
                                                               sizeof(BaseNode *) * MAPPING_TABLE_SIZE,
...
// they could call CAS and change the key
     ...
     */
    NO_ASAN const KeyValuePair *Traverse(Context              *context_p,
    ...
    retry_traverse:
        ...
        while (1) {
            ...
            if (context_p->abort_flag) {
                ...
                // INVALID_NODE_ID
                NOISEPAGE_ASSERT(child_node_id == INVALID_NODE_ID,
                                 "NavigateInnerNode aborted without INVALID_NODE_ID.");
        ...
        if (context_p->abort_flag) {
            INDEX_LOG_TRACE("NavigateLeafNode() or NavigateSiblingChain()"
                            " aborts. ABORT");
        ...
        INDEX_LOG_TRACE("Found leaf node. Abort count = %d, level = %d",
     ...
     */
    NO_ASAN inline NodeID LocateSeparatorByKey(const KeyType       &search_key,
        ...
        auto it
            = std::upper_bound(start_p, end_p, std::make_pair(search_key, INVALID_NODE_ID), key_node_id_pair_cmp_obj)
              - 1;
#ifdef BWTREE_DEBUG
...
// NOISEPAGE_ASSERT(it == it2);
    ...
    NO_ASAN InnerNode *CollectAllSepsOnInner(NodeSnapshot *snapshot_p, int p_depth = 0) {
        ...
        auto *inner_node_p = reinterpret_cast<InnerNode *>(ElasticNode<KeyNodeIDPair>::Get(node_p->GetItemCount(),
                                                                                           NodeType::InnerType,
                                                                                           p_depth,
                                                                                           node_p->GetItemCount(),
    ...
    NO_ASAN void CollectAllSepsOnInnerRecursive(const BaseNode *node_p,
        ...
        while (true) {
            ...
            case NodeType::InnerType: {
                ...
                if (high_key_pair.second == INVALID_NODE_ID) {
                    ...
                    // consistent
                    copy_end_it = std::lower_bound(inner_node_p->Begin() + 1,
                                                   inner_node_p->End(),
            ...
            case NodeType::InnerInsertType: {
                ...
                // node high key
                NOISEPAGE_ASSERT((high_key_pair.second == INVALID_NODE_ID)
    ...
    NO_ASAN void NavigateLeafNode(Context *context_p, std::vector<ValueType> &value_list) {
        ...
        bwtree::BloomFilter<ValueType, ValueEqualityChecker, ValueHashFunc> present_set{present_set_data_p,
                                                                                        value_eq_obj,
                                                                                        value_hash_obj};

        bwtree::BloomFilter<ValueType, ValueEqualityChecker, ValueHashFunc> deleted_set{deleted_set_data_p,
                                                                                        value_eq_obj,
                                                                                        value_hash_obj};
        ...
        while (1) {
            ...
            case NodeType::LeafType: {
                ...
                // element >= search key
                auto copy_start_it = std::lower_bound(start_it,
                                                      end_it,
     ...
     */
    NO_ASAN const KeyValuePair *NavigateLeafNode(Context              *context_p,
        ...
        while (1) {
            ...
            case NodeType::LeafType: {
                ...
                // NOTE: We only compare keys here, so it will get to the first
                // element >= search key
                auto scan_start_it = std::lower_bound(leaf_node_p->Begin(),
                                                      leaf_node_p->End(),
                                                      std::make_pair(search_key, ValueType{}),
                                                      key_value_pair_cmp_obj);
    ...
    NO_ASAN const KeyValuePair *NavigateLeafNode(Context                             *context_p,
        ...
        while (1) {
            ...
            case NodeType::LeafType: {
                ...
                auto copy_start_it = std::lower_bound(leaf_node_p->Begin(),
                                                      leaf_node_p->End(),
                                                      std::make_pair(search_key, ValueType{}),
                                                      key_value_pair_cmp_obj);
    ...
    NO_ASAN LeafNode *CollectAllValuesOnLeaf(NodeSnapshot *snapshot_p, LeafNode *leaf_node_p = nullptr) {
        ...
        if (leaf_node_p == nullptr) {
            leaf_node_p = reinterpret_cast<LeafNode *>(ElasticNode<KeyValuePair>::Get(node_p->GetItemCount(),
                                                                                      NodeType::LeafType,
                                                                                      0,
                                                                                      node_p->GetItemCount(),
                                                                                      node_p->GetLowKeyPair(),
    ...
    NO_ASAN void CollectAllValuesOnLeafRecursive(const BaseNode          *node_p,
                                                 T                       &sss,
                ...
                while (sss.GetBegin() != sss_end_it) {
                    ...
                    while (sss.GetFront()->GetIndexPair().first == current_index) {
                        ...
                        if (sss.GetFront()->GetType() == NodeType::LeafInsertType) {
                            ...
                            NOISEPAGE_ASSERT(sss.GetFront()->GetType() == NodeType::LeafDeleteType,
                                             "Must be a leaf delete type.");
    ...
    NO_ASAN void JumpToLeftSibling(Context *context_p) {
        ...
        if (IsOnLeftMostChild(context_p)) {
            INDEX_LOG_TRACE("Observed a remove node on left most child."
        ...
        if (parent_snapshot_p->node_p != GetNode(parent_snapshot_p->node_id)) {
            INDEX_LOG_TRACE("Inconsistent parent node snapshot and "
        ...
        if (removed_node_id != snapshot_p->node_p->GetNextNodeID()) {
            INDEX_LOG_TRACE("Left sibling's next node ID does not match removed NodeID."
                            " ABORT");
    ...
    retry_traverse:
        ...
        while (1) {
            ...
            if (snapshot_p->IsLeaf()) {
                ...
                INDEX_LOG_TRACE("Found leaf node (RO). Abort count = %d, level = %d",
                                context_p->abort_counter,
                                context_p->current_level);
     ...
     */
    NO_ASAN inline bool PostInnerInsertNode(Context             *context_p,
        ...
        const InnerInsertNode *insert_node_p = InnerInlineAllocateOfType(InnerInsertNode,
        ...
        INDEX_LOG_TRACE("Index term insert (from %" PRIu64 " to %" PRIu64 ") delta CAS failed. "
                        "ABORT",
                        GetLatestNodeSnapshot(context_p)->node_id,
                        insert_item.second);
     ...
     * NOTE: This function may abort
     */
    NO_ASAN inline bool PostInnerDeleteNode(Context             *context_p,
        ...
        const InnerDeleteNode *delete_node_p = InnerInlineAllocateOfType(InnerDeleteNode,
                                                                         parent_snapshot_p->node_p,
                                                                         delete_item,
                                                                         prev_item,
                                                                         next_item,
    ...
    before_switch:
        ...
        case NodeType::InnerRemoveType: {
            ...
            if (left_snapshot_p->IsLeaf()) {
                ret = PostLeafMergeNode(left_snapshot_p,
                                        &merge_key,
                                        merge_right_branch,
                                        deleted_node_id,
                                        &merge_node_p);
            } else {
                ret = PostInnerMergeNode(left_snapshot_p,
                                         &merge_key,
                                         merge_right_branch,
                                         deleted_node_id,
                                         &merge_node_p);
            ...
            if (ret) {
                INDEX_LOG_TRACE("Merge delta CAS succeeds. "
        ...
        case NodeType::LeafSplitType: {
            ...
            if (context_p->IsOnRootNode()) {
                ...
                InnerNode *inner_node_p = reinterpret_cast<InnerNode *>(
                    ElasticNode<KeyNodeIDPair>::Get(2,
                                                    NodeType::InnerType,
                                                    0,
                                                    2,
                                                    first_item,
                ...
                if ((parent_snapshot_p->node_p->GetNextNodeID() != INVALID_NODE_ID)
                    ...
                    INDEX_LOG_TRACE("Bounds check failed on parent node"
                                    " - item key >= high key");
                ...
                const KeyNodeIDPair *found_item_p
                    = NavigateInnerNode(parent_snapshot_p, insert_item_p->first, &location);
                ...
                if (found_item_p != nullptr) {
                    ...
                    if (found_item_p->second != insert_item_p->second) {
                        ...
                        NOISEPAGE_ASSERT(node_p->GetType() == NodeType::InnerRemoveType
        ...
        if (snapshot_p->IsLeaf()) {
            ...
            if (node_size >= GetLeafNodeSizeUpperThreshold()) {
                ...
                if (new_leaf_node_p == nullptr) {
                    INDEX_LOG_TRACE("LeafNode size exceeds overhead, "
                ...
                const LeafSplitNode *split_node_p = LeafInlineAllocateOfType(LeafSplitNode,
                                                                             node_p,
                ...
                if (ret) {
                    INDEX_LOG_TRACE("Leaf split delta (from %" PRIu64 " to %" PRIu64 ") CAS succeeds. ABORT",
                                    node_id,
                                    new_node_id);
                ...
                if (abort_node_ret) {
                    ...
                    INDEX_LOG_TRACE("Unable to block parent node "
            ...
            if (node_size >= GetInnerNodeSizeUpperThreshold()) {
                ...
                const InnerSplitNode *split_node_p = InnerInlineAllocateOfType(InnerSplitNode,
                                                                               node_p,
                                                                               std::make_pair(split_key, new_node_id),
                                                                               node_p,
                                                                               new_inner_node_p);
                ...
                if (ret) {
                    INDEX_LOG_TRACE("Inner split delta (from %" PRIu64 " to %" PRIu64 ") CAS succeeds."
                                    " ABORT",
                                    node_id,
                                    new_node_id);
     ...
     */
    NO_ASAN void
    RemoveAbortOnParent(NodeID parent_node_id, const BaseNode *abort_node_p, const BaseNode *abort_child_node_p) {
     ...
     */
    NO_ASAN bool PostAbortOnParent(Context         *context_p,
     ...
     * used
     */
    NO_ASAN const KeyNodeIDPair *
    NavigateInnerNode(NodeSnapshot *snapshot_p, const KeyType &search_key, const KeyNodeIDPair **location) {
        // Save some keystrokes
        const BaseNode *node_p = snapshot_p->node_p;
        ...
        while (1) {
            ...
            case NodeType::InnerType: {
                ...
                const KeyNodeIDPair *it = std::lower_bound(start_it,
                                                           inner_node_p->End(),
                                                           std::make_pair(search_key, INVALID_NODE_ID),
                                                           key_node_id_pair_cmp_obj);
    ...
    NO_ASAN inline NodeID FindLeftSibling(const KeyType &search_key, NodeSnapshot *snapshot_p) {
        ...
        while (1) {
            ...
            case NodeType::InnerMergeType: {
                INDEX_LOG_TRACE("Found merge node. "
     ...
     */
    NO_ASAN bool PostInnerMergeNode(const NodeSnapshot *snapshot_p,
        ...
        const InnerMergeNode *merge_node_p = InnerInlineAllocateOfType(InnerMergeNode,
                                                                       merge_branch_p,
                                                                       *merge_key_p,
                                                                       merge_branch_p,
                                                                       deleted_node_id,
     ...
     */
    NO_ASAN bool PostLeafMergeNode(const NodeSnapshot *snapshot_p,
                                   const KeyType      *merge_key_p,
                                   const BaseNode     *merge_branch_p,
                                   NodeID              deleted_node_id,
                                   const BaseNode    **node_p_p) {
        ...
        const LeafMergeNode *merge_node_p = InnerInlineAllocateOfType(LeafMergeNode,
                                                                      merge_branch_p,
                                                                      *merge_key_p,
                                                                      merge_branch_p,
                                                                      deleted_node_id,
     ...
     */
    NO_ASAN bool ConditionalInsert(const KeyType                       &key,
                                   const ValueType                     &value,
                                   std::function<bool(const ValueType)> predicate,
                                   bool                                *predicate_satisfied) {
    ...
    NO_ASAN uint64_t GetSize() const {
        return index_size.load();
    }
     ...
     * counter.
     */
    NO_ASAN bool NeedGarbageCollection() {
        return true;
    }
...
// maintains its own memory
         ...
         */
        NO_ASAN EpochManager(BwTree *p_tree_p)
            : tree_p{p_tree_p} {
...
#ifdef BWTREE_DEBUG
            INDEX_LOG_TRACE("Stat: Freed %" PRIu64 " nodes and %" PRIu64 " NodeID by epoch manager",
                            freed_count,
                            freed_id_count);

            INDEX_LOG_TRACE("      Epoch created = %" PRIu64 "; epoch freed = %" PRIu64 "", epoch_created, epoch_freed);

            INDEX_LOG_TRACE("      Epoch join = %" PRIu64 "; epoch leave = %" PRIu64 "",
                            epoch_join.load(),
                            epoch_leave.load());
#endif
        ...
        NO_ASAN void ClearEpoch() {
            ...
            while (1) {
                ...
                if (head_epoch_p->active_thread_count.fetch_sub(MAX_THREAD_COUNT) > 0) {
                    INDEX_LOG_TRACE("Some thread sneaks in after we have decided"
                                    " to clean. Return");
     ...
     */
    NO_ASAN ForwardIterator Begin(const KeyType &start_key) {
     ...
     */
    NO_ASAN ForwardIterator NullIterator() {
    ...
    private:
         ...
         */
        NO_ASAN IteratorContext(BwTree *p_tree_p)
            : tree_p{p_tree_p}
            , ref_count{0UL} {}
    ...
    public:
         ...
         */
        NO_ASAN inline LeafNode *GetLeafNode() {
         ...
         */
        NO_ASAN inline size_t GetRefCount() {
            return ref_count;
        }
        ...
        NO_ASAN inline static IteratorContext *Get(BwTree *p_tree_p, const BaseNode *node_p) {
            ...
            new (ic_p->GetLeafNode()) ElasticNode<KeyValuePair>{node_p->GetType(),
                                                                node_p->GetDepth(),
                                                                node_p->GetItemCount(),
                                                                node_p->GetLowKeyPair(),
                                                                node_p->GetHighKeyPair()};
    ...
    public:
         ...
         */
        NO_ASAN ForwardIterator(BwTree *p_tree_p, const KeyType &start_key)
            : ic_p{nullptr}
            , kv_p{nullptr} {
         ...
         */
        NO_ASAN ForwardIterator(const ForwardIterator &other)
            : ic_p{other.ic_p}
            , kv_p{other.kv_p} {
        ...
        NO_ASAN void MoveBackByOne() {
            ...
            while (1) {
                ...
                NOISEPAGE_ASSERT((node_p->GetLowKeyPair().second == INVALID_NODE_ID)
                                     || tree_p->KeyCmpLess(node_p->GetLowKey(), low_key),
