        ...
        namespace flatbuf {
            ...
            inline const MetadataVersion (&EnumValuesMetadataVersion())[4] {
                static const MetadataVersion values[]
                    = {MetadataVersion_V1, MetadataVersion_V2, MetadataVersion_V3, MetadataVersion_V4};
                return values;
            }

            inline const char *const *EnumNamesMetadataVersion() {
                static const char *const names[5] = {"V1", "V2", "V3", "V4", nullptr};
                return names;
            }

            inline const char *EnumNameMetadataVersion(MetadataVersion e) {
                if (e < MetadataVersion_V1 || e > MetadataVersion_V4)
                    return "";
            ...
            inline const char *EnumNameUnionMode(UnionMode e) {
                if (e < UnionMode_Sparse || e > UnionMode_Dense)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            inline const char *EnumNamePrecision(Precision e) {
                if (e < Precision_HALF || e > Precision_DOUBLE)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            inline const char *EnumNameDateUnit(DateUnit e) {
                if (e < DateUnit_DAY || e > DateUnit_MILLISECOND)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            inline const char *EnumNameTimeUnit(TimeUnit e) {
                if (e < TimeUnit_SECOND || e > TimeUnit_NANOSECOND)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            inline const IntervalUnit (&EnumValuesIntervalUnit())[2] {
                static const IntervalUnit values[] = {IntervalUnit_YEAR_MONTH, IntervalUnit_DAY_TIME};
                return values;
            }

            inline const char *const *EnumNamesIntervalUnit() {
                static const char *const names[3] = {"YEAR_MONTH", "DAY_TIME", nullptr};
                return names;
            }

            inline const char *EnumNameIntervalUnit(IntervalUnit e) {
                if (e < IntervalUnit_YEAR_MONTH || e > IntervalUnit_DAY_TIME)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            inline const char *const *EnumNamesType() {
                static const char *const names[23] = {"NONE",          "Null",      "Int",       "FloatingPoint",
                                                      "Binary",        "Utf8",      "Bool",      "Decimal",
                                                      "Date",          "Time",      "Timestamp", "Interval",
                                                      "List",          "Struct_",   "Union",     "FixedSizeBinary",
                                                      "FixedSizeList", "Map",       "Duration",  "LargeBinary",
                                                      "LargeUtf8",     "LargeList", nullptr};
                return names;
            }

            inline const char *EnumNameType(Type e) {
                if (e < Type_NONE || e > Type_LargeList)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            inline const char *EnumNameEndianness(Endianness e) {
                if (e < Endianness_Little || e > Endianness_Big)
                    return "";
                const size_t index = static_cast<size_t>(e);
            ...
            struct FixedSizeList FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_LISTSIZE)
                           && verifier.EndTable();
                }
            };
            ...
            struct Map FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyField<uint8_t>(verifier, VT_KEYSSORTED)
                           && verifier.EndTable();
                }
            };
            ...
            inline flatbuffers::Offset<Union> CreateUnionDirect(flatbuffers::FlatBufferBuilder        &_fbb,
                                                                org::apache::arrow::flatbuf::UnionMode mode
                                                                = org::apache::arrow::flatbuf::UnionMode_Sparse,
            ...
            inline flatbuffers::Offset<Int>
            CreateInt(flatbuffers::FlatBufferBuilder &_fbb, int32_t bitWidth = 0, bool is_signed = false) {
            ...
            struct FloatingPoint FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyField<int16_t>(verifier, VT_PRECISION)
                           && verifier.EndTable();
                }
            };
            ...
            CreateFloatingPoint(flatbuffers::FlatBufferBuilder        &_fbb,
                                ...
                                = org::apache::arrow::flatbuf::Precision_HALF) {
            ...
            struct FixedSizeBinary FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_BYTEWIDTH)
                           && verifier.EndTable();
                }
            };
            ...
            struct Decimal FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyField<int32_t>(verifier, VT_PRECISION)
                           && VerifyField<int32_t>(verifier, VT_SCALE) && verifier.EndTable();
                }
            };
            ...
            inline flatbuffers::Offset<Decimal>
            CreateDecimal(flatbuffers::FlatBufferBuilder &_fbb, int32_t precision = 0, int32_t scale = 0) {
            ...
            inline flatbuffers::Offset<Date> CreateDate(flatbuffers::FlatBufferBuilder       &_fbb,
                                                        org::apache::arrow::flatbuf::DateUnit unit
            ...
            inline flatbuffers::Offset<Time> CreateTime(flatbuffers::FlatBufferBuilder       &_fbb,
                                                        org::apache::arrow::flatbuf::TimeUnit unit
                                                        = org::apache::arrow::flatbuf::TimeUnit_MILLISECOND,
                                                        int32_t bitWidth = 32) {
            ...
            inline flatbuffers::Offset<Timestamp> CreateTimestampDirect(flatbuffers::FlatBufferBuilder       &_fbb,
                                                                        org::apache::arrow::flatbuf::TimeUnit unit
                                                                        = org::apache::arrow::flatbuf::TimeUnit_SECOND,
            ...
            CreateInterval(flatbuffers::FlatBufferBuilder           &_fbb,
                           ...
                           = org::apache::arrow::flatbuf::IntervalUnit_YEAR_MONTH) {
            ...
            inline flatbuffers::Offset<Duration> CreateDuration(flatbuffers::FlatBufferBuilder       &_fbb,
                                                                org::apache::arrow::flatbuf::TimeUnit unit
                                                                = org::apache::arrow::flatbuf::TimeUnit_MILLISECOND) {
            ...
            struct DictionaryEncoding FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyField<int64_t>(verifier, VT_ID)
                           ...
                           && VerifyField<uint8_t>(verifier, VT_ISORDERED) && verifier.EndTable();
                }
            };
            ...
            CreateDictionaryEncoding(flatbuffers::FlatBufferBuilder                       &_fbb,
                                     int64_t                                               id = 0,
            ...
            struct Field FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
                ...
                const flatbuffers::Vector<flatbuffers::Offset<org::apache::arrow::flatbuf::Field>> *children() const {
                    return GetPointer<
                        const flatbuffers::Vector<flatbuffers::Offset<org::apache::arrow::flatbuf::Field>> *>(
                        VT_CHILDREN);
                }
                ...
                bool Verify(flatbuffers::Verifier &verifier) const {
                    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME)
                           && verifier.VerifyString(name()) && VerifyField<uint8_t>(verifier, VT_NULLABLE)
                           && VerifyField<uint8_t>(verifier, VT_TYPE_TYPE) && VerifyOffset(verifier, VT_TYPE)
            ...
            Field::type_as<org::apache::arrow::flatbuf::Binary>() const {
            ...
            Field::type_as<org::apache::arrow::flatbuf::Decimal>() const {
            ...
            Field::type_as<org::apache::arrow::flatbuf::Timestamp>() const {
                return type_as_Timestamp();
            }

            template <>
            inline const org::apache::arrow::flatbuf::Interval *
            Field::type_as<org::apache::arrow::flatbuf::Interval>() const {
            ...
            Field::type_as<org::apache::arrow::flatbuf::Struct_>() const {
                return type_as_Struct_();
            }

            template <>
            inline const org::apache::arrow::flatbuf::Union *
            Field::type_as<org::apache::arrow::flatbuf::Union>() const {
            ...
            Field::type_as<org::apache::arrow::flatbuf::Duration>() const {
            ...
            Field::type_as<org::apache::arrow::flatbuf::LargeUtf8>() const {
                return type_as_LargeUtf8();
            }

            template <>
            inline const org::apache::arrow::flatbuf::LargeList *
            Field::type_as<org::apache::arrow::flatbuf::LargeList>() const {
            ...
            inline flatbuffers::Offset<Field> CreateFieldDirect(
                ...
                const std::vector<flatbuffers::Offset<org::apache::arrow::flatbuf::KeyValue>> *custom_metadata
                = nullptr) {
                auto name__ = name ? _fbb.CreateString(name) : 0;
                auto children__
                    = children ? _fbb.CreateVector<flatbuffers::Offset<org::apache::arrow::flatbuf::Field>>(*children)
                               : 0;
                auto custom_metadata__
                    = custom_metadata ? _fbb.CreateVector<flatbuffers::Offset<org::apache::arrow::flatbuf::KeyValue>>(
                          *custom_metadata)
                                      : 0;
                return org::apache::arrow::flatbuf::CreateField(_fbb,
                                                                name__,
                                                                nullable,
                                                                type_type,
                                                                type,
            ...
            inline flatbuffers::Offset<Schema> CreateSchemaDirect(
                ...
                = nullptr) {
                auto fields__
                    = fields ? _fbb.CreateVector<flatbuffers::Offset<org::apache::arrow::flatbuf::Field>>(*fields) : 0;
                auto custom_metadata__
                    = custom_metadata ? _fbb.CreateVector<flatbuffers::Offset<org::apache::arrow::flatbuf::KeyValue>>(
                          *custom_metadata)
                                      : 0;
                return org::apache::arrow::flatbuf::CreateSchema(_fbb, endianness, fields__, custom_metadata__);
            }
