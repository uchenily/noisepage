...
static void _outIntList(StringInfo str, const List *node) {
    const ListCell *lc;
...
static void _outOidList(StringInfo str, const List *node) {
    const ListCell *lc;
...
static void _outInteger(StringInfo str, const Value *node) {
    WRITE_NODE_TYPE("Integer");
    appendStringInfo(str, "\"ival\": %ld, ", node->val.ival);
}

static void _outFloat(StringInfo str, const Value *node) {
...
static void _outString(StringInfo str, const Value *node) {
...
static void _outBitString(StringInfo str, const Value *node) {
...
static void _outNull(StringInfo str, const Value *node) {
