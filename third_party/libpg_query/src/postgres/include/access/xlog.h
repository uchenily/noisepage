...
#define XLogArchivingActive() (XLogArchiveMode > ARCHIVE_MODE_OFF && wal_level >= WAL_LEVEL_ARCHIVE)
/* Is WAL archiving enabled always (even during recovery)? */
#define XLogArchivingAlways() (XLogArchiveMode == ARCHIVE_MODE_ALWAYS && wal_level >= WAL_LEVEL_ARCHIVE)
