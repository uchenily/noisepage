...
extern bool check_track_commit_timestamp(bool *newval, void **extra, GucSource source);

extern void          TransactionTreeSetCommitTsData(TransactionId  xid,
                                                    int            nsubxids,
                                                    TransactionId *subxids,
                                                    TimestampTz    timestamp,
                                                    RepOriginId    nodeid,
                                                    bool           write_xlog);
extern bool          TransactionIdGetCommitTsData(TransactionId xid, TimestampTz *ts, RepOriginId *nodeid);
...
extern void SetCommitTsLimit(TransactionId oldestXact, TransactionId newestXact);
...
#define SizeOfCommitTsSet (offsetof(xl_commit_ts_set, mainxid) + sizeof(TransactionId))
