...
#define HashMaxItemSize(page)                                                                                          \
    MAXALIGN_DOWN(PageGetPageSize(page) - SizeOfPageHeaderData - sizeof(ItemIdData)                                    \
...
extern void    _h_spool(HSpool *hspool, ItemPointer self, Datum *values, bool *isnull);
...
extern IndexTuple   _hash_form_tuple(Relation index, Datum *values, bool *isnull);
