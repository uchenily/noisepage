...
typedef struct CustomExecMethods {
    ...
    void (*BeginCustomScan)(struct CustomScanState *node, EState *estate, int eflags);
    ...
    void (*ExplainCustomScan)(struct CustomScanState *node, List *ancestors, struct ExplainState *es);
} CustomExecMethods;
