 ...
 */
extern void add_paths_to_joinrel(PlannerInfo     *root,
                                 RelOptInfo      *joinrel,
                                 RelOptInfo      *outerrel,
                                 RelOptInfo      *innerrel,
                                 JoinType         jointype,
...
extern bool        have_dangerous_phv(PlannerInfo *root, Relids outer_relids, Relids inner_params);
...
extern bool  eclass_useful_for_merging(PlannerInfo *root, EquivalenceClass *eclass, RelOptInfo *rel);
...
extern Path *
get_cheapest_path_for_pathkeys(List *paths, List *pathkeys, Relids required_outer, CostSelector cost_criterion);
extern Path *
...
extern List *make_pathkeys_for_sortclauses(PlannerInfo *root, List *sortclauses, List *tlist);
...
extern List *find_mergeclauses_for_pathkeys(PlannerInfo *root, List *pathkeys, bool outer_keys, List *restrictinfos);
