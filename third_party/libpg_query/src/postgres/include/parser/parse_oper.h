...
extern Oid LookupOperNameTypeNames(ParseState *pstate,
                                   List       *opername,
                                   TypeName   *oprleft,
                                   TypeName   *oprright,
                                   bool        noError,
...
extern Operator oper(ParseState *pstate, List *op, Oid arg1, Oid arg2, bool noError, int location);
...
extern Expr *make_op(ParseState *pstate, List *opname, Node *ltree, Node *rtree, int location);
