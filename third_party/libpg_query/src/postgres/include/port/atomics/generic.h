...
static inline void pg_atomic_write_u32_impl(volatile pg_atomic_uint32 *ptr, uint32 val) {
    ptr->value = val;
}
#endif
...
static inline void pg_atomic_init_flag_impl(volatile pg_atomic_flag *ptr) {
...
static inline bool pg_atomic_unlocked_test_flag_impl(volatile pg_atomic_flag *ptr) {
...
static inline void pg_atomic_init_u32_impl(volatile pg_atomic_uint32 *ptr, uint32 val_) {
...
static inline uint32 pg_atomic_exchange_u32_impl(volatile pg_atomic_uint32 *ptr, uint32 xchg_) {
    uint32 old;
    while (true) {
...
static inline uint32 pg_atomic_add_fetch_u32_impl(volatile pg_atomic_uint32 *ptr, int32 add_) {
...
static inline uint64 pg_atomic_exchange_u64_impl(volatile pg_atomic_uint64 *ptr, uint64 xchg_) {
    uint64 old;
    while (true) {
        old = ptr->value;
...
static inline void pg_atomic_write_u64_impl(volatile pg_atomic_uint64 *ptr, uint64 val) {
    /*
...
static inline uint64 pg_atomic_read_u64_impl(volatile pg_atomic_uint64 *ptr) {
    uint64 old = 0;
...
static inline void pg_atomic_init_u64_impl(volatile pg_atomic_uint64 *ptr, uint64 val_) {
...
static inline uint64 pg_atomic_add_fetch_u64_impl(volatile pg_atomic_uint64 *ptr, int64 add_) {
...
static inline uint64 pg_atomic_sub_fetch_u64_impl(volatile pg_atomic_uint64 *ptr, int64 sub_) {
