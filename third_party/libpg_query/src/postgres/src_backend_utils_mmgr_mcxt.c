...
void MemoryContextInit(void) {
     ...
     */
    TopMemoryContext = AllocSetContextCreate((MemoryContext) NULL, "TopMemoryContext", 0, 0, 0);
     ...
     */
    ErrorContext = AllocSetContextCreate(TopMemoryContext, "ErrorContext", 0, 0, 0);
