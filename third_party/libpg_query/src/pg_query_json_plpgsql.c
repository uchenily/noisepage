...
static void dump_stmt(StringInfo str, PLpgSQL_stmt *node) {
...
static void dump_block(StringInfo str, PLpgSQL_stmt_block *node) {
...
static void dump_assign(StringInfo str, PLpgSQL_stmt_assign *node) {
...
static void dump_if(StringInfo str, PLpgSQL_stmt_if *node) {
...
static void dump_case(StringInfo str, PLpgSQL_stmt_case *node) {
    // ListCell   *l;
...
static void dump_loop(StringInfo str, PLpgSQL_stmt_loop *node) {
...
static void dump_while(StringInfo str, PLpgSQL_stmt_while *node) {
...
static void dump_fori(StringInfo str, PLpgSQL_stmt_fori *node) {
...
static void dump_fors(StringInfo str, PLpgSQL_stmt_fors *node) {
...
static void dump_forc(StringInfo str, PLpgSQL_stmt_forc *node) {
...
static void dump_foreach_a(StringInfo str, PLpgSQL_stmt_foreach_a *node) {
...
static void dump_open(StringInfo str, PLpgSQL_stmt_open *node) {
...
static void dump_fetch(StringInfo str, PLpgSQL_stmt_fetch *node) {
...
static void dump_close(StringInfo str, PLpgSQL_stmt_close *node) {
...
static void dump_perform(StringInfo str, PLpgSQL_stmt_perform *node) {
...
static void dump_exit(StringInfo str, PLpgSQL_stmt_exit *node) {
...
static void dump_return(StringInfo str, PLpgSQL_stmt_return *node) {
...
static void dump_return_next(StringInfo str, PLpgSQL_stmt_return_next *node) {
...
static void dump_return_query(StringInfo str, PLpgSQL_stmt_return_query *node) {
...
static void dump_raise(StringInfo str, PLpgSQL_stmt_raise *node) {
...
static void dump_execsql(StringInfo str, PLpgSQL_stmt_execsql *node) {
...
static void dump_dynexecute(StringInfo str, PLpgSQL_stmt_dynexecute *node) {
...
static void dump_dynfors(StringInfo str, PLpgSQL_stmt_dynfors *node) {
...
static void dump_getdiag(StringInfo str, PLpgSQL_stmt_getdiag *node) {
...
static void dump_expr(StringInfo str, PLpgSQL_expr *node) {
    WRITE_NODE_TYPE("PLpgSQL_expr");

    WRITE_STRING_FIELD(query);
}

static void dump_function(StringInfo str, PLpgSQL_function *node) {
    int            i;
    PLpgSQL_datum *d;
    ...
    for (i = 0; i < node->ndatums; i++) {
        ...
        case PLPGSQL_DTYPE_ARRAYELEM:
            ...
            break;
        default:
            elog(WARNING, "could not dump unrecognized dtype: %d", (int) d->dtype);
        }
        removeTrailingDelimiter(str);
        appendStringInfoString(str, "}}, ");
    }
...
static void dump_var(StringInfo str, PLpgSQL_var *node) {
...
static void dump_row(StringInfo str, PLpgSQL_row *node) {
    int i = 0;
...
static void dump_record(StringInfo str, PLpgSQL_rec *node) {
