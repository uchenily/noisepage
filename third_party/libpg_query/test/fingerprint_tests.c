const char *tests[] = {
    ...
    "CREATE TABLE types (a float(2), b float(49), c NUMERIC(2, 3), d character(4), e char(5), f varchar(6), g "
    "character varying(7))",
    "018b9c10a0987ccba4f8d8263f3fa7e9e8095d6c58",
    "CREATE VIEW view_a (a, b) AS WITH RECURSIVE view_a (a, b) AS (SELECT * FROM a(1)) SELECT \"a\", \"b\" FROM "
    "\"view_a\"",
