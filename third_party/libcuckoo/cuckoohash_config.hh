...
constexpr size_t LIBCUCKOO_DEFAULT_SIZE = (1U << 16) * LIBCUCKOO_DEFAULT_SLOT_PER_BUCKET;
...
constexpr size_t LIBCUCKOO_NO_MAXIMUM_HASHPOWER = std::numeric_limits<size_t>::max();
